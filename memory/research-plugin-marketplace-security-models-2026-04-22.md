...
HoloScript’s marketplace (`packages/studio/src/lib/marketplace/`) distributes **templates, agents, traits, and MCP-facing assets**. Any “install from community” path must assume **malicious publishers** unless the pipeline enforces **identity, integrity, and least privilege** at install _and_ runtime.
