...
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/strategy/battlecards/babylon-js-9.md`                                                                                   | W.GOLD.037, W.GOLD.044          | **Stale → fixed** | Proof column tied tropical semiring to W.GOLD.044; vault-aligned title for **W.GOLD.044** is _Affective Causality_, not tropical/CAEL. Cite **W.GOLD.037** for semiring stack. |
