...
**Venue:** AAMAS (Oct 2026) — _living draft, pre-submission_  
...
| Preempt reviewers (user study _N_, determinism ε)               | CAEL hash-chain modes (`CAELTrace` / `SimulationContract`) + separate user-study plan. |
