...
**Venue:** ECOOP (Jan 2027) — _living draft, pre-submission_  
...
| Preempt reviewers (user study _N_, determinism ε)                            | Paper + stats owner                            | Cross-link Paper-3 WebGPU hardware queue + semiring benches; user study plan separate. |
