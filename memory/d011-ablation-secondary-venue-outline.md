...
**Purpose:** Satisfy **gate G4** (_Ablation / alternate venue package_) from `docs/paper-program/D011_FOUR_GATE_CHECKLIST.md` with a repeatable pattern: one controlled ablation **or** a shortened alternate submission derived from the same assets.
