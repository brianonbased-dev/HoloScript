...
\paragraph{What ``embarrassingly parallel'' means here.}
...
SM occupancy saturation). For $|T|$ values up to $\sim$$1000$ tiles
per frame at H3, the per-frame overhead remains under $1$\,ms because
