...
"gate in Phase 4" but Phase 4 never ran. USENIX Sec requires a _demonstrated
attack against the real system_ plus a _measured defense_.
...
and one (Sybil) is _measurably stopped by a live defense_ (V11). That is the
