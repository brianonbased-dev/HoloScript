...
_Audit closed. 27 legacy browser/React/HTML examples flagged for archive. 11 v5.0-hardened examples need package-name migration. 112 language examples confirmed current._
