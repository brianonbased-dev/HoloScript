...
- **E2.** Cross-scale commutativity: use the contract's `CommutativityProfile` (ε*total = max(ε_field, ε_scale)) to bound coupling error and \_prove* the coupled run is within tolerance.
