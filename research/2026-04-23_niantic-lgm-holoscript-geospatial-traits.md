...
_This note summarizes public material; it is not an implementation spec for Niantic APIs._
...
2. **LGM is not a file format:** If HoloScript ever _consumes_ LGM-style outputs, it will be as **inference** from a service (pose, place embedding, mesh prior)—still mapped into **declarative** scene state your compilers understand.
