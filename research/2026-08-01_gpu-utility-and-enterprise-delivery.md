...
| A.GPU.007 | Enterprise capacity/policy/budget/audit surface                                          | Bounded store substrate implemented and committed: signed evidence plus atomic integer-minor-unit holds, release, metered settlement, replay protection, and exact v1-to-v2 migration; production dispatch, service wiring, billing, and provider reconciliation remain unshipped |
