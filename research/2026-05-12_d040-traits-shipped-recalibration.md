...
The original scoping memo (2026-05-11) treated the traits as "Skeletons shipped. Full implementation is multi-week." This is accurate but incomplete — it did not acknowledge that the _skeletons themselves_ were sufficient to close the greenfield gap. The analysis should have flagged: "Greenfield construction is NOT needed; remaining work is stub replacement + integration + CI verification."
