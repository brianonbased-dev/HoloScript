...
| **Safety-critical**      | _(none in MVP, but protocol must account for them)_ | **N/A**              | Per `safety_critical_never_accepted` theorem: safety-critical traits are NEVER accepted on Tier-2. Alpha is undefined (always 0). |
