...
- packages/absorb-service/src/self-improvement/**tests**/GRPOPromptExtractor.test.ts:125
- packages/core/src/cli/**tests**/holoscript-runner.daemon.test.ts:109
- packages/engine/src/simulation/**tests**/scenario-SimSciPipeline.test.ts:253
- packages/engine/tests/paper-6-webgpu-matrix.spec.ts:234
- packages/engine/tests/webgpu-physics-bench.spec.ts:235
- Multiple in packages/framework/src/agents/spatial-comms/**tests**/
