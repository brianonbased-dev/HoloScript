 ...
 *
 * TARGET: packages/r3f-renderer/src/utils/materialUtils.tsx
 */
...
/**
 * Check if geometry type is an advanced procedural type that uses marching
 * cubes, spline tubes, or membrane lofting instead of standard Three.js
 * primitives. These types need DoubleSide rendering and may need default
 * geometry data synthesis when no explicit blob/point/anchor data is given.
 */
export function isAdvancedGeometry(hsType: string): boolean {
  return (
    hsType === 'hull' ||
    hsType === 'metaball' ||
    hsType === 'blob' ||
