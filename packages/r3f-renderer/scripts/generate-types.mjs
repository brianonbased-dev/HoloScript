...
export declare function buildCrossScaleProjection(
  partition: CrossScalePartitionLike,
  options?: CrossScaleProjectionOptions
): CrossScaleProjectionResult;
export declare function CrossScaleProjectionRenderer(
  props: CrossScaleProjectionRendererProps
): React.ReactElement;
...
// ── Compiled Material (I.007 lotus assembly) ────────────────────────────────
...
export interface CompiledMaterialSpec {
  ...
  proceduralMaps?: {
    normalMap?: { name: string; params?: Record<string, unknown> };
    roughnessMap?: { name: string; params?: Record<string, unknown> };
    map?: { name: string; params?: Record<string, unknown> };
  };
}
...
export declare function buildCompiledMaterial(spec: CompiledMaterialSpec): CompiledMaterialResult;

export type ProceduralTextureGenerator = (params: Record<string, unknown>) => {
  data: Uint8Array;
  width: number;
  height: number;
};

export declare function registerProceduralTexture(name: string, generator: ProceduralTextureGenerator): void;
`;
