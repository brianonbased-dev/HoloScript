...
function fixFile(filePath) {
  ...
  content = content.replace(
    /(?<!\d)\b(pos|p|v|a|b|c|d|res|result|current|target|dir|direction|normal|up|forward|right|force|velocity|acceleration|last|min|max|center|start|end|node|bone|joint|tip)\b\.(x|y|z|w)\b/g,
    (match, p1, p2) => {
