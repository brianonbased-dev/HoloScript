...
export default defineConfig({
  ...
  external: [
    ...
    'onnxruntime-web',
    'onnxruntime-common',
    // Externalize Playwright's browser automation stack. ComputerUseTrait loads
    // it lazily at runtime; bundling follows Playwright internal subpaths that
    // are intentionally package-export guarded.
    'playwright',
    'playwright-core',
    /^playwright-core\//,
    /^chromium-bidi\//,
