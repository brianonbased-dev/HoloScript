...
const TRAIT_COMPLETIONS: CompletionItem[] = [
  {
    label: 'grabbable',
    kind: 'trait',
    detail: 'Make node grabbable in VR',
  ...
  },
  {
    ...
    insertText: '@audio(sound: "")',
  },
  {
    label: 'particles',
    kind: 'trait',
    detail: 'Attach particle system',
    insertText: '@particles(preset: "dust")',
  },
  {
    label: 'animation',
    kind: 'trait',
    detail: 'Keyframe animation',
    insertText: '@animation(clip: "")',
  },
  {
    label: 'state',
    kind: 'trait',
    detail: 'Finite state machine',
    insertText: '@state(initial: "idle")',
  },
  {
    label: 'sync',
    kind: 'trait',
    detail: 'Network synchronization',
    insertText: '@sync(rate: 20)',
  },
  {
    label: 'theme',
    kind: 'trait',
    detail: 'Apply theme styles',
    insertText: '@theme(classes: [])',
  },
  { label: 'events', kind: 'trait', detail: 'Event bus wiring', insertText: '@events(listen: {})' },
  {
    label: 'scrollable',
    kind: 'trait',
    detail: 'Physics-based scrolling',
    insertText: '@scrollable',
  },
  ...
  { label: 'lod', kind: 'trait', detail: 'Level of detail system', insertText: '@lod' },
  {
    ...
    kind: 'trait',
    detail: 'AI obstacle avoidance',
    insertText: '@obstacle_avoidance',
  },
  {
    label: 'safety_rated',
    kind: 'trait',
    detail: 'Safety-rated component',
    insertText: '@safety_rated',
  },
  ...
  // Material & rendering traits
  {
    label: 'transparent',
    kind: 'trait',
    detail: 'Transparent rendering mode',
    insertText: '@transparent',
  },
  {
    label: 'double_sided',
    kind: 'trait',
    detail: 'Double-sided material',
    insertText: '@double_sided',
  },
  ...
  { label: 'encoder', kind: 'trait', detail: 'Encoder binding', insertText: '@encoder' },
  {
    label: 'revolute',
    kind: 'trait',
    detail: 'Revolute joint constraint',
    insertText: '@revolute',
  },
...
const V6_TRAIT_COMPLETIONS: CompletionItem[] = [
  ...
  { label: 'handler', kind: 'trait', detail: 'v6: Request handler', insertText: '@handler' },
  {
    label: 'middleware',
    kind: 'trait',
    detail: 'v6: Service middleware',
    insertText: '@middleware',
  },
  { label: 'api_gateway', kind: 'trait', detail: 'v6: API gateway', insertText: '@api_gateway' },
  {
    label: 'load_balancer',
    kind: 'trait',
    detail: 'v6: Load balancer',
    insertText: '@load_balancer',
  },
  {
    label: 'service_discovery',
    kind: 'trait',
    detail: 'v6: Service discovery',
    insertText: '@service_discovery',
  },
  ...
  { label: 'rate_limiter', kind: 'trait', detail: 'v6: Rate limiter', insertText: '@rate_limiter' },
  {
    label: 'rest_resource',
    kind: 'trait',
    detail: 'v6: REST resource',
    insertText: '@rest_resource',
  },
  {
    label: 'health_endpoint',
    kind: 'trait',
    detail: 'v6: Health check endpoint',
    insertText: '@health_endpoint',
  },
  {
    label: 'graphql_resolver',
    kind: 'trait',
    detail: 'v6: GraphQL resolver',
    insertText: '@graphql_resolver',
  },
  {
    label: 'webhook_sender',
    kind: 'trait',
    detail: 'v6: Webhook sender',
    insertText: '@webhook_sender',
  },
  {
    label: 'webhook_receiver',
    kind: 'trait',
    detail: 'v6: Webhook receiver',
    insertText: '@webhook_receiver',
  },
  // Contract domain
  ...
  {
    label: 'schema_evolution',
    kind: 'trait',
    detail: 'v6: Schema evolution',
    insertText: '@schema_evolution',
  },
  ...
  {
    label: 'cursor_pagination',
    kind: 'trait',
    detail: 'v6: Cursor pagination',
    insertText: '@cursor_pagination',
  },
  { label: 'soft_delete', kind: 'trait', detail: 'v6: Soft delete', insertText: '@soft_delete' },
  {
    label: 'audit_column',
    kind: 'trait',
    detail: 'v6: Audit columns',
    insertText: '@audit_column',
  },
  // Network domain
  ...
  { label: 'graphql', kind: 'trait', detail: 'v6: GraphQL protocol', insertText: '@graphql' },
  {
    label: 'tls_config',
    kind: 'trait',
    detail: 'v6: TLS configuration',
    insertText: '@tls_config',
  },
  {
    label: 'jwt_config',
    kind: 'trait',
    detail: 'v6: JWT configuration',
    insertText: '@jwt_config',
  },
  {
    label: 'oauth2_config',
    kind: 'trait',
    detail: 'v6: OAuth2 config',
    insertText: '@oauth2_config',
  },
  // Pipeline domain
  ...
  { label: 'scheduler', kind: 'trait', detail: 'v6: Job scheduler', insertText: '@scheduler' },
  {
    ...
    kind: 'trait',
    detail: 'v6: Message broker',
    insertText: '@message_broker',
  },
  {
    label: 'idempotent_consumer',
    kind: 'trait',
    detail: 'v6: Idempotent consumer',
    insertText: '@idempotent_consumer',
  },
  {
    label: 'saga_orchestrator',
    kind: 'trait',
    detail: 'v6: Saga orchestrator',
    insertText: '@saga_orchestrator',
  },
  ...
  {
    label: 'structured_log',
    kind: 'trait',
    detail: 'v6: Structured logging',
    insertText: '@structured_log',
  },
  ...
  // Resilience domain
  {
    ...
    kind: 'trait',
    detail: 'v6: Circuit breaker',
    insertText: '@circuit_breaker',
  },
  ...
  { label: 'bulkhead', kind: 'trait', detail: 'v6: Bulkhead isolation', insertText: '@bulkhead' },
  {
    ...
    kind: 'trait',
    detail: 'v6: Exponential backoff',
    insertText: '@exponential_backoff',
  },
  {
    label: 'canary_release',
    kind: 'trait',
    detail: 'v6: Canary release',
    insertText: '@canary_release',
  },
  {
    label: 'blue_green_deploy',
    kind: 'trait',
    detail: 'v6: Blue-green deployment',
    insertText: '@blue_green_deploy',
  },
];
...
const DIRECTIVE_COMPLETIONS: CompletionItem[] = [
  ...
  { label: 'if', kind: 'directive', detail: 'Conditional rendering', insertText: '@if(condition)' },
  {
    label: 'each',
    kind: 'directive',
    detail: 'List iteration',
    insertText: '@each(items as item)',
  },
...
const BLOCK_COMPLETIONS: CompletionItem[] = [
  // ── Core scene ──────────────────────────────────────────────────────────
  {
    ...
    insertText: 'composition "Name" {\n  \n}',
  },
  {
    label: 'template',
    kind: 'block',
    detail: 'Reusable template',
  ...
  // ── Material & Shader System (7 material types) ─────────────────────────
  {
    label: 'material',
    kind: 'block',
    detail: 'PBR material definition',
    insertText:
      'material "Name" @pbr {\n  baseColor: "#ffffff"\n  roughness: 0.5\n  metallic: 0.0\n}',
  ...
  },
  {
    ...
    kind: 'block',
    detail: 'Unlit material (no lighting)',
    insertText: 'unlit_material "Name" {\n  emissive_color: "#ffffff"\n  opacity: 1.0\n}',
    documentation: 'Unlit material — not affected by scene lighting',
  },
  {
    label: 'shader',
    kind: 'block',
    detail: 'Custom shader definition',
    insertText:
  ...
  },
  {
    label: 'toon_material',
    kind: 'block',
    detail: 'Toon/cel-shaded material',
    insertText:
      'toon_material "Name" {\n  baseColor: "#ffffff"\n  outline_width: 0.02\n  outline_color: "#000000"\n  shading_steps: 3\n}',
    documentation: 'Toon/cel-shading material with outline and step parameters',
  },
  {
    label: 'glass_material',
    kind: 'block',
    detail: 'Glass/transparent material',
    insertText:
      'glass_material "Name" @transparent {\n  baseColor: "#ffffff"\n  opacity: 0.3\n  ior: 1.52\n  transmission: 0.95\n}',
    documentation: 'Glass material with IOR, transmission, and transparency',
  },
  {
    label: 'subsurface_material',
    kind: 'block',
    detail: 'Subsurface scattering material',
    insertText:
      'subsurface_material "Name" {\n  baseColor: "#ffddcc"\n  subsurface_color: "#ff4444"\n  subsurface_radius: [1.0, 0.2, 0.1]\n  thickness: 0.5\n}',
  ...
  // ── Texture map sub-blocks (19 channels) ────────────────────────────────
  {
    label: 'albedo_map',
    kind: 'block',
    detail: 'Albedo/diffuse texture',
    insertText:
      'albedo_map { source: "textures/diffuse.png" tiling: [1, 1] filtering: "trilinear" }',
    documentation: 'Albedo (diffuse color) texture channel',
  },
  {
    label: 'normal_map',
    kind: 'block',
    detail: 'Normal/bump texture',
    insertText: 'normal_map { source: "textures/normal.png" strength: 1.0 }',
    documentation: 'Normal map for surface detail',
  },
  {
    label: 'roughness_map',
    kind: 'block',
    detail: 'Roughness texture',
    insertText: 'roughness_map { source: "textures/roughness.png" }',
    documentation: 'Roughness channel texture',
  },
  {
    label: 'metallic_map',
    kind: 'block',
    detail: 'Metallic texture',
    insertText: 'metallic_map { source: "textures/metallic.png" }',
    documentation: 'Metallic channel texture',
  },
  {
    label: 'emission_map',
    kind: 'block',
    detail: 'Emission texture',
    insertText: 'emission_map { source: "textures/emission.png" }',
    documentation: 'Emission/glow texture',
  },
  {
    label: 'ao_map',
    kind: 'block',
    detail: 'Ambient occlusion texture',
    insertText: 'ao_map { source: "textures/ao.png" }',
    documentation: 'Ambient occlusion texture',
  },
  {
    label: 'height_map',
    kind: 'block',
    detail: 'Height/displacement texture',
    insertText: 'height_map { source: "textures/height.png" scale: 0.1 }',
    documentation: 'Height map for parallax or displacement',
  },
  {
    label: 'opacity_map',
    kind: 'block',
    detail: 'Opacity/alpha texture',
    insertText: 'opacity_map { source: "textures/opacity.png" }',
    documentation: 'Opacity/alpha channel texture',
  },
  {
    label: 'displacement_map',
    kind: 'block',
    detail: 'Displacement texture',
    insertText: 'displacement_map { source: "textures/displacement.png" scale: 0.05 }',
    documentation: 'Displacement mapping texture',
  },
  {
    label: 'specular_map',
    kind: 'block',
    detail: 'Specular texture',
    insertText: 'specular_map { source: "textures/specular.png" }',
    documentation: 'Specular highlight texture',
  },
  {
    label: 'clearcoat_map',
    kind: 'block',
    detail: 'Clearcoat texture',
    insertText: 'clearcoat_map { source: "textures/clearcoat.png" }',
    documentation: 'Clearcoat layer texture (car paint, lacquer)',
  },
  {
    label: 'baseColor_map',
    kind: 'block',
    detail: 'Base color texture',
    insertText: 'baseColor_map { source: "textures/basecolor.png" tiling: [1, 1] }',
    documentation: 'Base color texture (PBR metallic workflow)',
  },
  {
    label: 'emissive_map',
    kind: 'block',
    detail: 'Emissive texture',
    insertText: 'emissive_map { source: "textures/emissive.png" }',
    documentation: 'Emissive glow texture',
  },
  {
    label: 'transmission_map',
    kind: 'block',
    detail: 'Transmission texture',
    insertText: 'transmission_map { source: "textures/transmission.png" }',
    documentation: 'Transmission texture (glass, thin surfaces)',
  },
  {
    label: 'sheen_map',
    kind: 'block',
    detail: 'Sheen texture',
    insertText: 'sheen_map { source: "textures/sheen.png" }',
    documentation: 'Sheen texture (fabric, velvet)',
  },
  {
    label: 'anisotropy_map',
    kind: 'block',
    detail: 'Anisotropy texture',
    insertText: 'anisotropy_map { source: "textures/anisotropy.png" }',
    documentation: 'Anisotropy direction texture (brushed metal)',
  },
  {
    label: 'thickness_map',
    kind: 'block',
    detail: 'Thickness texture',
    insertText: 'thickness_map { source: "textures/thickness.png" }',
    documentation: 'Thickness map (subsurface scattering)',
  },
  {
    label: 'subsurface_map',
    kind: 'block',
    detail: 'Subsurface texture',
    insertText: 'subsurface_map { source: "textures/subsurface.png" }',
    documentation: 'Subsurface scattering color texture',
  },
  {
    label: 'iridescence_map',
    kind: 'block',
    detail: 'Iridescence texture',
    insertText: 'iridescence_map { source: "textures/iridescence.png" }',
    documentation: 'Iridescence texture (oil slick, soap bubble)',
  },
  ...
  // ── Force fields (6 types) ──────────────────────────────────────────────
  {
    label: 'force_field',
    kind: 'block',
    detail: 'Directional force field',
    insertText:
      'force_field "Name" {\n  strength: 5.0\n  direction: [0, 1, 0]\n  falloff: "linear"\n}',
  ...
  },
  {
    label: 'wind_zone',
    kind: 'block',
    detail: 'Wind zone effect',
    insertText: 'wind_zone "Name" {\n  direction: [1, 0, 0]\n  strength: 3.0\n  turbulence: 0.5\n}',
    documentation: 'Wind force affecting particles and physics',
  },
  {
    label: 'buoyancy_zone',
    kind: 'block',
    detail: 'Buoyancy/water zone',
    insertText: 'buoyancy_zone "Name" {\n  density: 1000\n  surface_height: 0.0\n  drag: 0.3\n}',
    documentation: 'Water buoyancy simulation zone',
  },
  {
    label: 'magnetic_field',
    kind: 'block',
    detail: 'Magnetic field zone',
    insertText: 'magnetic_field "Name" {\n  strength: 10.0\n  pole: [0, 1, 0]\n}',
    documentation: 'Magnetic attraction/repulsion field',
  },
  {
    label: 'drag_zone',
    kind: 'block',
    detail: 'Drag/resistance zone',
    insertText: 'drag_zone "Name" {\n  linear_drag: 0.5\n  angular_drag: 0.3\n}',
  ...
  // ── Articulation (with 8 joint types) ───────────────────────────────────
  {
    label: 'articulation',
    kind: 'block',
    detail: 'Physics articulation chain',
    insertText:
      'articulation "Name" {\n  joint "Joint1" {\n    type: "revolute"\n    axis: [0, 1, 0]\n    limits: [-90, 90]\n  }\n}',
  ...
  // ── Joint sub-blocks (8 types) ──────────────────────────────────────────
  {
    label: 'joint',
    kind: 'block',
    detail: 'Generic joint',
    insertText: 'joint "Name" {\n  type: "revolute"\n  axis: [0, 1, 0]\n  limits: [-90, 90]\n}',
    documentation: 'Generic physics joint',
  },
  {
    label: 'hinge',
    kind: 'block',
    detail: 'Hinge joint (1 axis)',
    insertText: 'hinge "Name" {\n  axis: [0, 1, 0]\n  limits: [-90, 90]\n  motor_speed: 0\n}',
    documentation: 'Single-axis rotation (doors, wheels)',
  },
  {
    label: 'slider',
    kind: 'block',
    detail: 'Slider/prismatic joint',
    insertText: 'slider "Name" {\n  axis: [1, 0, 0]\n  limits: [0, 2]\n}',
    documentation: 'Linear sliding joint (pistons, drawers)',
  },
  {
    label: 'ball_socket',
    kind: 'block',
    detail: 'Ball-socket joint (3 axes)',
    insertText: 'ball_socket "Name" {\n  swing_limit: 45\n  twist_limit: 30\n}',
    documentation: 'Spherical joint (shoulders, ragdoll)',
  },
  {
    label: 'fixed_joint',
    kind: 'block',
    detail: 'Fixed/weld joint',
    insertText: 'fixed_joint "Name" {\n  break_force: 1000\n}',
    documentation: 'Rigid connection between bodies',
  },
  {
    label: 'd6_joint',
    kind: 'block',
    detail: '6-DOF configurable joint',
    insertText:
      'd6_joint "Name" {\n  x_motion: "locked"\n  y_motion: "limited"\n  z_motion: "free"\n  swing1_limit: 45\n  swing2_limit: 45\n  twist_limit: 30\n}',
  ...
  },
  {
    ...
    kind: 'block',
    detail: 'Particle system (explicit)',
    insertText: 'particle_system "Name" {\n  max_particles: 1000\n  emission { rate: 200 }\n}',
  ...
  // ── Particle module sub-blocks (15 modules) ─────────────────────────────
  {
    label: 'emission',
    kind: 'module',
    detail: 'Particle emission module',
  ...
  },
  {
    label: 'lifetime',
    kind: 'module',
    detail: 'Particle lifetime module',
    insertText: 'lifetime {\n  min: 1.0\n  max: 3.0\n}',
  ...
  },
  {
    label: 'velocity',
    kind: 'module',
    detail: 'Particle velocity module',
    insertText: 'velocity {\n  initial: [0, 5, 0]\n  randomize: 0.3\n}',
  ...
  },
  {
    label: 'collision',
    kind: 'module',
    detail: 'Particle collision module',
    insertText: 'collision {\n  enabled: true\n  bounce: 0.3\n  lifetime_loss: 0.1\n}',
    documentation: 'Particle world collision behavior',
  },
  {
    label: 'sub_emitter',
    kind: 'module',
    detail: 'Sub-emitter module',
    insertText: 'sub_emitter {\n  trigger: "death"\n  emitter: "SparkBurst"\n}',
    documentation: 'Spawn sub-particles on birth/death/collision',
  },
  {
    label: 'shape',
    kind: 'module',
    detail: 'Emission shape module',
    insertText: 'shape {\n  type: "cone"\n  angle: 30\n  radius: 0.5\n}',
  ...
  },
  {
    label: 'renderer',
    kind: 'module',
    detail: 'Particle renderer module',
    insertText:
      'renderer {\n  mode: "billboard"\n  material: "ParticleMat"\n  sort_mode: "by_distance"\n}',
    documentation: 'Particle rendering mode and material',
  },
  {
    label: 'rotation_over_life',
    kind: 'module',
    detail: 'Rotation over lifetime',
    insertText: 'rotation_over_life {\n  angular_velocity: 90\n  randomize: 0.2\n}',
    documentation: 'Rotation animation over lifetime',
  },
  {
    label: 'trails',
    kind: 'module',
    detail: 'Particle trails module',
    insertText: 'trails {\n  lifetime: 0.5\n  width: 0.1\n  color: "#ffffff"\n}',
  ...
  },
  {
    label: 'texture_sheet',
    kind: 'module',
    detail: 'Texture sheet animation',
    insertText: 'texture_sheet {\n  tiles: [4, 4]\n  fps: 24\n  mode: "whole_sheet"\n}',
    documentation: 'Flipbook/sprite sheet animation',
  },
  {
    label: 'inherit_velocity',
    kind: 'module',
    detail: 'Inherit velocity module',
    insertText: 'inherit_velocity {\n  mode: "initial"\n  multiplier: 0.5\n}',
  ...
  },
  {
    label: 'post_fx',
    kind: 'block',
    detail: 'Post-FX pipeline',
    insertText: 'post_fx "Name" {\n  bloom { intensity: 0.5 }\n}',
  ...
  },
  {
    ...
    insertText: 'render_pipeline "Name" {\n  anti_aliasing { mode: "taa" }\n}',
  ...
  },
  {
    label: 'tone_mapping',
    kind: 'module',
    detail: 'HDR tone mapping',
    insertText: 'tone_mapping {\n  mode: "aces"\n  exposure: 1.0\n}',
  ...
  },
  {
    ...
    insertText: 'chromatic_aberration {\n  intensity: 0.1\n}',
  ...
  },
  {
    ...
    kind: 'module',
    detail: 'Volumetric fog',
    insertText: 'volumetric_fog {\n  density: 0.02\n  albedo: "#ffffff"\n  anisotropy: 0.6\n}',
    documentation: 'Ray-marched volumetric fog',
  },
  {
    label: 'screen_space_reflections',
    kind: 'module',
    detail: 'Screen-space reflections',
    insertText: 'screen_space_reflections {\n  quality: "high"\n  max_distance: 50\n}',
  ...
  },
  {
    ...
    kind: 'block',
    detail: 'Reverb zone',
    insertText: 'reverb_zone "Name" {\n  decay_time: 2.0\n  room_size: 0.8\n  pre_delay: 20\n}',
    documentation: 'Spatial reverb processing zone',
  },
  {
    label: 'audio_mixer',
    kind: 'block',
    detail: 'Audio mixer channel',
    insertText: 'audio_mixer "Name" {\n  volume: 1.0\n  mute: false\n}',
    documentation: 'Audio mixing channel/group',
  },
  {
    label: 'ambience',
    kind: 'block',
    detail: 'Ambient soundscape',
    insertText: 'ambience "Name" {\n  clip: "ambient.ogg"\n  volume: 0.3\n  loop: true\n}',
    documentation: 'Background ambient audio',
  },
  {
    label: 'sound_emitter',
    kind: 'block',
    detail: 'Sound emitter',
    insertText: 'sound_emitter "Name" @spatial {\n  clip: "sound.ogg"\n  volume: 1.0\n}',
  ...
  },
  {
    label: 'atmosphere',
    kind: 'block',
    detail: 'Atmosphere settings',
    insertText: 'atmosphere "Name" {\n  scattering: true\n  density: 1.0\n}',
    documentation: 'Atmospheric scattering settings',
  },
  {
    label: 'sky',
    kind: 'block',
    detail: 'Sky/skybox settings',
    insertText: 'sky "Name" {\n  type: "procedural"\n  sun_size: 0.04\n}',
  ...
  },
  {
    label: 'lightning',
    kind: 'module',
    detail: 'Lightning layer',
    insertText: 'lightning {\n  frequency: 5\n  intensity: 2.0\n}',
  ...
  },
  {
    label: 'time_of_day',
    kind: 'module',
    detail: 'Day/night cycle',
    insertText: 'time_of_day {\n  hour: 12\n  speed: 1.0\n  auto_cycle: true\n}',
  ...
  },
  {
    label: 'fog_layer',
    kind: 'module',
    detail: 'Atmospheric fog layer',
    insertText: 'fog_layer {\n  density: 0.02\n  height: 5.0\n  color: "#cccccc"\n}',
  ...
  },
  {
    label: 'dust_storm',
    kind: 'module',
    detail: 'Dust storm layer',
    insertText: 'dust_storm {\n  intensity: 0.7\n  visibility: 50\n}',
  ...
  },
  {
    label: 'generate',
    kind: 'block',
    detail: 'Generate block',
    insertText: 'generate "Name" {\n  \n}',
    documentation: 'Alias for procedural generation',
  },
  {
    label: 'scatter',
    kind: 'block',
    detail: 'Distribution scatter',
    insertText: 'scatter "Name" {\n  count: 1000\n  radius: 50\n  seed: 42\n}',
    documentation: 'Scatter placement distribution',
  },
  {
    label: 'distribute',
    kind: 'block',
    detail: 'Distribution block',
    insertText: 'distribute "Name" {\n  pattern: "poisson"\n  density: 0.5\n}',
  ...
  },
  {
    label: 'simplex',
    kind: 'module',
    detail: 'Simplex noise',
    insertText: 'simplex base {\n  scale: 100\n  octaves: 4\n}',
    documentation: 'Simplex noise (faster Perlin variant)',
  },
  {
    label: 'voronoi',
    kind: 'module',
    detail: 'Voronoi noise',
    insertText: 'voronoi base {\n  scale: 50\n  jitter: 0.8\n}',
  ...
  },
  {
    ...
    kind: 'module',
    detail: 'Ridged noise',
    insertText: 'ridged base {\n  octaves: 6\n  sharpness: 2.0\n}',
    documentation: 'Ridged multifractal noise (mountain ridges)',
  },
  {
    label: 'cellular',
    kind: 'module',
    detail: 'Cellular noise',
    insertText: 'cellular base {\n  scale: 20\n  type: "f1"\n}',
  ...
  },
  {
    label: 'nav_agent',
    kind: 'block',
    detail: 'Navigation agent',
    insertText: 'nav_agent "Name" {\n  speed: 3.5\n  acceleration: 8\n  stopping_distance: 0.5\n}',
  ...
  },
  {
    label: 'obstacle',
    kind: 'block',
    detail: 'Navigation obstacle',
    insertText: 'obstacle "Name" {\n  carve: true\n  shape: "box"\n  size: [2, 2, 2]\n}',
  ...
  },
  {
    ...
    insertText: 'nav_link "Name" {\n  start: [0, 0, 0]\n  end: [5, 2, 0]\n  bidirectional: true\n}',
    documentation: 'Off-mesh navigation link (jumps, ladders)',
  },
  {
    label: 'nav_modifier',
    kind: 'block',
    detail: 'Navigation modifier',
    insertText: 'nav_modifier "Name" {\n  area_type: "water"\n  cost: 3.0\n}',
    documentation: 'Navigation area cost modifier',
  },
  {
    label: 'crowd_manager',
    kind: 'block',
    detail: 'Crowd navigation',
    insertText: 'crowd_manager "Name" {\n  max_agents: 100\n  separation: 0.5\n}',
  ...
  },
  {
    label: 'condition',
    kind: 'module',
    detail: 'BT condition check',
    insertText: 'condition has_target: true',
    documentation: 'Boolean condition check node',
  },
  {
    label: 'leaf',
    kind: 'module',
    detail: 'BT leaf action',
    insertText: 'leaf patrol: "waypoints"',
    documentation: 'Terminal action node',
  },
  {
    label: 'parallel',
    kind: 'module',
    detail: 'BT parallel node',
    insertText: 'parallel {\n  \n}',
  ...
  },
  {
    ...
    kind: 'module',
    detail: 'BT repeater',
    insertText: 'repeater repeat_count {\n  count: 3\n}',
  ...
  },
  {
    label: 'interaction',
    kind: 'block',
    detail: 'Interaction profile',
    insertText: 'interaction "Name" {\n  type: "grab"\n  hand: "any"\n}',
    documentation: 'VR/XR interaction definition',
  },
  {
    label: 'gesture_profile',
    kind: 'block',
    detail: 'Gesture recognition profile',
    insertText:
      'gesture_profile "Name" {\n  gestures: ["pinch", "wave", "point"]\n  sensitivity: 0.8\n}',
    documentation: 'Hand gesture recognition configuration',
  },
  {
    label: 'controller_map',
    kind: 'block',
    detail: 'Controller button mapping',
    insertText: 'controller_map "Name" {\n  trigger: "fire"\n  grip: "grab"\n}',
  ...
  // ── Annotation syntax ───────────────────────────────────────────────────
  {
    ...
    kind: 'snippet',
    detail: 'Annotation',
    insertText: '#[debug, profile("gpu"), editor_only]',
    documentation: 'Metadata annotations: #[key, key(value)]',
  },
  ...
  },
  {
    ...
    insertText: 'dashboard "Name" {\n  layout: "grid"\n  refresh: 5000\n}',
  },
  {
    label: 'lesson',
    kind: 'block',
    detail: 'Educational lesson',
    insertText: 'lesson "Name" {\n  objective: ""\n}',
  },
  {
    label: 'contract',
    kind: 'block',
    detail: 'Web3 smart contract',
    insertText: 'contract "Name" {\n  chain: "base"\n  standard: "ERC-721"\n}',
  },
  {
    label: 'test',
    kind: 'block',
    detail: 'Test block',
    insertText: 'test "description" {\n  given { }\n  when { }\n  then { assert true }\n}',
  ...
  // ── Physics container ───────────────────────────────────────────────────
  {
    label: 'physics',
    kind: 'block',
    detail: 'Physics container block',
    insertText:
...
const BLOCK_PROPERTY_MAP: Record<string, CompletionItem[]> = {
  ...
  material: [
    ...
    { label: 'metallic', kind: 'property', detail: '0.0 - 1.0', insertText: 'metallic: 0.0' },
    {
      ...
      insertText: 'emissive_color: "#000000"',
    },
    {
      label: 'emissive_intensity',
      kind: 'property',
      detail: 'Emission strength',
      insertText: 'emissive_intensity: 1.0',
    },
    ...
    { label: 'ior', kind: 'property', detail: 'Index of refraction', insertText: 'ior: 1.5' },
    {
      label: 'transmission',
      kind: 'property',
      detail: '0.0 - 1.0 (glass)',
      insertText: 'transmission: 0.0',
    },
    { label: 'clearcoat', kind: 'property', detail: '0.0 - 1.0', insertText: 'clearcoat: 0.0' },
    {
      label: 'clearcoat_roughness',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'clearcoat_roughness: 0.0',
    },
    { label: 'sheen', kind: 'property', detail: '0.0 - 1.0 (fabric)', insertText: 'sheen: 0.0' },
    {
      label: 'sheen_roughness',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'sheen_roughness: 0.5',
    },
    { label: 'anisotropy', kind: 'property', detail: '0.0 - 1.0', insertText: 'anisotropy: 0.0' },
    {
      label: 'anisotropy_rotation',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'anisotropy_rotation: 0.0',
    },
    {
      label: 'subsurface_color',
      kind: 'property',
      detail: 'SSS color',
      insertText: 'subsurface_color: "#ff4444"',
    },
    {
      label: 'subsurface_radius',
      kind: 'property',
      detail: 'SSS radius [R,G,B]',
      insertText: 'subsurface_radius: [1.0, 0.2, 0.1]',
    },
    ...
    {
      label: 'iridescence_ior',
      kind: 'property',
      detail: 'Iridescence IOR',
      insertText: 'iridescence_ior: 1.3',
    },
    {
      label: 'alpha_mode',
      kind: 'property',
      detail: '"opaque"|"blend"|"mask"',
      insertText: 'alpha_mode: "opaque"',
    },
    {
      label: 'alpha_cutoff',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'alpha_cutoff: 0.5',
    },
    {
      label: 'normal_scale',
      kind: 'property',
      detail: 'Normal map strength',
      insertText: 'normal_scale: 1.0',
    },
  ],
  pbr_material: [
    {
  ...
  unlit_material: [
    {
      ...
      kind: 'property',
      detail: 'Flat color',
      insertText: 'emissive_color: "#ffffff"',
    },
    { label: 'opacity', kind: 'property', detail: '0.0 - 1.0', insertText: 'opacity: 1.0' },
    {
      label: 'alpha_mode',
  ...
  toon_material: [
    ...
    },
    {
      label: 'outline_width',
      kind: 'property',
      detail: 'Outline thickness',
      insertText: 'outline_width: 0.02',
    },
    {
      label: 'outline_color',
      kind: 'property',
      detail: 'Outline color',
      insertText: 'outline_color: "#000000"',
    },
    {
      label: 'shading_steps',
      kind: 'property',
      detail: 'Discrete shading bands',
      insertText: 'shading_steps: 3',
    },
    {
      label: 'specular_size',
      kind: 'property',
      detail: 'Specular highlight size',
      insertText: 'specular_size: 0.2',
    },
  ],
  glass_material: [
    {
    ...
    { label: 'opacity', kind: 'property', detail: '0.0 - 1.0', insertText: 'opacity: 0.3' },
    {
      label: 'ior',
      kind: 'property',
      detail: 'Index of refraction (1.0-2.5)',
      insertText: 'ior: 1.52',
    },
    {
      label: 'transmission',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'transmission: 0.95',
    },
    {
      label: 'roughness',
      kind: 'property',
      detail: '0.0 - 1.0 (frosted)',
      insertText: 'roughness: 0.0',
    },
  ],
  subsurface_material: [
    {
      label: 'baseColor',
      kind: 'property',
      detail: 'Surface color',
      insertText: 'baseColor: "#ffddcc"',
    },
    {
      label: 'subsurface_color',
      kind: 'property',
      detail: 'Scatter color',
      insertText: 'subsurface_color: "#ff4444"',
    },
    {
      label: 'subsurface_radius',
      kind: 'property',
      detail: 'Scatter radius [R,G,B]',
      insertText: 'subsurface_radius: [1.0, 0.2, 0.1]',
    },
    {
      label: 'thickness',
      kind: 'property',
      detail: 'Material thickness',
      insertText: 'thickness: 0.5',
    },
  ...
  shader: [
    {
      label: 'vertex',
      kind: 'property',
      detail: 'Vertex shader path',
      insertText: 'vertex: "shaders/vert.glsl"',
    },
    {
      label: 'fragment',
      kind: 'property',
      detail: 'Fragment shader path',
      insertText: 'fragment: "shaders/frag.glsl"',
    },
    {
      label: 'compute',
      kind: 'property',
      detail: 'Compute shader path',
      insertText: 'compute: "shaders/compute.glsl"',
    },
    {
      label: 'defines',
      kind: 'property',
      detail: 'Preprocessor defines',
      insertText: 'defines: { "USE_NORMAL_MAP": true }',
    },
  ],
  ...
  texture_map: [
    {
      label: 'source',
      kind: 'property',
      detail: 'Texture file path',
      insertText: 'source: "textures/texture.png"',
    },
    ...
    { label: 'offset', kind: 'property', detail: 'UV offset [x, y]', insertText: 'offset: [0, 0]' },
    {
      label: 'filtering',
      kind: 'property',
      detail: '"bilinear"|"trilinear"|"nearest"',
      insertText: 'filtering: "trilinear"',
    },
    {
      label: 'wrap',
      kind: 'property',
      detail: '"repeat"|"clamp"|"mirror"',
      insertText: 'wrap: "repeat"',
    },
    {
      label: 'strength',
      kind: 'property',
      detail: 'Map influence 0.0-1.0',
      insertText: 'strength: 1.0',
    },
  ...
  pass: [
    ...
    },
    {
      label: 'blend_mode',
      kind: 'property',
      detail: '"opaque"|"alpha"|"additive"',
      insertText: 'blend_mode: "opaque"',
    },
    {
      label: 'cull',
      kind: 'property',
      detail: '"back"|"front"|"none"',
    ...
    { label: 'depth_write', kind: 'property', detail: 'Boolean', insertText: 'depth_write: true' },
    {
      label: 'stencil',
      kind: 'property',
      detail: 'Stencil operations',
      insertText: 'stencil: { ref: 1 comp: "always" }',
    },
  ],
  ...
  collider: [
    {
      label: 'radius',
      kind: 'property',
      detail: 'Sphere/capsule radius',
      insertText: 'radius: 0.5',
    },
    {
      label: 'size',
      kind: 'property',
      detail: 'Box extents [x, y, z]',
      insertText: 'size: [1, 1, 1]',
    },
    {
      label: 'height',
      kind: 'property',
      detail: 'Capsule/cylinder height',
      insertText: 'height: 2.0',
    },
    { label: 'is_trigger', kind: 'property', detail: 'Boolean', insertText: 'is_trigger: false' },
    {
      ...
      kind: 'property',
      detail: 'Offset [x, y, z]',
      insertText: 'center: [0, 0, 0]',
    },
    {
      label: 'mesh',
      kind: 'property',
      detail: 'Mesh collider source',
      insertText: 'mesh: "collision.glb"',
    },
    { label: 'convex', kind: 'property', detail: 'Force convex hull', insertText: 'convex: true' },
    {
      label: 'friction',
      kind: 'property',
      detail: 'Surface friction',
      insertText: 'friction: 0.5',
    },
    {
      label: 'bounciness',
      kind: 'property',
      detail: 'Restitution 0.0-1.0',
      insertText: 'bounciness: 0.3',
    },
  ...
  rigidbody: [
    ...
    { label: 'use_gravity', kind: 'property', detail: 'Boolean', insertText: 'use_gravity: true' },
    {
      ...
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'linear_damping: 0.0',
    },
    {
      label: 'angular_damping',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'angular_damping: 0.05',
    },
    {
      label: 'is_kinematic',
      kind: 'property',
      detail: 'Boolean',
      insertText: 'is_kinematic: false',
    },
    {
      label: 'freeze_position',
      kind: 'property',
      detail: 'Frozen axes [x, y, z]',
      insertText: 'freeze_position: [false, false, false]',
    },
    {
      label: 'freeze_rotation',
      kind: 'property',
      detail: 'Frozen axes [x, y, z]',
      insertText: 'freeze_rotation: [false, false, false]',
    },
    {
      label: 'center_of_mass',
      kind: 'property',
      detail: 'Override CoM [x, y, z]',
      insertText: 'center_of_mass: [0, 0, 0]',
    },
    {
      label: 'collision_detection',
      kind: 'property',
      detail: '"discrete"|"continuous"',
      insertText: 'collision_detection: "discrete"',
    },
    {
      label: 'interpolation',
      kind: 'property',
      detail: '"none"|"interpolate"|"extrapolate"',
      insertText: 'interpolation: "interpolate"',
    },
  ],
  ...
  force_field: [
    { label: 'strength', kind: 'property', detail: 'Force magnitude', insertText: 'strength: 5.0' },
    {
      label: 'direction',
      kind: 'property',
      detail: 'Force direction [x, y, z]',
      insertText: 'direction: [0, 1, 0]',
    },
    {
      label: 'falloff',
      kind: 'property',
      detail: '"none"|"linear"|"inverse_square"',
      insertText: 'falloff: "linear"',
    },
    { label: 'radius', kind: 'property', detail: 'Effect radius', insertText: 'radius: 10.0' },
    {
      label: 'shape',
      kind: 'property',
      detail: '"sphere"|"box"|"infinite"',
      insertText: 'shape: "sphere"',
    },
  ],
  gravity_zone: [
    {
      label: 'gravity',
      kind: 'property',
      detail: 'Gravity vector [x, y, z]',
      insertText: 'gravity: [0, -9.81, 0]',
    },
    { label: 'shape', kind: 'property', detail: '"box"|"sphere"', insertText: 'shape: "box"' },
    {
      label: 'bounds',
      kind: 'property',
      detail: 'Zone size [x, y, z]',
      insertText: 'bounds: [10, 10, 10]',
    },
  ...
  wind_zone: [
    {
      label: 'direction',
      kind: 'property',
      detail: 'Wind direction [x, y, z]',
      insertText: 'direction: [1, 0, 0]',
    },
    { label: 'strength', kind: 'property', detail: 'Wind speed', insertText: 'strength: 3.0' },
    {
      label: 'turbulence',
      kind: 'property',
      detail: 'Turbulence 0.0-1.0',
      insertText: 'turbulence: 0.5',
    },
    {
      label: 'pulse_magnitude',
      kind: 'property',
      detail: 'Gust strength',
      insertText: 'pulse_magnitude: 0.3',
    },
    {
      label: 'pulse_frequency',
      kind: 'property',
      detail: 'Gust frequency Hz',
      insertText: 'pulse_frequency: 0.5',
    },
  ],
  buoyancy_zone: [
    {
      label: 'density',
      kind: 'property',
      detail: 'Fluid density (kg/m3)',
      insertText: 'density: 1000',
    },
    {
      label: 'surface_height',
      kind: 'property',
      detail: 'Water surface Y',
      insertText: 'surface_height: 0.0',
    },
    { label: 'drag', kind: 'property', detail: 'Fluid drag', insertText: 'drag: 0.3' },
    {
      label: 'angular_drag',
      kind: 'property',
      detail: 'Rotational drag',
      insertText: 'angular_drag: 0.1',
    },
    {
      label: 'flow_direction',
      kind: 'property',
      detail: 'Current [x, y, z]',
      insertText: 'flow_direction: [0, 0, 0]',
    },
  ],
  magnetic_field: [
    { label: 'strength', kind: 'property', detail: 'Field strength', insertText: 'strength: 10.0' },
    {
      label: 'pole',
      kind: 'property',
      detail: 'Pole direction [x, y, z]',
      insertText: 'pole: [0, 1, 0]',
    },
    { label: 'radius', kind: 'property', detail: 'Effect radius', insertText: 'radius: 5.0' },
    {
      label: 'attract_tags',
      kind: 'property',
      detail: 'Attracted object tags',
      insertText: 'attract_tags: ["metal"]',
    },
  ],
  drag_zone: [
    {
      label: 'linear_drag',
      kind: 'property',
      detail: 'Linear resistance',
      insertText: 'linear_drag: 0.5',
    },
    {
      label: 'angular_drag',
      kind: 'property',
      detail: 'Rotational resistance',
      insertText: 'angular_drag: 0.3',
    },
    { label: 'shape', kind: 'property', detail: '"box"|"sphere"', insertText: 'shape: "box"' },
    {
      label: 'bounds',
  ...
  articulation: [
    ...
    {
      label: 'immovable_base',
      kind: 'property',
      detail: 'Fixed root',
      insertText: 'immovable_base: true',
    },
    {
      label: 'solver_iterations',
      kind: 'property',
      detail: 'Physics solver steps',
      insertText: 'solver_iterations: 10',
    },
    {
      label: 'collision_enabled',
      kind: 'property',
      detail: 'Inter-link collision',
      insertText: 'collision_enabled: false',
    },
  ],
  joint: [
    {
      label: 'type',
      kind: 'property',
      detail: '"revolute"|"prismatic"|"fixed"|"spherical"',
      insertText: 'type: "revolute"',
    },
    {
      label: 'axis',
      kind: 'property',
      detail: 'Rotation axis [x, y, z]',
      insertText: 'axis: [0, 1, 0]',
    },
    {
      label: 'limits',
      kind: 'property',
      detail: '[min, max] degrees',
      insertText: 'limits: [-90, 90]',
    },
    { label: 'damping', kind: 'property', detail: 'Joint damping', insertText: 'damping: 0.1' },
    {
      label: 'stiffness',
      kind: 'property',
      detail: 'Joint stiffness',
      insertText: 'stiffness: 0.0',
    },
    {
      label: 'motor_speed',
      kind: 'property',
      detail: 'Motor target speed',
      insertText: 'motor_speed: 0',
    },
    {
      label: 'max_force',
      kind: 'property',
      detail: 'Motor max force',
      insertText: 'max_force: 100',
    },
    {
      label: 'connected_body',
      kind: 'property',
      detail: 'Connected rigidbody',
      insertText: 'connected_body: "BodyB"',
    },
    {
      label: 'anchor',
      kind: 'property',
      detail: 'Joint anchor [x, y, z]',
      insertText: 'anchor: [0, 0, 0]',
    },
    {
      label: 'break_force',
      kind: 'property',
      detail: 'Force to break joint',
      insertText: 'break_force: 1000',
    },
  ],
  hinge: [
  ...
  slider: [
    { label: 'axis', kind: 'property', detail: 'Slide axis', insertText: 'axis: [1, 0, 0]' },
    {
      label: 'limits',
      kind: 'property',
      detail: '[min, max] meters',
      insertText: 'limits: [0, 2]',
    },
  ...
  ball_socket: [
    {
      label: 'swing_limit',
      kind: 'property',
      detail: 'Swing cone degrees',
      insertText: 'swing_limit: 45',
    },
    {
      label: 'twist_limit',
      kind: 'property',
      detail: 'Twist degrees',
      insertText: 'twist_limit: 30',
    },
    { label: 'damping', kind: 'property', detail: 'Joint damping', insertText: 'damping: 0.1' },
  ],
  fixed_joint: [
    {
      label: 'break_force',
      kind: 'property',
      detail: 'Force to break',
      insertText: 'break_force: 1000',
    },
    {
      label: 'break_torque',
      kind: 'property',
      detail: 'Torque to break',
      insertText: 'break_torque: 1000',
    },
  ],
  d6_joint: [
    {
      label: 'x_motion',
      kind: 'property',
      detail: '"locked"|"limited"|"free"',
      insertText: 'x_motion: "locked"',
    },
    {
      label: 'y_motion',
      kind: 'property',
      detail: '"locked"|"limited"|"free"',
      insertText: 'y_motion: "limited"',
    },
    {
      label: 'z_motion',
      kind: 'property',
      detail: '"locked"|"limited"|"free"',
      insertText: 'z_motion: "free"',
    },
    {
      label: 'swing1_limit',
      kind: 'property',
      detail: 'Swing1 degrees',
      insertText: 'swing1_limit: 45',
    },
    {
      label: 'swing2_limit',
      kind: 'property',
      detail: 'Swing2 degrees',
      insertText: 'swing2_limit: 45',
    },
    {
      label: 'twist_limit',
      kind: 'property',
    ...
    },
    {
      label: 'linear_limit',
      kind: 'property',
      detail: 'Linear distance',
      insertText: 'linear_limit: 1.0',
    },
  ],
  spring_joint: [
    {
      label: 'stiffness',
      kind: 'property',
      detail: 'Spring stiffness',
      insertText: 'stiffness: 100',
    },
  ...
  particles: [
    {
      ...
      kind: 'property',
      detail: 'Max count',
      insertText: 'max_particles: 500',
    },
    {
      label: 'duration',
      kind: 'property',
      detail: 'Seconds (-1 = infinite)',
    ...
    { label: 'world_space', kind: 'property', detail: 'Boolean', insertText: 'world_space: true' },
    {
      label: 'start_speed',
      kind: 'property',
      detail: 'Initial speed',
      insertText: 'start_speed: 5.0',
    },
    {
      label: 'start_size',
      kind: 'property',
      detail: 'Initial size',
      insertText: 'start_size: 0.1',
    },
    {
      label: 'start_color',
      kind: 'property',
      detail: 'Initial color',
      insertText: 'start_color: "#ffffff"',
    },
    {
      label: 'start_lifetime',
      kind: 'property',
      detail: 'Lifetime seconds',
      insertText: 'start_lifetime: 2.0',
    },
    {
      label: 'gravity_modifier',
      kind: 'property',
      detail: 'Gravity scale',
      insertText: 'gravity_modifier: 1.0',
    },
    {
      label: 'simulation_speed',
      kind: 'property',
      detail: 'Playback speed',
      insertText: 'simulation_speed: 1.0',
    },
  ...
  emitter: [
    { label: 'rate', kind: 'property', detail: 'Emission rate/sec', insertText: 'rate: 100' },
    {
      label: 'shape',
      kind: 'property',
      detail: '"cone"|"sphere"|"box"|"edge"',
      insertText: 'shape: "cone"',
    },
  ...
  audio_source: [
    ...
    { label: 'loop', kind: 'property', detail: 'Boolean', insertText: 'loop: true' },
    {
      ...
      kind: 'property',
      detail: 'Auto-play',
      insertText: 'play_on_awake: true',
    },
    {
      label: 'spatialization',
      kind: 'property',
      detail: '"hrtf"|"stereo"|"off"',
      insertText: 'spatialization: "hrtf"',
    },
    {
      label: 'min_distance',
      kind: 'property',
      detail: 'Min distance',
      insertText: 'min_distance: 1',
    },
    {
      label: 'max_distance',
      kind: 'property',
      detail: 'Max distance',
      insertText: 'max_distance: 50',
    },
    {
      label: 'rolloff',
      kind: 'property',
      detail: '"logarithmic"|"linear"|"custom"',
      insertText: 'rolloff: "logarithmic"',
    },
    {
      label: 'doppler_level',
      kind: 'property',
      detail: '0.0 - 5.0',
      insertText: 'doppler_level: 1.0',
    },
    { label: 'spread', kind: 'property', detail: 'Stereo spread 0-360', insertText: 'spread: 0' },
    {
      label: 'priority',
      kind: 'property',
      detail: '0 (highest) - 256',
      insertText: 'priority: 128',
    },
  ],
  audio_listener: [
  ...
  reverb_zone: [
    {
      label: 'decay_time',
      kind: 'property',
      detail: 'Reverb decay seconds',
      insertText: 'decay_time: 2.0',
    },
    ...
    {
      label: 'high_freq_damping',
      kind: 'property',
      detail: '0.0 - 1.0',
      insertText: 'high_freq_damping: 0.5',
    },
    {
      label: 'min_distance',
      kind: 'property',
      detail: 'Inner radius',
      insertText: 'min_distance: 5',
    },
    {
      label: 'max_distance',
      kind: 'property',
      detail: 'Outer radius',
      insertText: 'max_distance: 20',
    },
  ],
  audio_mixer: [
  ...
  ambience: [
    ...
    { label: 'loop', kind: 'property', detail: 'Boolean', insertText: 'loop: true' },
    {
      label: 'crossfade',
      kind: 'property',
      detail: 'Crossfade seconds',
      insertText: 'crossfade: 2.0',
    },
  ],
  ...
  weather: [
    {
      label: 'intensity',
      kind: 'property',
      detail: 'Overall weather intensity',
      insertText: 'intensity: 0.5',
    },
    {
      label: 'transition_time',
      kind: 'property',
      detail: 'Blend time seconds',
      insertText: 'transition_time: 5.0',
    },
  ],
  ...
  procedural: [
    { label: 'seed', kind: 'property', detail: 'Random seed', insertText: 'seed: 42' },
    {
      label: 'resolution',
      kind: 'property',
      detail: 'Grid resolution',
      insertText: 'resolution: 256',
    },
    {
      label: 'size',
      kind: 'property',
      detail: 'World size [x, z]',
      insertText: 'size: [1000, 1000]',
    },
  ],
  scatter: [
    ...
    { label: 'seed', kind: 'property', detail: 'Random seed', insertText: 'seed: 42' },
    {
      label: 'pattern',
      kind: 'property',
      detail: '"random"|"poisson"|"grid"',
      insertText: 'pattern: "poisson"',
    },
    {
      label: 'min_distance',
      kind: 'property',
      detail: 'Min between items',
      insertText: 'min_distance: 1.0',
    },
    {
      label: 'align_to_surface',
      kind: 'property',
      detail: 'Boolean',
      insertText: 'align_to_surface: true',
    },
  ],
  ...
  lod: [
    {
      label: 'fade_mode',
      kind: 'property',
      detail: '"cross_fade"|"speed_tree"|"none"',
      insertText: 'fade_mode: "cross_fade"',
    },
    {
      label: 'fade_width',
      kind: 'property',
      detail: 'Cross-fade distance',
      insertText: 'fade_width: 5.0',
    },
  ],
  render: [
    {
      ...
      kind: 'property',
      detail: 'Boolean',
      insertText: 'cast_shadows: true',
    },
    {
      label: 'receive_shadows',
      kind: 'property',
      detail: 'Boolean',
      insertText: 'receive_shadows: true',
    },
    {
      label: 'layer',
      kind: 'property',
      detail: '"opaque"|"transparent"|"overlay"',
      insertText: 'layer: "opaque"',
    },
    {
      label: 'render_queue',
      kind: 'property',
      detail: 'Render order integer',
      insertText: 'render_queue: 2000',
    },
    {
      label: 'lightmap',
      kind: 'property',
      detail: 'Lightmap mode',
      insertText: 'lightmap: "baked"',
    },
  ],
  ...
  navmesh: [
    {
      ...
      kind: 'property',
      detail: 'Agent radius',
      insertText: 'agent_radius: 0.5',
    },
    {
      label: 'agent_height',
      kind: 'property',
      detail: 'Agent height',
      insertText: 'agent_height: 2.0',
    },
    {
      label: 'max_slope',
      kind: 'property',
      detail: 'Max walkable slope degrees',
      insertText: 'max_slope: 45',
    },
    {
      label: 'step_height',
      kind: 'property',
      detail: 'Max step height',
      insertText: 'step_height: 0.3',
    },
    {
      label: 'cell_size',
      kind: 'property',
      detail: 'Voxel cell size',
      insertText: 'cell_size: 0.3',
    },
    {
      label: 'cell_height',
      kind: 'property',
      detail: 'Voxel cell height',
      insertText: 'cell_height: 0.2',
    },
  ],
  nav_agent: [
    { label: 'speed', kind: 'property', detail: 'Movement speed', insertText: 'speed: 3.5' },
    {
      label: 'acceleration',
      kind: 'property',
      detail: 'Acceleration rate',
      insertText: 'acceleration: 8',
    },
    {
      label: 'stopping_distance',
      kind: 'property',
      detail: 'Stop threshold',
      insertText: 'stopping_distance: 0.5',
    },
    {
      label: 'auto_braking',
      kind: 'property',
      detail: 'Boolean',
      insertText: 'auto_braking: true',
    },
    {
      label: 'avoidance_priority',
      kind: 'property',
      detail: '0-99 (lower=higher)',
      insertText: 'avoidance_priority: 50',
    },
  ],
  behavior_tree: [
    { label: 'tick_rate', kind: 'property', detail: 'Update rate Hz', insertText: 'tick_rate: 10' },
    {
      label: 'restart_on_complete',
      kind: 'property',
      detail: 'Boolean',
      insertText: 'restart_on_complete: true',
    },
  ],
  obstacle: [
    ...
    { label: 'size', kind: 'property', detail: 'Obstacle size', insertText: 'size: [2, 2, 2]' },
    {
      ...
      kind: 'property',
      detail: 'Re-carve threshold',
      insertText: 'move_threshold: 0.1',
    },
  ],
  nav_link: [
    ...
    { label: 'end', kind: 'property', detail: 'End position', insertText: 'end: [5, 2, 0]' },
    {
      ...
      kind: 'property',
      detail: 'Boolean',
      insertText: 'bidirectional: true',
    },
    {
      label: 'cost_modifier',
      kind: 'property',
      detail: 'Traversal cost',
      insertText: 'cost_modifier: 1.0',
    },
  ],
  crowd_manager: [
    {
      label: 'max_agents',
      kind: 'property',
      detail: 'Max concurrent agents',
      insertText: 'max_agents: 100',
    },
    {
      label: 'separation',
      kind: 'property',
      detail: 'Agent separation distance',
      insertText: 'separation: 0.5',
    },
    {
      label: 'obstacle_avoidance',
      kind: 'property',
      detail: '"low"|"medium"|"high"',
      insertText: 'obstacle_avoidance: "medium"',
    },
  ],
  ...
  input: [
    {
      label: 'move',
      kind: 'property',
      detail: 'Movement binding',
      insertText: 'move: "left_stick"',
    },
    { label: 'jump', kind: 'property', detail: 'Jump binding', insertText: 'jump: "button_a"' },
    {
      label: 'look',
      kind: 'property',
      detail: 'Camera look binding',
      insertText: 'look: "right_stick"',
    },
    {
      label: 'interact',
      kind: 'property',
      detail: 'Interact binding',
      insertText: 'interact: "button_x"',
    },
    {
      label: 'fire',
      kind: 'property',
      detail: 'Fire/action binding',
      insertText: 'fire: "trigger_right"',
    },
    ...
    { label: 'menu', kind: 'property', detail: 'Menu binding', insertText: 'menu: "button_menu"' },
    {
      label: 'deadzone',
      kind: 'property',
      detail: 'Stick deadzone 0.0-1.0',
      insertText: 'deadzone: 0.15',
    },
    {
      label: 'sensitivity',
      kind: 'property',
      detail: 'Input sensitivity',
      insertText: 'sensitivity: 1.0',
    },
  ],
  interaction: [
    {
      label: 'type',
      kind: 'property',
      detail: '"grab"|"poke"|"ray"|"gaze"',
      insertText: 'type: "grab"',
    },
    ...
    { label: 'range', kind: 'property', detail: 'Interaction range', insertText: 'range: 2.0' },
    {
      ...
      kind: 'property',
      detail: 'Boolean',
      insertText: 'haptic_feedback: true',
    },
  ],
  gesture_profile: [
    {
      label: 'gestures',
      kind: 'property',
      detail: 'Recognized gestures',
      insertText: 'gestures: ["pinch", "wave", "point"]',
    },
  ...
  controller_map: [
    ...
    { label: 'grip', kind: 'property', detail: 'Grip action', insertText: 'grip: "grab"' },
    {
      label: 'thumbstick',
      kind: 'property',
      detail: 'Thumbstick action',
      insertText: 'thumbstick: "move"',
    },
    {
      label: 'button_a',
      kind: 'property',
      detail: 'A button action',
      insertText: 'button_a: "jump"',
    },
    {
      label: 'button_b',
      kind: 'property',
      detail: 'B button action',
      insertText: 'button_b: "crouch"',
    },
  ],
...
const BLOCK_SUBBLOCK_MAP: Record<string, CompletionItem[]> = {
  ...
  material: BLOCK_COMPLETIONS.filter((c) => c.label.endsWith('_map') || c.label === 'pass'),
  pbr_material: BLOCK_COMPLETIONS.filter((c) => c.label.endsWith('_map') || c.label === 'pass'),
  unlit_material: BLOCK_COMPLETIONS.filter(
    (c) => c.label === 'emission_map' || c.label === 'opacity_map'
  ),
  shader: BLOCK_COMPLETIONS.filter((c) => c.label === 'pass'),
  toon_material: BLOCK_COMPLETIONS.filter((c) => c.label.endsWith('_map') || c.label === 'pass'),
  glass_material: BLOCK_COMPLETIONS.filter((c) => c.label.endsWith('_map') || c.label === 'pass'),
  subsurface_material: BLOCK_COMPLETIONS.filter(
    (c) => c.label.endsWith('_map') || c.label === 'pass'
  ),
  ...
  container: V6_TRAIT_COMPLETIONS.filter((c) =>
    ['deployment', 'scaling', 'secret', 'dockerfile', 'kubernetes_pod', 'helm_chart'].includes(
      c.label
    )
  ),
  ...
  network: V6_TRAIT_COMPLETIONS.filter((c) =>
    ['http', 'websocket', 'grpc', 'graphql', 'tls_config', 'jwt_config', 'oauth2_config'].includes(
      c.label
    )
  ),
};
...
export class CompletionProvider {
  ...
  getCompletions(context: {
    ...
    if (context.triggerChar === '#' || prefix.startsWith('#[')) {
      return [
        { label: 'debug', kind: 'snippet', detail: 'Debug annotation', insertText: 'debug' },
        {
          label: 'profile',
          kind: 'snippet',
          detail: 'Profile annotation',
          insertText: 'profile("gpu")',
        },
        {
          label: 'editor_only',
          kind: 'snippet',
          detail: 'Editor-only annotation',
          insertText: 'editor_only',
        },
        {
          label: 'deprecated',
          kind: 'snippet',
          detail: 'Deprecation annotation',
          insertText: 'deprecated("reason")',
        },
        {
          label: 'serialize',
          kind: 'snippet',
          detail: 'Serialization hint',
          insertText: 'serialize',
        },
        {
          label: 'inspect',
          kind: 'snippet',
          detail: 'Inspector visibility',
          insertText: 'inspect',
        },
        {
          label: 'range',
          kind: 'snippet',
          detail: 'Value range constraint',
          insertText: 'range(0, 1)',
        },
        {
          label: 'tooltip',
          kind: 'snippet',
          detail: 'Tooltip text',
          insertText: 'tooltip("description")',
        },
      ];
    }
    ...
    if (context.blockContext) {
      ...
      if (blockProps.length > 0 || subBlocks.length > 0) {
        return [...blockProps, ...subBlocks, ...PROPERTY_COMPLETIONS].filter(
          (c) => !prefix || c.label.toLowerCase().startsWith(prefix)
        );
      }
    }
  ...
  get totalCompletions(): number {
    return (
      ...
      BLOCK_COMPLETIONS.length +
      HSPLUS_COMPLETIONS.length +
