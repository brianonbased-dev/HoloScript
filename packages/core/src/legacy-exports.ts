...
export {
  ...
  renderDecisionSvg,
  type DecisionEvent,
  type DecisionNetworkOptions,
} from './cognition/decision-network';
...
export {
  ...
  type AnimationChannelContribution,
  type AnimationResolvedChannel,
  type AnimationOutputSnapshot,
  type AnimationUtilizationBackend,
  type AnimationOutputUtilization,
  type AnimationUtilizationEvidence,
