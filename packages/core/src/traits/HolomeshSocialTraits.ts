...
export const agentProfileHandler: TraitHandler<AgentProfileConfig> = {
  ...
  onEvent(node, _config, context, event) {
    const state = node.__agentProfileState as Record<string, any>;
    if (!state) return;
...
export const profileThemeHandler: TraitHandler<ProfileThemeConfig> = {
  ...
  onEvent(node, _config, context, event) {
    const state = node.__profileThemeState as Record<string, any>;
    if (!state) return;
...
export const statusMoodHandler: TraitHandler<StatusMoodConfig> = {
  ...
  onUpdate(node, config, context, _delta) {
    const state = node.__statusMoodState as Record<string, any>;
    if (!state) return;
...
export const agentBadgeHandler: TraitHandler<AgentBadgeConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__agentBadgeState as Record<string, any>;
    if (!state) return;
...
export const visitorCounterHandler: TraitHandler<VisitorCounterConfig> = {
  ...
  onUpdate(node, config, _context, _delta) {
    const state = node.__visitorCounterState as Record<string, any>;
    if (!state) return;
...
export const top8FriendsHandler: TraitHandler<Top8FriendsConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__top8FriendsState as Record<string, any>;
    if (!state) return;
...
export const guestbookHandler: TraitHandler<GuestbookConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__guestbookState as Record<string, any>;
    if (!state) return;
...
export const agentWallHandler: TraitHandler<AgentWallConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__agentWallState as Record<string, any>;
    if (!state) return;
...
export const agentRoomHandler: TraitHandler<AgentRoomConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__agentRoomState as Record<string, any>;
    if (!state) return;
...
export const backgroundMusicHandler: TraitHandler<BackgroundMusicConfig> = {
  ...
  onDetach(node, _config, context) {
    const state = node.__backgroundMusicState as Record<string, any>;
...
export const spatialCommentHandler: TraitHandler<SpatialCommentConfig> = {
  ...
  onUpdate(node, config, _context, _delta) {
    ...
    const state = node.__spatialCommentState as Record<string, any>;
    if (!state) return;
...
export const roomPortalHandler: TraitHandler<RoomPortalConfig> = {
  ...
  onEvent(node, _config, context, event) {
    const state = node.__roomPortalState as Record<string, any>;
    if (!state) return;
...
export const traitShowcaseHandler: TraitHandler<TraitShowcaseConfig> = {
  ...
  onEvent(node, config, context, event) {
    const state = node.__traitShowcaseState as Record<string, any>;
    if (!state) return;
