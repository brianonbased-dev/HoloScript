...
export const timeTravelDebugHandler: TraitHandler<TimeTravelDebugConfig> = {
  ...
  onAttach(node: any): void { node.__ttdState = { snapshots: [] as Array<{ frame: number; data: unknown }>, cursor: -1 }; },
  onDetach(node: any): void { delete node.__ttdState; },
  onUpdate(): void {},
  onEvent(node: any, config: TimeTravelDebugConfig, context: any, event: any): void {
