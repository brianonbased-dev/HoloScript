...
export const renderPipelineHandler: TraitHandler<RenderPipelineConfig> = {
  ...
  onAttach(node: any): void { node.__rpState = { passes: [] as string[], active: false }; },
  onDetach(node: any): void { delete node.__rpState; },
  onUpdate(): void {},
  onEvent(node: any, config: RenderPipelineConfig, context: any, event: any): void {
