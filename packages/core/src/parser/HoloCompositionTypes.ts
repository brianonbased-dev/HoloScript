...
export type HoloDomainType =
  ...
  | 'physics_contract' // physics_contract: typed rigid-body + constraint stack lowered to a WGSL semi-implicit-Euler + PBD compute solve (Unreal Chaos / PhysX outbuild, CG-313)
