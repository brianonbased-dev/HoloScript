 ...
 *
 * @version 1.0.0 (Phase 2(b) - markdown_ssot emitter only;
 *   ts_adapter_capabilities + cost_guard_pricing + json_capability_matrix
 *   are filed Phase 2(b) follow-ups)
...
export class LLMProviderCapabilitiesCompiler extends CompilerBase {
   ...
   *   3. emit     - dispatch to per-format emitters (markdown_ssot is
   *                 the only one in this Phase 2(b) commit; the other
   *                 three are filed follow-ups)
   */
  compile(
