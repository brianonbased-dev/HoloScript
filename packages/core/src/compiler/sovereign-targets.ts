...
export const SOVEREIGN_ENGINES = [
  ...
  },
  {
    ...
    tests: false,
    promoted: false,
    note: 'HS UI traits → flat DOM/Tailwind/React. The D.080 HS-native console base. Emits an "@generated by HoloScript" header. No unit test.',
  },
  {
    id: 'canvas2d-game',
    ...
    tests: false,
    promoted: false,
    note: 'I.017 "2D-game compiler COMPLETE". Trait→self-contained offline HTML canvas game. No unit test.',
  },
  {
    id: 'webgpu-compiler',
    name: 'WebGPUCompiler',
