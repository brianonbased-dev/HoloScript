...
describe('ANSNamespace', () => {
  ...
  describe('ANSCapabilityPath constants', () => {
    it('should define exactly 45 capability paths', () => {
      expect(Object.keys(ANSCapabilityPath)).toHaveLength(45);
    });
  ...
  describe('COMPILER_DOMAIN_MAP', () => {
    it('should map exactly 45 compilers', () => {
      expect(Object.keys(COMPILER_DOMAIN_MAP)).toHaveLength(45);
    });
  ...
  describe('COMPILER_ANS_MAP', () => {
    it('should map exactly 45 compilers to paths', () => {
      expect(Object.keys(COMPILER_ANS_MAP)).toHaveLength(45);
    });
  ...
  describe('ALL_COMPILER_NAMES', () => {
    it('should contain exactly 45 names', () => {
      expect(ALL_COMPILER_NAMES).toHaveLength(45);
    });
  ...
  describe('getAllCompilersInDomain()', () => {
    ...
    it('should return 8 compilers for ai', () => {
      ...
      expect(compilers).toContain('daimon-seed');
      expect(compilers).toContain('hsi-ir');
    ...
    it('total across all domains should equal 45', () => {
      let total = 0;
      for (const domain of ALL_DOMAINS) {
  ...
  describe('getAllCompilersWithRiskTier()', () => {
    ...
    it('should return compilers for HIGH tier', () => {
      ...
      // social-vr(1) + xr(8) + mobile(2) + runtime(4) + iot(1) + ai(8) + neuromorphic(1) + edge(1) = 26
      expect(compilers).toHaveLength(26);
      expect(compilers).toContain('vrchat');
      expect(compilers).toContain('openxr');
      expect(compilers).toContain('android');
      expect(compilers).toContain('wasm');
    ...
    it('total across all tiers should equal 45', () => {
      ...
      expect(standard + high + critical).toBe(45);
    });
  });
  ...
  describe('getANSSummary()', () => {
    it('should return correct total counts', () => {
      ...
      expect(summary.totalCompilers).toBe(45);
