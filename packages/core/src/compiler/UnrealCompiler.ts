...
export class UnrealCompiler extends CompilerBase {
  ...
  private generateHeader(composition: HoloComposition): string {
    ...
    this.emitH(`// Source: composition "${this.escapeStringValue(composition.name as string, 'TypeScript')}"`);
    ...
    if (composition.state) {
      ...
      for (const prop of composition.state.properties) {
        ...
        this.emitH(`${cppType} ${this.escapeStringValue(prop.key as string, 'TypeScript')};`);
      }
      this.emitH('');
    }
  ...
  private generateSource(composition: HoloComposition): string {
    ...
    this.emitS(`// Source: composition "${this.escapeStringValue(composition.name as string, 'TypeScript')}"`);
    this.emitS('');
    ...
    this.emitS('');
    this.emitS(`UE_LOG(LogTemp, Log, TEXT("HoloScript scene '${this.escapeStringValue(composition.name as string, 'TypeScript')}' initialized"));`);
    ...
    if (composition.state) {
      this.emitS('');
      for (const prop of composition.state.properties) {
        this.emitS(`DOREPLIFETIME(${this.options.className}, ${this.escapeStringValue(prop.key as string, 'TypeScript')});`);
      }
    }
    this.indentLevel--;
    this.emitS('}');
  ...
  private compileObjectSetup(obj: HoloObjectDecl): void {
    ...
    this.emitS(`// Object: ${this.escapeStringValue(obj.name as string, 'TypeScript')}`);
    this.emitS(`${varName} = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("${this.escapeStringValue(obj.name as string, 'TypeScript')}"));`);
  ...
  private compileTraitSetup(
    ...
    switch (trait.name) {
      ...
      case 'pointable':
      case 'hoverable':
        this.emitS(`// @${this.escapeStringValue(trait.name as string, 'TypeScript')} — implement via line trace interaction`);
        break;
      case 'portal':
      ...
      case 'emissive':
      case 'glowing':
        this.emitS(`// @${this.escapeStringValue(trait.name as string, 'TypeScript')} — apply emissive material`);
        break;
      case 'transparent':
        this.emitS(`// @transparent — set material blend mode`);
        break;
      default:
        this.emitS(`// @${this.escapeStringValue(trait.name as string, 'TypeScript')} — custom trait implementation required`);
    }
  }
  ...
  private compileLightSetup(light: HoloLight): void {
    ...
    this.emitS(`// Light: ${this.escapeStringValue(light.name as string, 'TypeScript')}`);
    this.emitS(`${varName} = CreateDefaultSubobject<${lightType}>(TEXT("${this.escapeStringValue(light.name as string, 'TypeScript')}"));`);
    this.emitS(`${varName}->SetupAttachment(RootComponent);`);
  ...
  private compileAudioSetup(audio: HoloAudio): void {
    const varName = this.sanitizeName(audio.name);
    this.emitS(`// Audio: ${this.escapeStringValue(audio.name as string, 'TypeScript')}`);
    this.emitS(`${varName} = CreateDefaultSubobject<UAudioComponent>(TEXT("${this.escapeStringValue(audio.name as string, 'TypeScript')}"));`);
    this.emitS(`${varName}->SetupAttachment(RootComponent);`);
  ...
  private compileZoneSetup(zone: any): void {
    ...
    this.emitS(`// Zone: ${this.escapeStringValue(zone.name as string, 'TypeScript')} — bind overlap events`);
    this.emitS(
  ...
  private compileZoneHandlers(zone: any): void {
    ...
    this.emitS('{');
    this.indentLevel++;
    this.emitS(`UE_LOG(LogTemp, Log, TEXT("Actor entered zone: ${this.escapeStringValue(zone.name as string, 'TypeScript')}"));`);
    this.indentLevel--;
    this.emitS('}');
    this.emitS('');
    ...
    this.emitS('{');
    this.indentLevel++;
    this.emitS(`UE_LOG(LogTemp, Log, TEXT("Actor exited zone: ${this.escapeStringValue(zone.name as string, 'TypeScript')}"));`);
    this.indentLevel--;
    this.emitS('}');
    this.emitS('');
  }
  ...
  private compileTimelineFunction(timeline: HoloTimeline): void {
    ...
    this.emitS('{');
    this.indentLevel++;
    this.emitS(`UE_LOG(LogTemp, Log, TEXT("Playing timeline: ${this.escapeStringValue(timeline.name as string, 'TypeScript')}"));`);
  ...
  private compileActionFunction(action: any): void {
    ...
    this.emitS('{');
    this.indentLevel++;
    this.emitS(`UE_LOG(LogTemp, Log, TEXT("Action: ${this.escapeStringValue(action.name as string, 'TypeScript')}"));`);
