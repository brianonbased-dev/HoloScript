...
describe('WebGPUCompiler', () => {
  ...
  describe('GPU traits', () => {
    it('should handle gaussian_splat trait', () => {
      ...
      expect(result).toContain('GaussianSplatSorter');
      expect(result).toContain('SplatCount');
    });
  ...
  describe('compute shaders', () => {
    ...
    it('should not emit compute pipelines when enableCompute is false', () => {
      ...
      const result = noComputeCompiler.compile(composition, 'test-token');
  ...
  describe('edge cases', () => {
    ...
    it('should handle unicode characters in names', () => {
      ...
      expect(() => compiler.compile(composition, 'test-token')).not.toThrow();
    });
