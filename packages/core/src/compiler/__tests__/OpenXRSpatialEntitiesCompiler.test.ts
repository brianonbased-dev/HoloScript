          ...
          objects: [
            {
              type: 'Object',
              name: 'MySphere',
              properties: [{ type: 'ObjectProperty', key: 'mesh', value: 'sphere' }],
              traits: [],
            },
          ] as any,
        })
          ...
          objects: [
            {
              type: 'Object',
              name: 'AnchoredItem',
              properties: [{ type: 'ObjectProperty', key: 'position', value: [5, 0, -2] }],
              traits: [{ type: 'ObjectTrait', name: 'anchor', config: {} }],
            },
          ] as any,
        })
      );
          ...
          objects: [
            {
              ...
              name: 'AndroidAnchor',
              properties: [],
              traits: [{ type: 'ObjectTrait', name: 'persistent_anchor', config: {} }],
            },
          ] as any,
        })
      );
          ...
          objects: [
            {
              type: 'Object',
              name: 'RotatedObj',
              properties: [{ type: 'ObjectProperty', key: 'rotation', value: [90, 0, 0] }],
              traits: [],
            },
          ] as any,
        })
          ...
          spatialGroups: [
            {
              type: 'SpatialGroup',
              name: 'Room1',
              properties: [{ type: 'GroupProperty', key: 'position', value: [10, 0, 5] }],
              objects: [],
            },
          ] as any,
        })
          ...
          zones: [
            {
              type: 'Zone',
              name: 'SafeZone',
              properties: [{ type: 'ZoneProperty', key: 'type', value: 'safe' }],
              handlers: [],
            },
          ] as any,
        })
          ...
          zones: [
            {
              type: 'Zone',
              name: 'RadiusZone',
              properties: [{ type: 'ZoneProperty', key: 'radius', value: 5 }],
              handlers: [],
            },
          ] as any,
        })
          ...
          objects: [
            {
              type: 'Object',
              name: 'NoGeo',
              properties: [{ type: 'ObjectProperty', key: 'position', value: [1, 2, 3] }],
              traits: [],
            },
          ] as any,
        })
          ...
          spatialGroups: [
            {
              type: 'SpatialGroup',
              name: 'Room',
              properties: [{ type: 'GroupProperty', key: 'position', value: [0, 0, 0] }],
              objects: [
                {
                  type: 'Object',
                  name: 'Chair',
          ...
          zones: [
            {
              type: 'Zone',
              name: 'PlayArea',
              properties: [{ type: 'ZoneProperty', key: 'size', value: [5, 3, 5] }],
              handlers: [],
            },
          ] as any,
          waypointSets: [
