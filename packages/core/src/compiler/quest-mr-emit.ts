...
const PROGUARD_REL = 'app/proguard-rules.pro';
...
/**
 * @generated app/proguard-rules.pro — Horizon OS supplies these platform classes on-device.
 * They are referenced by Meta Spatial SDK but are intentionally absent from the public Android SDK.
 */
export function emitProguardRules(): string {
  return `# @generated from scanner.holo by the quest compiler — edit the spec, not here.
#
...
export function emitQuestMrFiles(composition?: HoloComposition): Record<string, string> {
  ...
  return {
    ...
    [PROGUARD_REL]: emitProguardRules(),
