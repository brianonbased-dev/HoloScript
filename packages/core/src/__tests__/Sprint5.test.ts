/**
 * Sprint 5 Acceptance Tests – v3.14.0
 *
 * Feature areas:
...
describe('Feature 1: Dead Code Detection', () => {
  ...
  describe('noDeadCodeRule (linter rule)', () => {
    ...
    it('reports unused template', () => {
      ...
      // pattern in the rule's reference collector — making them reliably detectable as unused.
...
describe('Feature 5: Package Registry MVP', () => {
  describe('LocalRegistry – publish & retrieve', () => {
  ...
  describe('LocalRegistry – search & list', () => {
    let registry: LocalRegistry;
  ...
  describe('PackageResolver – version resolution', () => {
    let registry: LocalRegistry;
