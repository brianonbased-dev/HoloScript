/**
 * Sprint 25 Acceptance Tests — Rendering + PostFX + Build (v3.34.0)
 *
 * Features:
 *   1A/B  PostFX Config     — createPostFXPipeline, mergeEffectConfig
 *   2A–C  PostProcess Types — getDefaultParams, mergeParams, validateParams, constants
 *   3A/B  PostProcessPipeline — construction, createPreset
 *   4A/B  ShaderGraph        — node lifecycle, connections
 *   5A/B  ShaderGraphTypes   — type compatibility, templates
 *   6A    PlatformExporter   — configure, export, targets
 *   7A    SceneBundler       — addAsset, treeShake, splitChunks, bundle
 */
...
// =============================================================================
// Feature 1A: PostFX Config — createPostFXPipeline
// =============================================================================

describe('Feature 1A: PostFX Config — createPostFXPipeline', () => {
...
// =============================================================================
// Feature 1B: PostFX Config — mergeEffectConfig
// =============================================================================

describe('Feature 1B: PostFX Config — mergeEffectConfig', () => {
...
// =============================================================================
// Feature 2A: PostProcess Types — getDefaultParams / mergeParams
// =============================================================================

describe('Feature 2A: PostProcess Types — getDefaultParams / mergeParams', () => {
...
// =============================================================================
// Feature 2B: PostProcess Types — validateParams
// =============================================================================

describe('Feature 2B: PostProcess Types — validateParams', () => {
...
// =============================================================================
// Feature 2C: PostProcess Types — UNIFORM_SIZES
// =============================================================================

describe('Feature 2C: PostProcess Types — UNIFORM_SIZES', () => {
...
// =============================================================================
// Feature 3A: PostProcessPipeline — construction
// =============================================================================

describe('Feature 3A: PostProcessPipeline — construction', () => {
...
// =============================================================================
// Feature 3B: PostProcessPipeline — createPreset
// =============================================================================

describe('Feature 3B: PostProcessPipeline — createPreset', () => {
...
// =============================================================================
// Feature 4A: ShaderGraph — node lifecycle
// =============================================================================

describe('Feature 4A: ShaderGraph — node lifecycle', () => {
...
// =============================================================================
// Feature 4B: ShaderGraph — connections
// =============================================================================

describe('Feature 4B: ShaderGraph — connections', () => {
  let graph: ShaderGraph;
  ...
  it('connect float→float creates connection', () => {
...
// =============================================================================
// Feature 6A: PlatformExporter — configure / export / targets
// =============================================================================
...
// =============================================================================
// Feature 7A: SceneBundler — addAsset, treeShake, splitChunks, bundle
// =============================================================================
...
describe('Feature 7A: SceneBundler', () => {
  ...
  it('bundle returns manifest with correct totalAssets', () => {
    bundler.addAsset(makeAsset('a', ['b'])); // 'a' references 'b' → both reachable
