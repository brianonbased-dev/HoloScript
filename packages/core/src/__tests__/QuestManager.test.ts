...
describe('QuestManager', () => {
  ...
  it('optional objectives do not block completion', () => {
    qm.addQuest({
      ...
      description: '',
      category: 'main',
      objectives: [objective('req', 1), objective('opt', 5, true)],
      prerequisites: [],
      level: 1,
      timeLimit: 0,
      repeatable: false,
  ...
  it('getProgress returns fractional completion', () => {
    qm.addQuest({
      ...
      description: '',
      category: 'main',
      objectives: [objective('a', 1), objective('b', 1)],
      prerequisites: [],
      level: 1,
      timeLimit: 0,
      repeatable: false,
