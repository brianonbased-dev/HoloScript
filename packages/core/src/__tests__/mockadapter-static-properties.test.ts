/**
 * Sprint 18 Acceptance Tests â€” LLM Provider SDK + Comparative Benchmarks
 *
 * Covers:
...
// ---------------------------------------------------------------------------
// LLM Provider imports (no @holoscript/core dependency â€” import directly)
// ---------------------------------------------------------------------------
...
// =============================================================================
// Feature 1A: MockAdapter â€” static properties
// =============================================================================

describe('Feature 1A: MockAdapter â€” static properties', () => {
...
// =============================================================================
// Feature 1B: MockAdapter â€” initial mutable state
// =============================================================================

describe('Feature 1B: MockAdapter â€” initial mutable state', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 2A: MockAdapter â€” complete() response shape
// =============================================================================

describe('Feature 2A: MockAdapter â€” complete() response shape', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 2B: MockAdapter â€” callCount and keyword scenes
// =============================================================================

describe('Feature 2B: MockAdapter â€” callCount and keyword scenes', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 3A: MockAdapter â€” control: failOnNextCall and reset()
// =============================================================================

describe('Feature 3A: MockAdapter â€” failOnNextCall and reset()', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 3B: MockAdapter â€” healthCheck()
// =============================================================================

describe('Feature 3B: MockAdapter â€” healthCheck()', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 4: MockAdapter â€” generateHoloScript()
// =============================================================================

describe('Feature 4: MockAdapter â€” generateHoloScript()', () => {
  let mock: MockAdapter;
...
// =============================================================================
// Feature 7A: ComparativeBenchmarks â€” class instantiation
// =============================================================================

describe('Feature 7A: ComparativeBenchmarks â€” class instantiation', () => {
...
// =============================================================================
// Feature 7B: ComparativeBenchmarks â€” runAll() results shape
// (use minimal iterations for speed)
// =============================================================================

describe('Feature 7B: ComparativeBenchmarks â€” runAll() results', () => {
...
// =============================================================================
// Feature 8: ComparativeBenchmarks â€” generateReport()
// =============================================================================

describe('Feature 8: ComparativeBenchmarks â€” generateReport()', () => {
