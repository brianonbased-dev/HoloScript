 ...
 *
 * v3.17.0 — WASM compiler, Team workspaces (RBAC + secrets + activity), HoloScript Academy
 *
 * Coverage:
 *   1. WASM compiler package structure  — 10 tests
 *   2. Workspace RBAC & permission utils — 16 tests
 *   3. WorkspaceService operations       — 15 tests
 *   4. HoloScript Academy content        — 16 tests
 *                               Total:   57 tests
 */
...
describe('Sprint 8 – WASM compiler package structure', () => {
...
describe('Sprint 8 – Workspace RBAC permissions', () => {
...
describe('Sprint 8 – WorkspaceService', () => {
...
describe('Sprint 8 – HoloScript Academy', () => {
  ...
  // Level 2 – at least 10 lessons exist
  ...
  // Level 3 – at least 5 advanced lessons exist
