/**
 * Sprint 22 Acceptance Tests â€” ECS + Events
 *
 * Covers:
 *   packages/core/src/ecs/
 *     World         â€” entity lifecycle, components, tags, queries, undo/redo
 *     EntityRegistryâ€” create/destroy, queries, hierarchy, component bookkeeping
 *     ComponentStoreâ€” pools, CRUD, bulk ops, iteration
 *     ComponentRegistry â€” schema registration, built-in components
 *     SystemSchedulerâ€” registration, phases, execution order, stats
 *
 *   packages/core/src/events/
 *     EventBus       â€” subscribe/emit, once, priority, wildcard, history, pause
 *     EventChannel   â€” subscribe/emit, filter, replay buffer, throttle
 *     ChannelManager â€” multi-channel registry, bridging
 *     CommandSystem  â€” execute/undo/redo, batching, macros
 */
...
} from '@holoscript/engine/ecs/ComponentRegistry.js';
...
// =============================================================================
// Feature 1A: World â€” entity lifecycle
// =============================================================================

describe('Feature 1A: World â€” entity lifecycle', () => {
  let world: World;
...
// =============================================================================
// Feature 1B: World â€” component management
// =============================================================================

describe('Feature 1B: World â€” component management', () => {
  let world: World;
...
// =============================================================================
// Feature 1C: World â€” tags and queries
// =============================================================================

describe('Feature 1C: World â€” tags and queries', () => {
  let world: World;
...
// =============================================================================
// Feature 1D: World â€” undo / redo
// =============================================================================

describe('Feature 1D: World â€” undo/redo', () => {
  let world: World;
...
// =============================================================================
// Feature 2A: EntityRegistry â€” create / destroy
// =============================================================================

describe('Feature 2A: EntityRegistry â€” create/destroy', () => {
...
// =============================================================================
// Feature 2B: EntityRegistry â€” queries and tags
// =============================================================================

describe('Feature 2B: EntityRegistry â€” queries and tags', () => {
  let reg: EntityRegistry;
...
// =============================================================================
// Feature 2C: EntityRegistry â€” hierarchy
// =============================================================================

describe('Feature 2C: EntityRegistry â€” hierarchy', () => {
  let reg: EntityRegistry;
...
// =============================================================================
// Feature 2D: EntityRegistry â€” component bookkeeping
// =============================================================================

describe('Feature 2D: EntityRegistry â€” component bookkeeping', () => {
  let reg: EntityRegistry;
...
// =============================================================================
// Feature 3A: ComponentStore â€” pool management
// =============================================================================

describe('Feature 3A: ComponentStore â€” pool management', () => {
...
// =============================================================================
// Feature 3B: ComponentStore â€” CRUD operations
// =============================================================================

describe('Feature 3B: ComponentStore â€” CRUD', () => {
  let store: ComponentStore;
...
// =============================================================================
// Feature 3C: ComponentStore â€” bulk and iteration
// =============================================================================

describe('Feature 3C: ComponentStore â€” bulk ops', () => {
  let store: ComponentStore;
...
// =============================================================================
// Feature 4A: ComponentRegistry â€” schemas
// =============================================================================

describe('Feature 4A: ComponentRegistry â€” schemas', () => {
...
// =============================================================================
// Feature 4B: ComponentRegistry â€” built-in components
// =============================================================================

describe('Feature 4B: ComponentRegistry â€” built-in components', () => {
  let reg: ComponentRegistry;
...
// =============================================================================
// Feature 5A: SystemScheduler â€” registration and execution
// =============================================================================

describe('Feature 5A: SystemScheduler â€” registration', () => {
...
// =============================================================================
// Feature 5B: SystemScheduler â€” phases and ordering
// =============================================================================

describe('Feature 5B: SystemScheduler â€” phases', () => {
  let sched: SystemScheduler;
...
// =============================================================================
// Feature 6A: EventBus â€” basic subscribe / emit
// =============================================================================

describe('Feature 6A: EventBus â€” subscribe/emit', () => {
  let bus: EventBus;
...
// =============================================================================
// Feature 6B: EventBus â€” once, priority, wildcard
// =============================================================================

describe('Feature 6B: EventBus â€” once/priority/wildcard', () => {
  let bus: EventBus;
...
describe('Feature 6C: EventBus â€” shared singleton', () => {
...
// =============================================================================
// Feature 7A: EventChannel â€” subscribe / emit / filter
// =============================================================================

describe('Feature 7A: EventChannel â€” subscribe/emit/filter', () => {
...
// =============================================================================
// Feature 7B: EventChannel â€” replay buffer
// =============================================================================

describe('Feature 7B: EventChannel â€” replay buffer', () => {
...
// =============================================================================
// Feature 8A: ChannelManager â€” multi-channel registry
// =============================================================================

describe('Feature 8A: ChannelManager â€” channels and bridging', () => {
...
// =============================================================================
// Feature 9A: CommandSystem â€” execute / undo / redo
// =============================================================================
...
describe('Feature 9A: CommandSystem â€” execute/undo/redo', () => {
...
// =============================================================================
// Feature 9B: CommandSystem â€” batching
// =============================================================================

describe('Feature 9B: CommandSystem â€” batching', () => {
  let sys: CommandSystem;
...
// =============================================================================
// Feature 9C: CommandSystem â€” macros
// =============================================================================

describe('Feature 9C: CommandSystem â€” macros', () => {
  let sys: CommandSystem;
