...
describe('Two-Handed Interactions', () => {
    ...
    it('scales object based on pinch distance', () => {
        ...
        context.vr.hands.left = { position: {x: -0.5, y:0, z:0}, rotation: {x:0,y:0,z:0}, pinchStrength: 1 } as any;
        context.vr.hands.right = { position: {x: 0.5, y:0, z:0}, rotation: {x:0,y:0,z:0}, pinchStrength: 1 } as any;
