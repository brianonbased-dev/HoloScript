/**
 * Sprint 23 Acceptance Tests — Scene + Math
 *
 * Covers:
 *   packages/core/src/scene/
 *     SceneNode       — hierarchy, transforms, tags, traversal
 *     SceneSerializer — node-based serialization, trait/Set/Map sanitization
 *     SceneDeserializer — reconstruct node tree, Map trait rebuild
 *     SceneManager    — save/load/has/delete/list/exportJSON/importJSON
 *     StateSnapshotCapture — capture with subsystems, defaults
 *
 *   packages/core/src/math/
 *     SplinePath      — add/remove points, evaluate, arc length, tangent
 *     SplineFollower  — playback, update, markers, onComplete
 */
...
// =============================================================================
// Feature 1A: SceneNode — constructor and transforms
// =============================================================================

describe('Feature 1A: SceneNode — constructor and transforms', () => {
...
// =============================================================================
// Feature 1B: SceneNode — hierarchy
// =============================================================================

describe('Feature 1B: SceneNode — hierarchy', () => {
...
// =============================================================================
// Feature 1C: SceneNode — tags and visibility
// =============================================================================
...
// =============================================================================
// Feature 2A: SceneSerializer — serialize HSPlusNode
// =============================================================================
...
// =============================================================================
// Feature 2B: SceneSerializer — sanitization
// =============================================================================
...
// =============================================================================
// Feature 2C: SceneDeserializer — reconstruct node tree
// =============================================================================

describe('Feature 2C: SceneDeserializer — deserialize', () => {
  let ser: SceneSerializer;
...
// =============================================================================
// Feature 3A: SceneManager — save / load / has / delete
// =============================================================================
...
// =============================================================================
// Feature 3B: SceneManager — exportJSON / importJSON
// =============================================================================
...
// =============================================================================
// Feature 3C: StateSnapshotCapture — capture
// =============================================================================
...
// =============================================================================
// Feature 4A: SplinePath — points and evaluate
// =============================================================================

describe('Feature 4A: SplinePath — points and evaluate', () => {
  let sp: SplinePath;
...
// =============================================================================
// Feature 4B: SplinePath — arc length and tangent
// =============================================================================

describe('Feature 4B: SplinePath — arc length and tangent', () => {
...
// =============================================================================
// Feature 5A: SplineFollower — playback control
// =============================================================================

describe('Feature 5A: SplineFollower — playback', () => {
  let sp: SplinePath;
...
// =============================================================================
// Feature 5B: SplineFollower — markers and completion
// =============================================================================

describe('Feature 5B: SplineFollower — markers and events', () => {
  let sp: SplinePath;
  let sf: SplineFollower;
