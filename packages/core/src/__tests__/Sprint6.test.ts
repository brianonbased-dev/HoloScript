/**
 * Sprint 6 Acceptance Tests – v3.15.0
 *
 * Feature areas:
 *   1. Publish validation   (PublishValidator)
 *   2. Package bundling     (PackagePackager – dry-run)
 *   3. Publish command      (PublishCommand – dry-run + validation errors)
...
// ── Feature 1 + 2: Validator & Packager ──────────────────────────────────────
