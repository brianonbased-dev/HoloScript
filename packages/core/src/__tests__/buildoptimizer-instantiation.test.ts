/**
 * Sprint 20 Acceptance Tests â€” Build Module + PostFX
 *
 * Covers:
...
// =============================================================================
// Feature 1A: BuildOptimizer â€” instantiation + config
// =============================================================================

describe('Feature 1A: BuildOptimizer â€” instantiation', () => {
...
// =============================================================================
// Feature 1B: BuildOptimizer â€” addTarget / getTarget / getTargetCount
// =============================================================================

describe('Feature 1B: BuildOptimizer â€” addTarget', () => {
...
// =============================================================================
// Feature 1C: BuildOptimizer â€” applyPass
// =============================================================================

describe('Feature 1C: BuildOptimizer â€” applyPass()', () => {
  let opt: BuildOptimizer;
...
// =============================================================================
// Feature 1D: BuildOptimizer â€” optimize() result shape
// =============================================================================

describe('Feature 1D: BuildOptimizer â€” optimize()', () => {
...
// =============================================================================
// Feature 1E: BuildOptimizer â€” enablePass / disablePass
// =============================================================================

describe('Feature 1E: BuildOptimizer â€” enablePass/disablePass', () => {
  let opt: BuildOptimizer;
...
// =============================================================================
// Feature 2A: SceneBundler â€” instantiation + addAsset
// =============================================================================

describe('Feature 2A: SceneBundler â€” instantiation', () => {
  it('can be instantiated with no args', () => {
...
// =============================================================================
// Feature 2B: SceneBundler â€” treeShake()
// =============================================================================

describe('Feature 2B: SceneBundler â€” treeShake()', () => {
  it('returns empty array when no entry points', () => {
    const b = new SceneBundler();
    b.addAsset(makeAsset('a'));
    b.addAsset(makeAsset('b'));
    // no entry points â†’ all unreachable
...
// =============================================================================
// Feature 2C: SceneBundler â€” bundle() manifest shape
// =============================================================================

describe('Feature 2C: SceneBundler â€” bundle()', () => {
...
// =============================================================================
// Feature 3A: PlatformExporter â€” getSupportedTargets
// =============================================================================

describe('Feature 3A: PlatformExporter â€” getSupportedTargets', () => {
...
// =============================================================================
// Feature 3B: PlatformExporter â€” configure + getConfig
// =============================================================================

describe('Feature 3B: PlatformExporter â€” configure()', () => {
...
// =============================================================================
// Feature 3C: PlatformExporter â€” export() result shape
// =============================================================================

describe('Feature 3C: PlatformExporter â€” export()', () => {
  let exporter: PlatformExporter;
...
// =============================================================================
// Feature 3D: PlatformExporter â€” exportAll()
// =============================================================================

describe('Feature 3D: PlatformExporter â€” exportAll()', () => {
...
// =============================================================================
// Feature 4A: PostFX â€” default configs
// =============================================================================

describe('Feature 4A: PostFX â€” default configs', () => {
...
// =============================================================================
// Feature 4B: PostFX â€” DEFAULT_POSTFX_PIPELINE
// =============================================================================

describe('Feature 4B: PostFX â€” DEFAULT_POSTFX_PIPELINE', () => {
  it('name is "default"', () => {
