/**
 * Sprint 11: Formatter, FS Utilities, Runtime EventBus & Storage, Benchmarks
 *
 * Tests cover:
 ...
 *   - Feature 2:  FS — path utilities (join, dirname, basename, extname, toPosix,
 *                 isAbsolute, normalize, parse)
 *   - Feature 3:  FS — file operations (readText/writeText, readJson/writeJson,
 ...
 *   - Feature 6:  (Comparative Benchmarks skipped — tinybench not in core deps)
 */
...
describe('Feature 1A: Formatter — DEFAULT_CONFIG', () => {
...
// ============================================================================
// Feature 1B: Formatter — format() basics
// ============================================================================

describe('Feature 1B: Formatter — format()', () => {
  ...
  it('changed is false when code is already formatted', () => {
    ...
    // Format twice — second pass should have changed=false
...
// ============================================================================
// Feature 1C: Formatter — check() and formatRange()
// ============================================================================

describe('Feature 1C: Formatter — check() and formatRange()', () => {
...
// ============================================================================
// Feature 3: FS — file I/O operations
// ============================================================================
...
// ============================================================================
// Feature 3C: FS — formatSize utility
// ============================================================================
...
// ============================================================================
// Feature 5: Runtime — MemoryStorageAdapter
// ============================================================================
...
// Feature 6 tests omitted — see packages/comparative-benchmarks for dedicated coverage.
