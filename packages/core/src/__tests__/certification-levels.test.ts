/**
 * 10: Certified Packages + Partner SDK + HoloScript 3.0 Release
 *
 * Tests cover:
 *   - Feature 1A: CERTIFICATION_LEVELS thresholds
 *   - Feature 1B: CertificationChecker.check() logic
 *   - Feature 1C: Badge.ts â€” issueBadge, verifyBadge, SVG/Markdown, store ops
 *   - Feature 2:  Partner SDK â€” HoloScriptRuntime embedding
 *   - Feature 3:  Partner SDK â€” WebhookHandler
...
// ============================================================================
// Feature 1C: Badge.ts â€” issueBadge / verifyBadge
// ============================================================================
...
// ============================================================================
// Feature 1C: Badge.ts â€” SVG / Markdown generation
// ============================================================================
...
// ============================================================================
// Feature 1C: Badge.ts â€” store operations
// ============================================================================
...
// ============================================================================
// Feature 2: Partner SDK â€” HoloScriptRuntime
// ============================================================================
...
describe('Feature 3: WebhookHandler', () => {
  const makeHandler = () =>
    createWebhookHandler({
      ...
      maxTimestampAge: 3600, // 1 hour â€” avoids timestamp failures in tests
      strictMode: false,
    });
  ...
  it('handle() is idempotent â€” duplicate eventId is silently skipped', async () => {
    const handler = makeHandler();
    const received: unknown[] = [];
