...
describe('MigrationManager', () => {
  ...
  it('registers migrations and sorts by fromVersion', () => {
    mgr.registerMigration({ fromVersion: 2, toVersion: 3, migrate: d => d, description: 'v2→v3' });
    mgr.registerMigration({ fromVersion: 1, toVersion: 2, migrate: d => d, description: 'v1→v2' });
