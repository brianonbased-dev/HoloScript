...
describe('PhysicsWorldImpl', () => {
  ...
  describe('constraints', () => {
    ...
    it('throws on duplicate constraint id', () => {
      world.createConstraint({ id: 'dup', type: 'distance', bodyA: 'cA', bodyB: 'cB', distance: 5 });
      expect(() => world.createConstraint({ id: 'dup', type: 'distance', bodyA: 'cA', bodyB: 'cB', distance: 5 })).toThrow();
    });

    it('throws if body not found', () => {
      expect(() => world.createConstraint({ id: 'bad', type: 'distance', bodyA: 'missing', bodyB: 'cB', distance: 5 })).toThrow();
    });

    it('removes a constraint', () => {
      world.createConstraint({ id: 'rem', type: 'distance', bodyA: 'cA', bodyB: 'cB', distance: 5 });
      expect(world.removeConstraint('rem')).toBe(true);
    });

    it('setConstraintEnabled does not throw', () => {
      world.createConstraint({ id: 'tog', type: 'distance', bodyA: 'cA', bodyB: 'cB', distance: 5 });
