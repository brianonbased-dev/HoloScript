...
describe('applyTransformation', () => {
  describe('filter', () => {
    ...
    it('filters with predicate: sets _item and evaluates', async () => {
      ...
      const result = await applyTransformation(
        [1, 2, 3],
        { operation: 'filter', parameters: { predicate: '_item > 0' } },
        ctx
      );
  ...
  describe('map', () => {
    ...
    it('maps with mapper: sets _item and evaluates expression', async () => {
      ...
      const result = await applyTransformation(
        [1, 2],
        { operation: 'map', parameters: { mapper: '_item * 2' } },
        ctx
      );
      expect(ctx.setVariable).toHaveBeenCalledWith('_item', 1);
  ...
  describe('reduce', () => {
    ...
    it('reduces with reducer: uses _acc and _item', async () => {
      ...
      await applyTransformation(
        [1, 2, 3],
        { operation: 'reduce', parameters: { reducer: '_acc + _item', initial: 0 } },
        ctx
      );
  ...
  describe('sort', () => {
    ...
    it('sorts numbers descending', async () => {
      const result = await applyTransformation(
        [3, 1, 2],
        { operation: 'sort', parameters: { descending: true } },
        makeCtx()
      );
    ...
    it('sorts by key', async () => {
      ...
      const result = await applyTransformation(
        data,
        { operation: 'sort', parameters: { key: 'n' } },
        makeCtx()
      );
  ...
  describe('take', () => {
    it('takes first N elements', async () => {
      const result = await applyTransformation(
        [1, 2, 3, 4, 5],
        { operation: 'take', parameters: { count: 3 } },
        makeCtx()
      );
      expect(result).toEqual([1, 2, 3]);
    });
    ...
    it('returns non-array unchanged', async () => {
      const result = await applyTransformation(
        'hi',
        { operation: 'take', parameters: { count: 2 } },
        makeCtx()
      );
  ...
  describe('skip', () => {
    it('skips first N elements', async () => {
      const result = await applyTransformation(
        [1, 2, 3, 4],
        { operation: 'skip', parameters: { count: 2 } },
        makeCtx()
      );
    ...
    it('returns non-array unchanged', async () => {
      const result = await applyTransformation(
        7,
        { operation: 'skip', parameters: { count: 1 } },
        makeCtx()
      );
  ...
  describe('unknown operation', () => {
    it('returns data unchanged for unknown operation', async () => {
      const result = await applyTransformation(
        [1, 2],
        { operation: 'explode' as any, parameters: {} },
        makeCtx()
      );
      expect(result).toEqual([1, 2]);
    });
