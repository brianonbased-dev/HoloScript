...
import { runSafetyPass, EffectASTNode } from '../compiler/safety/CompilerSafetyPass';
import { ResourceCategory, PLATFORM_BUDGETS } from '../compiler/safety/ResourceBudgetAnalyzer';
import { PlatformTarget, PLATFORM_CAPABILITIES } from '../compiler/platform/PlatformConditional';
import { InstallManifest } from '../marketplace/MarketplaceRegistry';
