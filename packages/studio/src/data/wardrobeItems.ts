...
export const BUILTIN_ITEMS: WardrobeItem[] = [
  ...
  // Accessories (6)
  { id: 'acc_glasses',    name: 'Glasses',       slot: 'accessory_1', thumbnail: '👓', category: 'accessories' },
  ...
  { id: 'acc_backpack',   name: 'Backpack',      slot: 'accessory_2', thumbnail: '🎒', category: 'accessories' },
  { id: 'acc_necklace',   name: 'Necklace',      slot: 'accessory_1', thumbnail: '📿', category: 'accessories' },
