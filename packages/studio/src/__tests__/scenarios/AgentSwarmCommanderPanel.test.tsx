...
import { AgentSwarmCommanderPanel } from '../../industry/scenarios/AgentSwarmCommanderPanel';

describe('AgentSwarmCommanderPanel', () => {
  it('renders without crashing', () => {
    ...
    const { container } = render(<AgentSwarmCommanderPanel />);
