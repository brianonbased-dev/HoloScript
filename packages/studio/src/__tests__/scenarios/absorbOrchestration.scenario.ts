...
describe('Scenario: Absorb Orchestration Funnel', () => {
  ...
  it('calculates efficiency based on token processing burden', () => {
    const tasks: AbsorbTask[] = [
      { id: '1', objective: 'A', phase: 'compress_knowledge', knowledgeTokensProcessed: 2000, progressPercent: 30 },
      { id: '2', objective: 'B', phase: 'graph_rag_query', knowledgeTokensProcessed: 1000, progressPercent: 10 },
    ];
    ...
    const overloaded: AbsorbTask[] = [
      { id: '3', objective: 'C', phase: 'compress_knowledge', knowledgeTokensProcessed: 200000, progressPercent: 30 },
    ];
