...
export const EMOTION_PALETTES: Record<
  EmotionCategory,
...
export function clarityScore(clarity: DreamClarity): number {
  const scores: Record<DreamClarity, number> = {
    vivid: 1.0,
    normal: 0.7,
    foggy: 0.4,
    fragment: 0.2,
...
export const COMMON_SYMBOLS: DreamSymbol[] = [
  {
    ...
    associatedEmotions: ['peace', 'fear'],
  },
  {
    name: 'flying',
    frequency: 0.25,
    meanings: ['freedom', 'ambition', 'escape'],
    associatedEmotions: ['joy', 'awe'],
  },
  {
    name: 'falling',
    frequency: 0.3,
    meanings: ['loss of control', 'anxiety', 'letting go'],
    associatedEmotions: ['fear', 'surprise'],
  },
  {
    name: 'teeth',
    frequency: 0.15,
    meanings: ['self-image', 'anxiety', 'transition'],
    associatedEmotions: ['fear', 'confusion'],
  },
  {
    name: 'chase',
    frequency: 0.2,
    meanings: ['avoidance', 'threat', 'unresolved conflict'],
    associatedEmotions: ['fear', 'anger'],
  },
  {
    name: 'house',
    frequency: 0.3,
    meanings: ['self', 'psyche', 'security'],
    associatedEmotions: ['peace', 'sadness'],
  },
  {
    name: 'animal',
    frequency: 0.25,
    meanings: ['instinct', 'nature', 'untamed qualities'],
    associatedEmotions: ['surprise', 'awe'],
  },
  {
    name: 'mirror',
    frequency: 0.1,
    meanings: ['self-reflection', 'identity', 'hidden truth'],
    associatedEmotions: ['confusion', 'awe'],
  },
];
