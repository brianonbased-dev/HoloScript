    ...
    parameters: {
      ...
      properties: {
        goal: {
          type: 'string',
          description:
            "What you're trying to do, in a few words — e.g. 'compile this scene to Unity', 'run a paid physics simulation', 'search the codebase for auth middleware', 'read or write workspace files', 'render the world on the fleet'.",
        },
        limit: {
          type: 'number',
