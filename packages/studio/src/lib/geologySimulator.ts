...
export const GEOLOGICAL_TIMELINE: GeologicalPeriod[] = [
  { name: 'Quaternary', era: 'Cenozoic', eon: 'Phanerozoic', startMya: 2.6, endMya: 0, fossilMarkers: ['Homo sapiens', 'mammoth'], keyEvents: ['Ice ages', 'Human evolution'] },
  { name: 'Neogene', era: 'Cenozoic', eon: 'Phanerozoic', startMya: 23.03, endMya: 2.6, fossilMarkers: ['grassland mammals', 'ape divergence'], keyEvents: ['Grassland expansion', 'Himalaya uplift'] },
  { name: 'Paleogene', era: 'Cenozoic', eon: 'Phanerozoic', startMya: 66, endMya: 23.03, fossilMarkers: ['early primates', 'whales'], keyEvents: ['Mammal radiation', 'India collision'] },
  { name: 'Cretaceous', era: 'Mesozoic', eon: 'Phanerozoic', startMya: 145, endMya: 66, fossilMarkers: ['T. rex', 'flowering plants'], keyEvents: ['K-Pg extinction', 'Pangaea breakup'] },
  { name: 'Jurassic', era: 'Mesozoic', eon: 'Phanerozoic', startMya: 201, endMya: 145, fossilMarkers: ['Brachiosaurus', 'Archaeopteryx'], keyEvents: ['Dinosaur dominance', 'First birds'] },
  { name: 'Triassic', era: 'Mesozoic', eon: 'Phanerozoic', startMya: 252, endMya: 201, fossilMarkers: ['early dinosaurs', 'first mammals'], keyEvents: ['Pangaea intact', 'End-Triassic extinction'] },
  { name: 'Permian', era: 'Paleozoic', eon: 'Phanerozoic', startMya: 299, endMya: 252, fossilMarkers: ['Dimetrodon', 'seed ferns'], keyEvents: ['Great Dying (96% species)'] },
  { name: 'Carboniferous', era: 'Paleozoic', eon: 'Phanerozoic', startMya: 359, endMya: 299, fossilMarkers: ['giant insects', 'coal forests'], keyEvents: ['Coal deposits', 'First reptiles'] },
  { name: 'Cambrian', era: 'Paleozoic', eon: 'Phanerozoic', startMya: 539, endMya: 485, fossilMarkers: ['trilobites', 'Anomalocaris'], keyEvents: ['Cambrian explosion'] },
];
...
export const EARTH_LAYERS: EarthLayer[] = [
  { name: 'Crust', depthStartKm: 0, depthEndKm: 35, state: 'solid', compositionMajor: 'silicates', temperatureC: 200, densityKgM3: 2700 },
  { name: 'Upper Mantle', depthStartKm: 35, depthEndKm: 670, state: 'plastic', compositionMajor: 'peridotite', temperatureC: 1400, densityKgM3: 3400 },
  { name: 'Lower Mantle', depthStartKm: 670, depthEndKm: 2900, state: 'solid', compositionMajor: 'silicate perovskite', temperatureC: 3000, densityKgM3: 5000 },
  { name: 'Outer Core', depthStartKm: 2900, depthEndKm: 5100, state: 'liquid', compositionMajor: 'iron-nickel', temperatureC: 4500, densityKgM3: 10000 },
  { name: 'Inner Core', depthStartKm: 5100, depthEndKm: 6371, state: 'solid', compositionMajor: 'iron-nickel', temperatureC: 5500, densityKgM3: 13000 },
];
