    ...
    async generateHoloScript(prompt: string): Promise<string> {
        const payload = {
            ...
            messages: [
                { 
                    role: 'system', 
                    content: 'You are an elite HoloScript architect. Output only valid HoloScript code inside ```holoscript blocks. Do not explain your code. Use valid geometric and material properties.' 
                },
