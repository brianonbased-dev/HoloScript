...
const MODEL_CATALOG: ModelEntry[] = [
  ...
  },
  {
    ...
    format: 'GLB',
    polyCount: '5K',
    description: 'Generic NPC with dialogue animations',
  },
  {
    id: 'mdl-robot',
    name: 'Service Bot',
    ...
    format: 'GLB',
    polyCount: '8K',
    description: 'Utility robot with walk cycle',
  },
  // Environment
  {
    id: 'mdl-house',
    ...
    format: 'GLB',
    polyCount: '15K',
    description: 'Half-timber house with interior',
  },
  {
    id: 'mdl-castle',
    name: 'Castle Tower',
    ...
    format: 'GLB',
    polyCount: '22K',
    description: 'Fortified tower with battlements',
  },
  {
    id: 'mdl-bridge',
    name: 'Stone Bridge',
    ...
    format: 'GLB',
    polyCount: '6K',
    description: 'Arched stone bridge',
  },
  // Props
  {
    id: 'mdl-chest',
    ...
    format: 'GLB',
    polyCount: '2K',
    description: 'Openable chest with loot',
  },
  {
    id: 'mdl-barrel',
    name: 'Barrel',
    ...
    format: 'GLB',
    polyCount: '800',
    description: 'Wooden barrel, destructible',
  },
  {
    id: 'mdl-torch',
    name: 'Wall Torch',
    ...
    format: 'GLB',
    polyCount: '1K',
    description: 'Animated flame torch',
  },
  {
    id: 'mdl-sign',
    name: 'Wooden Sign',
    ...
    format: 'GLB',
    polyCount: '500',
    description: 'Customizable text sign',
  },
  // Vehicles
  {
    id: 'mdl-cart',
    ...
    format: 'GLB',
    polyCount: '6K',
    description: 'Medieval transport cart',
  },
  {
    id: 'mdl-ship',
    name: 'Sailing Ship',
    ...
    format: 'GLB',
    polyCount: '18K',
    description: 'Three-masted galleon',
  },
  // Nature
  {
    id: 'mdl-tree',
    ...
    format: 'GLB',
    polyCount: '3K',
    description: 'LOD-ready deciduous tree',
  },
  {
    id: 'mdl-rock',
    name: 'Rock Formation',
    ...
    format: 'GLB',
    polyCount: '4K',
    description: 'Modular rock cluster',
  },
  {
    id: 'mdl-flower',
    name: 'Flower Patch',
    ...
    format: 'GLB',
    polyCount: '1.5K',
    description: 'Animated wildflowers',
  },
];
...
export function ModelViewerPanel() {
  ...
  const insertToViewport = useCallback(
    (model: ModelEntry) => {
    ...
    <div className="p-3 space-y-3 text-xs">
      ...
      <div className="grid grid-cols-2 gap-1.5 max-h-[180px] overflow-y-auto">
        {filtered.map((m) => (
          ...
          >
            ...
            <span className="text-studio-text font-medium truncate w-full text-center">
              {m.name}
            </span>
            <span className="text-studio-muted text-[9px]">
              {m.polyCount} · {m.format}
            </span>
          </button>
        ))}
      </div>
      ...
      {selected && (
        <div className="bg-studio-panel/30 rounded-lg p-2 space-y-1.5">
          ...
          <button
            onClick={() => insertToViewport(selected)}
