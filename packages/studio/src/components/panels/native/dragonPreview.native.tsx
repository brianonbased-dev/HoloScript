...
<div style={{"display":"flex","flexDirection":"column","justifyContent":"center","alignItems":"center","gap":"8px"}} className="min-h-32 rounded-lg border border-studio-border bg-studio-surface/70 p-4 text-center">
