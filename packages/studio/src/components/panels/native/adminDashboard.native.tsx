...
export function AdminDashboardComponent() {
  ...
  return (
    <div className="holoscript-2d-root w-full h-full" data-holo-view-contract="1a14871e7e25c12d8c9d5375bb6f13461967188495348a7b8147234b58bd136e">
...
export const holoViewContract = {"version":"holo-view-contract-v1","projections":[{"element":"AgentsValue","node":"stats.agents.tracked","identity":true},{"element":"AuditActor","node":"entry.actor","identity":true},{"element":"AuditEvent","node":"entry.event","identity":true},{"element":"AuditOutcome","node":"entry.outcome","identity":false},{"element":"AuditRow","node":"recent","identity":false},{"element":"QuotasSub","node":"stats.quotas.tracked","identity":false,"transform":{"suffix":" tracked"}},{"element":"QuotasValue","node":"stats.quotas.exceeded","identity":false},{"element":"SessionsSub","node":"stats.sessions.revoked","identity":false,"transform":{"suffix":" revoked"}},{"element":"SessionsValue","node":"stats.sessions.authenticated","identity":true},{"element":"TenantsSub","node":"stats.tenants.suspended","identity":false,"transform":{"suffix":" suspended"}},{"element":"TenantsValue","node":"stats.tenants.active","identity":true}],"stateRoots":["auditLog","entry","recent","stats"],"contractHash":"1a14871e7e25c12d8c9d5375bb6f13461967188495348a7b8147234b58bd136e"} as const;
