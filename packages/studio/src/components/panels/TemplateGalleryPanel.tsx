...
const TEMPLATES: Template[] = [
  // Scenes
  {
    ...
    icon: '🏘️',
    category: 'scene',
    description: 'Medieval village with NPCs, shops, and quest givers',
    entities: 24,
    complexity: 'complex',
    tags: ['game', 'rpg'],
  },
  {
    ...
    icon: '🎯',
    category: 'scene',
    description: 'Competitive arena with spawn points and pickups',
    entities: 18,
    complexity: 'medium',
    tags: ['game', 'fps'],
  },
  {
    ...
    icon: '🛸',
    category: 'scene',
    description: 'Sci-fi station with airlocks and zero-G zones',
    entities: 30,
    complexity: 'complex',
    tags: ['sci-fi', 'vr'],
  },
  {
    ...
    icon: '🥽',
    category: 'scene',
    description: 'Social VR hub with portals and avatar mirrors',
    entities: 12,
    complexity: 'simple',
    tags: ['vr', 'social'],
  },
  // Characters
  {
    ...
    icon: '⚔️',
    category: 'character',
    description: 'Warrior, mage, healer, rogue — classic 4-member party',
    entities: 4,
    complexity: 'medium',
    tags: ['game', 'rpg'],
  },
  {
    ...
    icon: '👥',
    category: 'character',
    description: '20 unique crowd NPCs with idle animations',
    entities: 20,
    complexity: 'complex',
    tags: ['game', 'film'],
  },
  {
    ...
    icon: '🧑',
    category: 'character',
    description: '8 customizable VR-ready avatars',
    entities: 8,
    complexity: 'medium',
    tags: ['vr', 'social'],
  },
  // Environments
  {
    ...
    description: 'Dense forest with fog, wildlife, and ambient sound',
    entities: 40,
    complexity: 'complex',
    tags: ['game', 'nature'],
  },
  {
    ...
    icon: '🏰',
    category: 'environment',
    description: 'Modular dungeon pieces with traps and secrets',
    entities: 35,
    complexity: 'complex',
    tags: ['game', 'rpg'],
  },
  {
    ...
    icon: '🌃',
    category: 'environment',
    description: 'Neon-lit cityscape with rain and holograms',
    entities: 50,
    complexity: 'complex',
    tags: ['sci-fi', 'film'],
  },
  {
    ...
    icon: '🏝️',
    category: 'environment',
    description: 'Beach, palms, ocean, and underwater coral',
    entities: 28,
    complexity: 'medium',
    tags: ['game', 'nature'],
  },
  // UI
  {
    ...
    icon: '📟',
    category: 'ui',
    description: 'Health bar, minimap, hotbar, and quest tracker',
    entities: 6,
    complexity: 'medium',
    tags: ['game', 'ui'],
  },
  {
    ...
    icon: '📋',
    category: 'ui',
    description: 'Animated main menu with settings and credits',
    entities: 4,
    complexity: 'simple',
    tags: ['game', 'ui'],
  },
  // VFX
  {
    ...
    icon: '🪄',
    category: 'vfx',
    description: 'Fire, ice, lightning, and heal spell effects',
    entities: 8,
    complexity: 'medium',
    tags: ['game', 'vfx'],
  },
  {
    ...
    icon: '🌦️',
    category: 'vfx',
    description: 'Rain, snow, fog, and thunderstorm effects',
    entities: 5,
    complexity: 'medium',
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  ...
                  style={{
                    backgroundColor: `${COMPLEXITY_COLORS[t.complexity]}22`,
        ...
        <div className="bg-studio-panel/30 rounded-lg p-2 space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <span
              ...
              style={{ color: COMPLEXITY_COLORS[selected.complexity] }}
            >
              {selected.complexity}
            </span>
          </div>
