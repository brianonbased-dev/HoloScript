    ...
    <div className="p-3 space-y-3 text-xs">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] text-studio-muted">
          FOV {state.fov.toFixed(0)}° · Zoom {state.zoom.toFixed(1)}x
        </span>
      </div>
      ...
      <div className="bg-studio-panel/30 rounded-lg p-2">
        <div className="grid grid-cols-3 gap-2 text-[10px]">
          <div>
            ...
            <br />
            <span className="text-studio-text font-mono">{state.position.x.toFixed(1)}</span>
          </div>
          <div>
            <span className="text-studio-muted">Y</span>
            <br />
            <span className="text-studio-text font-mono">{state.position.y.toFixed(1)}</span>
          </div>
          <div>
            <span className="text-studio-muted">Z</span>
            <br />
            <span className="text-studio-text font-mono">{state.position.z.toFixed(1)}</span>
          </div>
        </div>
      </div>
