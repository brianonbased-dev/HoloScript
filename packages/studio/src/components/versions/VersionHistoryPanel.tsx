...
interface VersionHistoryPanelProps { onClose: () => void; }

const TIME_FMT = new Intl.DateTimeFormat('en', { hour: '2-digit', minute: '2-digit', second: '2-digit' });
    ...
    <div className="flex h-full flex-col bg-studio-panel text-studio-text">
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-studio-border/30">
        ...
        <div className="flex items-start gap-2.5 px-3 py-2.5 bg-studio-accent/8 border-l-2 border-studio-accent">
          ...
          <span className="shrink-0 rounded-full bg-studio-accent/20 px-1.5 py-0.5 text-[7px] text-studio-accent">NOW</span>
        </div>
