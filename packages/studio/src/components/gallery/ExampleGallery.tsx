      ...
      {preview ? (
        <div className="flex flex-1 flex-col">
          <div className="flex shrink-0 items-center gap-2 border-b border-studio-border px-3 py-2">
            <button onClick={() => setPreview(null)} className="text-studio-muted hover:text-studio-text text-[10px]">
              ← Back
            </button>
          ...
          <div className="shrink-0 border-t border-studio-border p-2.5">
            ...
            >
              {applied === preview.id ? '✅ Loaded!' : <><ChevronRight className="h-3 w-3" /> Use This Example</>}
            </button>
          </div>
        </div>
      ) : (
        <>
          ...
          <div className="flex-1 overflow-y-auto p-2.5 space-y-1.5">
            {loading && <p className="py-8 text-center text-[10px] text-studio-muted animate-pulse">Loading examples…</p>}
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-[9px] text-studio-muted line-clamp-2">{ex.description}</p>
                ...
                <div className="mt-2 flex gap-1">
                  ...
                  >
                    {applied === ex.id ? '✅ Loaded!' : <><ChevronRight className="h-3 w-3" /> Use</>}
                  </button>
                </div>
              </div>
            ))}
