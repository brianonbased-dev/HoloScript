      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
            <div className="text-xs font-semibold text-studio-text-muted uppercase tracking-wide">
              Content Type
            </div>
          ...
          <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
            ...
            <div className="mt-2 text-sm text-studio-text whitespace-pre-wrap">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
              ...
              <div className="text-xs text-studio-text-muted">
                {((contentFile?.size || 0) / 1024 / 1024) | 0} MB
              </div>
            </div>
            ...
            <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
              ...
              <div className="mt-2 text-sm font-medium text-studio-text">
                {thumbnailFile?.name || '(none)'}
              </div>
            </div>
          </div>
          ...
          {projectDNA && (
            <div className="rounded-lg bg-studio-info/10 p-4 border border-studio-info/30">
              ...
              <div className="text-sm text-studio-text">
                {projectDNA.detectedStack?.join(', ') || 'Unknown'}
              </div>
            </div>
          )}
          ...
          {enableDaemon && (
            <div className="rounded-lg bg-studio-success/10 p-4 border border-studio-success/30">
              <div className="text-xs font-semibold text-studio-success uppercase tracking-wide mb-2">
                🤖 Daemon Analysis
              </div>
              <div className="text-sm text-studio-text">
                Profile: <span className="font-medium capitalize">{daemonProfile}</span>
              </div>
            </div>
          )}
        </div>
