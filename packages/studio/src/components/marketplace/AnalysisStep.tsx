      ...
      <div>
        ...
        <div className="space-y-3">
            ...
            <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {projectDNA.detectedStack.map((item, i) => (
                  <span
                    key={i}
                    className="inline-block rounded-full bg-studio-accent/20 px-3 py-1 text-xs font-medium text-studio-accent"
                  >
                    {item}
                  </span>
                ))}
          ...
          <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
            ...
            <div className="mt-1 text-base font-medium text-studio-text">
              {(projectDNA.confidence * 100).toFixed(0)}%
            </div>
          </div>
          ...
          <div className="rounded-lg bg-studio-surface p-4 border border-studio-border">
            ...
            <div className="mt-1 text-base font-medium text-studio-text capitalize">
              {projectDNA.recommendedProfile}
            </div>
          </div>
