...
export const ThumbnailStep: React.FC<ThumbnailStepProps> = ({
  ...
  return (
    <div className="space-y-4 p-6">
      <div>
        <h3 className="mb-4 text-base font-semibold text-studio-text">
        ...
        >
          ...
          <p className="mb-6 text-sm text-studio-text-muted">
            PNG, JPG, or WebP (recommended: 1200x675px)
          </p>
          <input
            type="file"
      ...
      {thumbnailFile && (
        <div className="rounded-lg bg-studio-success/10 p-4 border border-studio-success/30">
          <div className="font-medium text-studio-text">
