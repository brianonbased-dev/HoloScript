...
export function SceneSearchOverlay({ open, onClose, onJump }: SceneSearchOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-16" onClick={onClose}>
      <div
        className="w-full max-w-sm overflow-hidden rounded-2xl border border-studio-border bg-[#0d0d1a]/95 shadow-2xl backdrop-blur-xl"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`rounded-full border px-1.5 py-0.5 text-[7px] font-medium ${TYPE_COLOR[r.type]}`}
                  >
                    {r.type}
                  </span>
                </div>
