...
export const SCENARIOS: ScenarioEntry[] = [
  ...
  {
    id: 'v6-swarm',
    name: 'Agent Swarm Commander',
    emoji: '🌐',
    category: 'engineering',
    description: 'P2P Gossip, Agent Roles, Swarm Coordination',
    tags: ['v6', 'agents', 'mesh'],
    engine: 'v6PlatformServices',
    testCount: 0,
  },
  {
    id: 'v6-snn',
    name: 'Spiking Neural Net GPU',
    emoji: '🧠',
    category: 'science',
    description: 'WebGPU neuron inferencing in real-time',
    tags: ['v6', 'ai', 'snn'],
    engine: 'v6PlatformServices',
    testCount: 0,
  },
  {
    id: 'v6-sandbox',
    name: 'RBAC Sandbox Auditor',
    emoji: '🛡️',
    category: 'engineering',
    description: 'StdlibPolicy limits and cryptograhpic context isolation',
    tags: ['v6', 'security'],
    engine: 'v6PlatformServices',
    testCount: 0,
  },
  {
    id: 'v6-compiler',
    name: 'Universal Output Compiler',
    emoji: '📦',
    category: 'engineering',
    description: 'AST metrics to USD, Unity, VRChat backends',
    tags: ['v6', 'compiler'],
    engine: 'v6PlatformServices',
    testCount: 0,
  },
  {
    id: 'v6-market',
    name: 'Galactic Infinite Market',
    emoji: '🏦',
    category: 'society',
    description: 'V2 Reputation, Agent Escrows, Micropayments',
    tags: ['v6', 'economy'],
    engine: 'v6PlatformServices',
    testCount: 0,
  },
