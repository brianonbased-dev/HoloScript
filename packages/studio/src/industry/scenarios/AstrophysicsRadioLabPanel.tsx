...
import { RadioSpectrumEvent, mapRadioToVolumetric, filterRFI } from '@/lib/astrophysicsScenario';
...
export function AstrophysicsRadioLabPanel() {
  ...
  return (
    <div style={s.panel} data-testid="astro-radio-panel">
      ...
      <div style={s.box}>
        <div style={{ fontSize: 12, fontWeight: 'bold', marginBottom: 10, color: '#a78bfa' }}>
          SPATIAL VOLUMETRIC MAPPING PREVIEW
        </div>
            ...
            >
              <div>
                <div style={{ fontSize: 12, fontWeight: 'bold' }}>
                  Spectrum {ev.frequencyMHz} MHz
                </div>
                <div style={{ fontSize: 10, color: '#94a3b8' }}>
                  RA: {ev.rightAscension}° | DEC: {ev.declination}°
                </div>
              </div>
              <div
                style={{
                  width: 20 * mapping.scaleX,
                  height: 10,
                  borderRadius: 5,
