  ...
  // --- A04: Maze ---
  {
    ...
    objects: [
      ...
      ...[
        {
          name: 'Wall_North',
          position: [5, 0.75, 0] as [number, number, number],
          scale: [10, 1.5, 0.1] as [number, number, number],
        },
        {
          name: 'Wall_South',
          position: [5, 0.75, 10] as [number, number, number],
          scale: [10, 1.5, 0.1] as [number, number, number],
        },
        {
          name: 'Wall_East',
          position: [10, 0.75, 5] as [number, number, number],
          scale: [0.1, 1.5, 10] as [number, number, number],
        },
        {
          name: 'Wall_West',
          position: [0, 0.75, 5] as [number, number, number],
          scale: [0.1, 1.5, 10] as [number, number, number],
        },
      ...
      ...[
        {
          name: 'V2',
          position: [2, 0.75, 6] as [number, number, number],
          scale: [0.1, 1.5, 8] as [number, number, number],
        },
        {
          name: 'V4',
          position: [4, 0.75, 6] as [number, number, number],
          scale: [0.1, 1.5, 8] as [number, number, number],
        },
        {
          name: 'V6',
          position: [6, 0.75, 6] as [number, number, number],
          scale: [0.1, 1.5, 8] as [number, number, number],
        },
        {
          name: 'V8',
          position: [8, 0.75, 6] as [number, number, number],
          scale: [0.1, 1.5, 8] as [number, number, number],
        },
        {
          name: 'H2',
          position: [4, 0.75, 2] as [number, number, number],
          scale: [8, 1.5, 0.1] as [number, number, number],
        },
        {
          name: 'H4',
          position: [4, 0.75, 4] as [number, number, number],
          scale: [8, 1.5, 0.1] as [number, number, number],
        },
        {
          name: 'H6',
        ...
        {
          name: 'H8',
          position: [4, 0.75, 8] as [number, number, number],
          scale: [8, 1.5, 0.1] as [number, number, number],
        },
      ].map((w) => ({ ...w, type: 'mesh', primitive: 'cube', color: 'brown' })),
    ],
    notes:
      '5x5 grid (2m cells), outer perimeter + interior walls forming unique path from (0,0) to (4,4)',
  },
  ...
  // --- A10: Gear assembly ---
  {
    ...
    objects: [
      // Large gear
      {
        ...
        position: [0, 0, 0],
        radius: 1.0,
        scale: [1, 0.2, 1] as [number, number, number],
        color: 'silver',
      },
      ...
      ...Array.from({ length: 8 }, (_, i) => {
        ...
        return {
          ...
          type: 'mesh',
          primitive: 'cube',
          position: [1.4 + Math.cos(angle) * 0.4, 0, Math.sin(angle) * 0.4] as [
            number,
            number,
            number,
          ],
    ...
    notes:
      'Large gear (r=1.0) at origin, small gear (r=0.4) at (1.4,0,0), 8 teeth each, gray axles',
  },
