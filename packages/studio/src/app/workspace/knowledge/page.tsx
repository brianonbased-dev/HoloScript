      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
          ...
          <p className="text-h-text-dim text-sm max-w-2xl">
            This module compresses your domain insights into standard structured tuples (Wisdom,
            Pattern, Gotcha) and files them to your designated HoloMesh workspace. The synced
            knowledge is instantly queryable by all agents connected to your API key.
          </p>
        </div>
