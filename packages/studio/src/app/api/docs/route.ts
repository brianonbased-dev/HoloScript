...
export async function GET() {
  const spec = {
    ...
    info: {
      ...
      version: '0.1.0',
      description:
        'Backend API for HoloScript Studio — 3D scene creation, compilation, and deployment platform. 70+ REST endpoints, MCP tool proxy, OAuth authentication.',
    ...
    paths: {
      ...
      '/api/auth/{...nextauth}': {
        get: {
          ...
          description: 'Handles /signin, /signout, /callback, /session, /csrf, /providers',
          parameters: [
            { name: '...nextauth', in: 'path', required: true, schema: { type: 'string' } },
          ],
      ...
      '/api/agent': {
        get: {
          tags: ['agent'],
          summary: 'List available agent actions',
          responses: { '200': { description: 'Action catalog' } },
        },
        post: {
          tags: ['agent'],
          summary: 'Execute agent action',
          description:
            'Maps friendly action names to MCP tools. Actions: compile, parse, validate, suggest_traits, generate, query, list_traits, explain_trait',
          requestBody: {
            content: {
              'application/json': {
                schema: {
      ...
      '/api/studio/mcp-config': {
        get: {
          tags: ['agent'],
          summary: 'MCP configuration for IDE agents',
          parameters: [
            {
              name: 'format',
              in: 'query',
              schema: { type: 'string', enum: ['claude', 'cursor', 'generic'], default: 'claude' },
            },
          ],
          responses: { '200': { description: 'MCP server configuration' } },
        },
      },
      '/api/studio/quickstart': {
        post: {
          tags: ['agent'],
          summary: 'One-request agent onboarding',
          description: 'Returns capabilities, workflows, MCP config, and hello world compilation',
          responses: { '200': { description: 'Quickstart bundle' } },
        },
      },
      '/api/studio/capabilities': {
        get: {
          tags: ['agent'],
          summary: 'Structured capabilities listing',
          description: 'Returns all Studio domains, tools, and access methods',
      ...
      '/api/generate': {
        post: {
          tags: ['scenes'],
          summary: 'Generate scene from prompt',
          requestBody: {
            content: {
              'application/json': {
                schema: {
          ...
          responses: { '200': { description: 'Generated scene' } },
        },
      },
      '/api/export': {
        post: {
          tags: ['scenes'],
          summary: 'Export scene',
      ...
      '/api/export/gltf': {
        post: {
          tags: ['scenes'],
          summary: 'Export scene as GLTF',
          responses: { '200': { description: 'GLTF data' } },
        },
      },
      '/api/export/v2': {
        post: {
          tags: ['scenes'],
          summary: 'Export scene (v2 pipeline)',
          responses: { '200': { description: 'Exported data' } },
        },
      },
      '/api/publish': {
      ...
      '/api/deploy': {
        post: {
          tags: ['scenes'],
          summary: 'Deploy scene to hosting',
          responses: { '200': { description: 'Deployment result' } },
        },
      },
      '/api/critique': {
        post: {
          tags: ['scenes'],
          summary: 'AI scene critique',
          responses: { '200': { description: 'Critique result' } },
        },
      },
      '/api/assets': {
        get: {
      ...
      '/api/assets/upload': {
        post: {
          ...
          responses: { '200': { description: 'Uploaded asset' } },
        },
      },
      '/api/assets/process': {
        post: {
          tags: ['assets'],
          summary: 'Process uploaded asset',
      ...
      '/api/social/follows': {
        post: {
          ...
          responses: { '200': { description: 'Follow result' } },
        },
      },
      '/api/social/comments': {
        post: {
          tags: ['social'],
          summary: 'Comment on scene',
          responses: { '200': { description: 'Comment result' } },
        },
      },
      '/api/social/crosspost/moltbook': {
        ...
        post: {
          ...
          description:
            'Posts a discovery/update payload to Moltbook community channels for agent visibility.',
          requestBody: {
            content: {
              'application/json': {
                schema: {
      ...
      '/api/trait-registry': {
        get: {
          tags: ['projects'],
          summary: 'Browse trait registry',
          responses: { '200': { description: 'Trait list' } },
        },
      },
      '/api/materials': {
        get: {
          ...
          responses: { '200': { description: 'Material list' } },
        },
      },
      '/api/plugins': {
        get: {
