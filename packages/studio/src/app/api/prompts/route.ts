...
const PROMPTS: Prompt[] = [
  // ── Scene Building ─────────────────────────────────────────────────────────
  {
    id: 'build-room',
    title: 'Build a Room',
    prompt: 'Create a cozy living room with a fireplace, two sofas, a coffee table, and warm ambient lighting',
  ...
  },
  {
    ...
    prompt: 'Build a forest clearing with tall pine trees, a small stream, wildflowers, and golden hour sunlight',
    category: 'Scene Building',
  ...
  },
  {
    ...
    prompt: 'Design a futuristic space station corridor with metallic walls, blue accent lights, holographic displays, and an airlock at the end',
    category: 'Scene Building',
  ...
  },
  {
    ...
    prompt: 'Create a cyberpunk city rooftop scene at night with neon signs, rain effects, distant skyscrapers, and a hovering drone',
    category: 'Scene Building',
  ...
  // ── Physics & Simulation ───────────────────────────────────────────────────
  {
    ...
    prompt: 'Set up a domino chain reaction with 50 dominoes in a spiral pattern that triggers when the first one is pushed',
  ...
  },
  {
    ...
    prompt: 'Build a Rube Goldberg machine marble run with ramps, loops, funnels, and a bell at the finish',
    category: 'Physics & Simulation',
  ...
  },
  {
    ...
    prompt: 'Create a dramatic explosion with expanding fireball, debris particles, shockwave ring, and camera shake',
    category: 'Physics & Simulation',
  ...
  // ── Game Mechanics ─────────────────────────────────────────────────────────
  {
    ...
    prompt: 'Design a side-scrolling platformer level with moving platforms, spike traps, collectible coins, and a flagpole finish',
  ...
  },
  {
    ...
    prompt: 'Create an RPG inventory system with a 6x4 grid, item tooltips, drag-and-drop, and an equipment panel',
    category: 'Game Mechanics',
  ...
  },
  {
    ...
    prompt: 'Create a merchant NPC with a branching dialogue tree: greet, show items, haggle, buy, and farewell paths',
    category: 'Game Mechanics',
  ...
  // ── Visual Effects ──────────────────────────────────────────────────────────
  {
    ...
    prompt: 'Create a stunning aurora borealis effect with flowing green and purple curtains of light in a starry night sky',
  ...
  },
  {
    id: 'portal-effect',
    title: 'Magic Portal',
    prompt: 'Build a swirling magic portal with a glowing ring, particle vortex, lens distortion effect, and ethereal sound',
    category: 'Visual Effects',
  ...
  },
  {
    id: 'fire-campfire',
    title: 'Campfire',
    prompt: 'Create a realistic campfire with flickering flames, ember particles, crackling audio, and warm light that illuminates nearby logs',
    category: 'Visual Effects',
  ...
  // ── Architecture & Design ──────────────────────────────────────────────────
  {
    id: 'modern-house',
    title: 'Modern House',
    prompt: 'Design a modern minimalist house with floor-to-ceiling windows, a flat roof, an open floor plan, and a pool deck',
  ...
  },
  {
    ...
    prompt: 'Create a museum exhibition space with pedestals for 3D sculptures, spotlighting, info plaques, and an interactive tour guide path',
    category: 'Architecture & Design',
  ...
  // ── Modify & Enhance ──────────────────────────────────────────────────────
  {
    ...
    prompt: 'Add realistic physics to every object in the current scene: make the floor static, all boxes dynamic with mass, and spheres bouncy',
  ...
  },
  {
    ...
    prompt: 'Replace the current lighting with cinematic three-point lighting: key light from above-right, fill light from left, and a rim light from behind',
    category: 'Modify & Enhance',
  ...
  },
  {
    ...
    prompt: 'Add click interactions to every object: clicking an object should highlight it, show its name, and play a subtle sound effect',
    category: 'Modify & Enhance',
  ...
  // ── Learning & Reference ───────────────────────────────────────────────────
  {
    ...
    prompt: 'List every @-trait available in HoloScript with a one-line description and example usage for each',
  ...
  },
  {
    ...
    prompt: 'Explain what the current scene code does line by line, including what each trait does and how the objects relate to each other',
    category: 'Learning & Reference',
