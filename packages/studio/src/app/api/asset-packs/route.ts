...
const PACKS: AssetPack[] = [
  {
    ...
    category: 'sci-fi',
    emoji: '🛸',
    description: 'Modular space station components: corridors, airlocks, control panels, and reactor cores',
    author: 'HoloScript Labs',
    itemCount: 6,
    tags: ['space', 'futuristic', 'interior'],
    items: [
      {
        id: 'corridor', name: 'Corridor Segment', type: 'mesh', emoji: '🚪',
      ...
      {
        id: 'reactor', name: 'Reactor Core', type: 'mesh', emoji: '⚛️',
      ...
      {
        id: 'airlock', name: 'Airlock Door', type: 'mesh', emoji: '🔒',
      ...
      {
        id: 'control-panel', name: 'Control Panel', type: 'mesh', emoji: '🖥️',
      ...
      {
        id: 'station-light', name: 'Station Accent Light', type: 'light', emoji: '💡',
        traitSnippet: `light "Station_Light" {\n  @transform { position: [0, 3, 0] }\n  @light { type: point color: "#0088ff" intensity: 2.0 range: 12 castShadow: true }\n}`,
      },
      {
        id: 'escape-pod', name: 'Escape Pod', type: 'mesh', emoji: '🚀',
  ...
  },
  {
    ...
    items: [
      {
        id: 'market-stall', name: 'Market Stall', type: 'mesh', emoji: '🏪',
        traitSnippet: `object "Market_Stall" {\n  @transform { position: [0, 0, 0] }\n  @material { albedo: "#8B4513" roughness: 0.9 }\n  @physics { type: static }\n}`,
      },
      {
        id: 'torch', name: 'Wall Torch', type: 'mesh', emoji: '🔥',
  ...
  },
  {
    ...
    category: 'urban',
    emoji: '🏙️',
    description: 'City props: streetlights, benches, traffic signals, dumpsters, and distant crowd audio',
    author: 'HoloScript Labs',
    itemCount: 5,
    tags: ['city', 'street', 'modern'],
    items: [
      {
        id: 'streetlight', name: 'Street Light', type: 'mesh', emoji: '🔦',
  ...
  },
  {
    ...
    category: 'abstract',
    emoji: '🎨',
    description: 'Geometric art installations: floating cubes, plasma orbs, mirror planes, light pillars',
    author: 'HoloScript Labs',
    itemCount: 4,
    tags: ['art', 'geometric', 'abstract'],
    items: [
      {
        id: 'plasma-orb', name: 'Plasma Orb', type: 'mesh', emoji: '🔮',
        traitSnippet: `object "Plasma_Orb" {\n  @transform { position: [0, 1.5, 0] }\n  @material { fragmentShader: "plasma" roughness: 0.0 metallic: 0.5 }\n  @animation { rotate: [0, 30, 0] loop: true }\n}`,
      },
      {
        id: 'mirror-plane', name: 'Mirror Plane', type: 'mesh', emoji: '🪞',
      ...
      {
        id: 'light-pillar', name: 'Light Pillar', type: 'light', emoji: '💫',
      ...
      {
        id: 'floating-cube', name: 'Floating Cube', type: 'mesh', emoji: '📦',
  ...
  },
  {
    ...
    category: 'vr-ui',
    emoji: '🥽',
    description: 'Spatial UI elements: floating panels, hand menus, progress rings, notification popups',
    author: 'HoloScript Labs',
    itemCount: 4,
    tags: ['vr', 'ui', 'xr', 'spatial'],
    items: [
      {
        id: 'floating-panel', name: 'Floating Info Panel', type: 'mesh', emoji: '🪟',
      ...
      {
        id: 'progress-ring', name: 'Progress Ring', type: 'mesh', emoji: '⭕',
      ...
      {
        id: 'hand-menu', name: 'Hand Menu Anchor', type: 'group', emoji: '🤚',
        traitSnippet: `group "Hand_Menu" {\n  @transform { position: [0, 0, 0] }\n  @xr { attachTo: "leftWrist" billboard: false }\n}`,
      },
      {
        id: 'notification', name: 'Notification Toast', type: 'mesh', emoji: '🔔',
