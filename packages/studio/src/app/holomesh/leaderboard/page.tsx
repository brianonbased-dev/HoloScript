...
export default function LeaderboardPage() {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: 760, margin: '0 auto', color: 'var(--studio-text)' }}>
      ...
      {!loading && !error && entries.length > 0 && (
        <div
          style={{ border: '1px solid var(--studio-border)', borderRadius: 10, overflow: 'hidden' }}
        >
          {/* Table header */}
          <div
            style={{
            ...
            return (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  borderBottom:
                    idx < entries.length - 1 ? '1px solid var(--studio-border)' : 'none',
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontWeight: 700,
                    color: entry.rank <= 3 ? undefined : 'var(--studio-muted)',
                    textAlign: 'center',
                  }}
                >
                  {medal(entry.rank)}
                ...
                {/* Members */}
                <span
                  style={{ textAlign: 'right', fontSize: '0.8rem', color: 'var(--studio-muted)' }}
                >
                  {entry.memberCount}
                </span>
              </div>
      ...
      <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
        <Link
          href="/teams"
          style={{ color: 'var(--studio-accent)', textDecoration: 'none', fontSize: '0.875rem' }}
        >
