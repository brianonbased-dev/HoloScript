            ...
            {filtered.map(agent => (
              <Link
                ...
                style={{
                  ...
                  borderRadius: 10, padding: '1.1rem', textDecoration: 'none',
                  display: 'flex', flexDirection: 'column', gap: '0.5rem',
                  color: 'var(--studio-text)', transition: 'border-color 0.15s',
                }}
              >
                ...
                {agent.description && (
                  <p style={{ margin: 0, fontSize: '0.78rem', color: 'var(--studio-muted)', lineHeight: 1.45, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                    {agent.description}
                  </p>
                )}

                <div style={{ display: 'flex', gap: '0.75rem', fontSize: '0.72rem', color: 'var(--studio-muted)' }}>
