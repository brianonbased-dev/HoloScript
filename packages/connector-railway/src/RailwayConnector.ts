...
export class RailwayConnector extends ServiceConnector {
    ...
    async executeTool(name: string, args: Record<string, unknown>): Promise<unknown> {
        ...
        switch (name) {
            ...
            case 'railway_variable_set':
                ...
                variables = { projectId: args.projectId, environmentId: args.environmentId, serviceId: args.serviceId, name: args.name, value: args.value };
                break;
            case 'railway_domain_add':
                ...
                variables = { serviceId: args.serviceId, environmentId: args.environmentId, domain: args.domain };
                break;
    ...
    private async executeGraphQLWithBackoff(query: string, variables: Record<string, unknown>, retries: number = 3): Promise<unknown> {
