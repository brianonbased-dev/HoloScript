...
export interface LocalLLMProviderConfig extends Omit<LLMProviderConfig, 'apiKey'> {
   ...
   * HOLO_INFERENCE_CALLER then HOLOMESH_HANDLE; omitted entirely when none is set, because a
   * placeholder would look like attribution while identifying nobody.
   */
  callerId?: string;
}
