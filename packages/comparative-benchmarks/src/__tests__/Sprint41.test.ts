/**
 * Sprint 41 — @holoscript/comparative-benchmarks acceptance tests
 ...
 * (min 100ms per task × 3 tasks × 5 benchmarks = ~1.5s minimum).
...
// Constructor & config
// ═══════════════════════════════════════════════
describe('ComparativeBenchmarks — constructor', () => {
...
// ═══════════════════════════════════════════════
describe('ComparativeBenchmarks — generateReport', () => {
...
// ═══════════════════════════════════════════════
// runComparativeBenchmarks — function
// ═══════════════════════════════════════════════
