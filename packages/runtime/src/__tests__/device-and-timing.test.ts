...
// device.ts â€” node environment (no navigator/window)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
describe('device â€” node environment defaults', () => {
  ...
  it('isDesktop returns true in node (not mobile and not tablet)', () => {
    // isDesktop = !isMobile && !isTablet â†’ true when both are false
...
describe('device â€” helper functions', () => {
  ...
  it('isDesktop() is true when isMobile and isTablet are both false', () => {
    // In node: isMobile=false, isTablet=false â†’ isDesktop=true
    expect(isDesktop()).toBe(true);
  });
});

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// timing.ts â€” timer functions with fake timers
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
describe('timing â€” after()', () => {
  beforeEach(() => {
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// timing.ts â€” easing functions (pure math)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
describe('timing â€” easing', () => {
