/**
 * Sprint 40 — @holoscript/ai-validator acceptance tests
...
// Constructor & config
// ═══════════════════════════════════════════════
describe('AIValidator — constructor', () => {
...
// ═══════════════════════════════════════════════
describe('AIValidator — validate() result shape', () => {
...
// validate — valid code
// ═══════════════════════════════════════════════
describe('AIValidator — valid code', () => {
  let validator: AIValidator;
...
// ═══════════════════════════════════════════════
describe('AIValidator — invalid code', () => {
  let validator: AIValidator;
