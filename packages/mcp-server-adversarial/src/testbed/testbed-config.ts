...
export const DEFAULT_TOPOLOGY: TestbedTopology = {
  ...
  legitimateServers: [
    {
      id: 'legit-01',
      toolSet: ['search_knowledge', 'holo_query'],
      latencyMs: 50,
      vouchingDefault: true,
    },
    {
      id: 'legit-02',
      toolSet: ['compile_to_unity', 'compile_to_godot'],
      latencyMs: 120,
      vouchingDefault: true,
    },
    {
      id: 'legit-03',
      toolSet: ['generate_scene', 'generate_world'],
      latencyMs: 80,
      vouchingDefault: false,
    },
    {
      id: 'legit-04',
      toolSet: ['holo_reconstruct', 'holo_anchor'],
      latencyMs: 200,
      vouchingDefault: true,
    },
    {
      id: 'legit-05',
      toolSet: ['protocol_publish', 'protocol_collect'],
      latencyMs: 60,
      vouchingDefault: true,
    },
    {
      id: 'legit-06',
      toolSet: ['absorb_scan', 'absorb_query'],
      latencyMs: 90,
      vouchingDefault: false,
    },
    {
      id: 'legit-07',
      toolSet: ['studio_ui_graph', 'studio_devtools'],
      latencyMs: 40,
      vouchingDefault: true,
    },
    {
      id: 'legit-08',
      toolSet: ['snn_forward', 'snn_encode'],
      latencyMs: 300,
      vouchingDefault: true,
    },
    {
      id: 'legit-09',
      toolSet: ['crdt_sync', 'crdt_spatial'],
      latencyMs: 70,
      vouchingDefault: false,
    },
    {
      id: 'legit-10',
      toolSet: ['lean_check', 'lean_build'],
      latencyMs: 150,
      vouchingDefault: true,
    },
    {
      id: 'legit-11',
      toolSet: ['trust_formula_v1', 'trust_decay'],
      latencyMs: 55,
      vouchingDefault: true,
    },
    {
      id: 'legit-12',
      toolSet: ['canary_probe', 'canary_verify'],
      latencyMs: 65,
      vouchingDefault: true,
    },
  ],
  adversarialServers: [
    {
      id: 'adv-whitewasher-01',
      toolSet: ['search_knowledge'],
      latencyMs: 50,
      vouchingDefault: true,
      adversarial: true,
