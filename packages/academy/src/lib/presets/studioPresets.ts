...
export const STUDIO_PRESETS: StudioPreset[] = [
  ...
  },
  {
    ...
    sidebarTabs: ['traits', 'state', 'network', 'scene', 'compiler', 'saveload'],
    suggestedTemplateCategory: 'minimal',
  },
  {
  ...
  },
  {
    ...
    sidebarTabs: ['traits', 'scene', 'assets', 'lighting', 'camera', 'animation', 'saveload'],
  ...
  },
  {
    ...
    sidebarTabs: ['templates', 'traits', 'scene', 'assets', 'physics', 'animation', 'saveload'],
    suggestedTemplateCategory: 'minimal',
  },
  {
    id: 'vr-world',
  ...
  },
  {
    ...
    emoji: '🌾',
    description:
      'Farm digital twins, greenhouse monitoring, precision agriculture, and crop visualization',
...
export const SUBCATEGORIES: Record<string, SubCategory[]> = {
  ...
  film: [
    ...
    },
    {
      ...
      label: 'Product Viz',
      emoji: '📦',
      description: 'Product showcases and ads',
    },
  ...
  art: [
    {
      ...
      emoji: '🧑‍🎨',
      description: 'Avatars and NPCs',
    },
    {
      id: 'environment-art',
      label: 'Environment Art',
      emoji: '🏔️',
      description: 'Worlds and landscapes',
    },
    {
      id: 'material-study',
      label: 'Material Study',
      emoji: '✨',
      description: 'Shaders and materials',
    },
    {
      id: 'music-visualizer',
      label: 'Music Visualizer',
    ...
    },
    {
      ...
      label: 'AI Scene Composer',
      emoji: '🤖',
      description: 'AI-generated 3D scenes',
    },
  ],
  web: [
    ...
    },
    {
      ...
      emoji: '🔧',
      description: 'Customizable product viewer',
    },
  ],
  iot: [
    {
    ...
    },
    {
      ...
      label: 'Digital Twin',
      emoji: '🏭',
      description: 'Physical system mirror',
    },
    {
      id: 'control-panel',
      label: 'Control Panel',
      emoji: '🎛️',
      description: 'Device management UI',
    },
    {
      id: 'smart-home',
      label: 'Smart Home',
      emoji: '🏠',
      description: 'IoT-connected home dashboard',
    },
  ],
  education: [
    {
      ...
      emoji: '📝',
      description: 'Build learning modules',
    },
    {
      id: 'student-sandbox',
      label: 'Student Sandbox',
      emoji: '🎓',
      description: 'Safe experimentation space',
    },
    {
      id: 'classroom-demo',
      label: 'Classroom Demo',
      emoji: '🏫',
      description: 'Live teaching demos',
    },
  ],
  robotics: [
    {
      ...
      label: 'Robot Arm',
      emoji: '🦾',
      description: 'URDF robot with joint control',
    },
    {
      id: 'factory-automation',
      label: 'Factory Floor',
      emoji: '🏭',
      description: 'Industrial automation twin',
    },
    {
      id: 'drone-sim',
      label: 'Drone Simulator',
      emoji: '🚁',
      description: 'Autonomous flight planning',
    },
    {
      id: 'warehouse-robotics',
      label: 'Warehouse Robots',
      emoji: '📦',
      description: 'Pick-and-place swarms',
    },
  ],
  science: [
    {
      ...
      emoji: '🧬',
      description: 'Drug design and docking',
    },
    {
      id: 'narupa-sim',
      label: 'Narupa MD',
      emoji: '🔬',
      description: 'Interactive molecular dynamics',
    },
    {
      id: 'anatomy-explorer',
      label: 'Anatomy Explorer',
      emoji: '🫀',
      description: 'Medical 3D visualization',
    },
    {
      id: 'surgical-training',
      label: 'Surgical Training',
      emoji: '🏥',
      description: 'VR procedure practice',
    },
  ],
  healthcare: [
    {
      ...
      label: 'Therapy VR',
      emoji: '🧘',
      description: 'Therapeutic virtual environments',
    },
    {
      id: 'rehab-sim',
      label: 'Rehab Simulation',
      emoji: '🏋️',
    ...
    },
    {
      ...
      emoji: '🩺',
      description: 'Medical procedure practice',
    },
    {
      id: 'patient-education',
      label: 'Patient Education',
      emoji: '📋',
      description: 'Visual health explanations',
    },
  ],
  architecture: [
    {
      id: 'building-walkthrough',
      label: 'Building Walkthrough',
      emoji: '🏗️',
      description: 'First-person building tours',
    },
    {
      id: 'interior-design',
      label: 'Interior Design',
      emoji: '🛋️',
      description: 'Room layouts and furnishing',
    },
    {
      id: 'urban-planning',
  ...
  agriculture: [
    ...
    },
    {
      ...
      label: 'Greenhouse',
      emoji: '🌱',
      description: 'Climate-controlled growth tracking',
    },
    {
  ...
  creator: [
    ...
    },
    {
      ...
      label: 'Token Forge',
      emoji: '🔥',
      description: 'Mint and display 3D tokens',
    },
    {
      id: 'social-avatar',
      label: 'Social Avatar',
      emoji: '🧑‍🎤',
      description: 'Custom avatar creator',
    },
    {
      id: 'live-stage',
      label: 'Live Stage',
      emoji: '🎤',
      description: 'Virtual concert and streaming',
    },
  ],
  hologram: [
    {
      id: 'holographic-gallery',
      label: 'Holographic Gallery',
      emoji: '🖼️',
      description: 'Depth-displaced photo gallery',
    },
    {
      id: 'memory-wall',
      label: 'Memory Wall',
      emoji: '🧱',
      description: 'Interactive photo grid holograms',
    },
    {
      id: 'video-portal',
      label: 'Video Portal',
      emoji: '🌀',
      description: 'Video with depth parallax effect',
    },
  ],
};
