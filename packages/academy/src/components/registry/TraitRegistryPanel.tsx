          ...
          return (
            <div key={trait.id}>
              ...
              <div className="flex items-center gap-2 px-3 py-2.5 hover:bg-studio-surface/40 transition">
                <button
                  onClick={() => setExpanded(isExpanded ? null : trait.id)}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[7px] text-studio-muted">
                      {trait.params.length} params · since {trait.since}
                    </p>
                  </div>
                  <span
                    className="shrink-0 rounded-full px-1.5 py-0.5 text-[7px] capitalize"
                    ...
                    {trait.params.map((p: TraitParam) => (
                      ...
                      >
                        ...
                        <span className="text-studio-muted leading-snug">
                          {p.description}
                          {p.options && (
                            <span className="text-studio-muted/60"> ({p.options.join(', ')})</span>
                          )}
                          {p.default != null && (
                            <span className="text-studio-muted/60">
                              {' '}
