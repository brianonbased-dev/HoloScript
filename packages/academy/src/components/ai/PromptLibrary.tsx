        ...
        {prompts.map((p) => (
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    className={`shrink-0 rounded-full border px-1.5 py-0.5 text-[8px] font-medium ${DIFFICULTY_COLOR[p.difficulty] ?? ''}`}
                  >
                    {p.difficulty}
                  </span>
                </div>
            ...
            <div className="mt-1.5 rounded-lg bg-black/20 px-2 py-1.5">
              <p className="text-[10px] leading-relaxed text-studio-text/70 italic">
