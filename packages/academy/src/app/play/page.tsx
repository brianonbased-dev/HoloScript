...
const COMPOUNDS = [
    ...
    children: [
      {
        ...
        scale: [0.25, 1.4, 0.25] as [number, number, number],
        color: '#6D4C41',
        roughness: 0.9,
        metalness: 0,
      },
      {
        type: 'sphere',
        offset: [0, 1.6, 0] as [number, number, number],
        scale: [1.4, 1.6, 1.4] as [number, number, number],
        color: '#00B894',
        roughness: 0.7,
        metalness: 0,
      },
      {
        type: 'sphere',
        offset: [0.5, 1.2, 0.3] as [number, number, number],
      ...
      {
        type: 'sphere',
        offset: [-0.4, 1.3, -0.3] as [number, number, number],
    ...
    children: [
      {
        type: 'box',
        offset: [0, 0, 0] as [number, number, number],
        scale: [1.6, 1.3, 1.6] as [number, number, number],
        color: '#FFEAA7',
        roughness: 0.6,
        metalness: 0.05,
      },
      {
        type: 'cone',
        offset: [0, 1.1, 0] as [number, number, number],
        scale: [2.0, 1.0, 2.0] as [number, number, number],
        color: '#E17055',
        roughness: 0.5,
        metalness: 0.1,
      },
      {
        type: 'box',
        offset: [0.35, -0.15, 0.81] as [number, number, number],
        scale: [0.38, 0.65, 0.06] as [number, number, number],
        color: '#6D4C41',
        roughness: 0.8,
        metalness: 0,
      },
      // Windows (emissive glow!)
      {
        type: 'box',
        offset: [-0.35, 0.15, 0.81] as [number, number, number],
        scale: [0.3, 0.3, 0.04] as [number, number, number],
        color: '#74B9FF',
        emissive: '#74B9FF',
  ...
  },
  {
    ...
    children: [
      ...
      {
        type: 'sphere',
        offset: [0, 0.8, 0] as [number, number, number],
      ...
      {
        type: 'sphere',
        offset: [0, 1.4, 0] as [number, number, number],
      ...
      {
        type: 'cone',
        offset: [0, 1.4, 0.25] as [number, number, number],
        scale: [0.06, 0.3, 0.06] as [number, number, number],
        color: '#E17055',
        roughness: 0.6,
        metalness: 0,
      },
      ...
      {
        type: 'sphere',
        offset: [-0.1, 1.5, 0.2] as [number, number, number],
        scale: [0.06, 0.06, 0.06] as [number, number, number],
        color: '#2D3436',
        roughness: 1,
        metalness: 0,
      },
      ...
      {
        type: 'cylinder',
        offset: [0, 1.7, 0] as [number, number, number],
        scale: [0.35, 0.08, 0.35] as [number, number, number],
        color: '#2D3436',
        roughness: 0.5,
        metalness: 0.2,
      },
      {
        type: 'cylinder',
        offset: [0, 1.9, 0] as [number, number, number],
    ...
    children: [
      {
        type: 'box',
        offset: [0, 0, 0] as [number, number, number],
        scale: [2.8, 1.8, 2.8] as [number, number, number],
        color: '#B2BEC3',
        roughness: 0.7,
        metalness: 0.15,
      },
      {
        type: 'cylinder',
        offset: [-1.2, 1.2, -1.2] as [number, number, number],
        scale: [0.4, 1.4, 0.4] as [number, number, number],
        color: '#A4B0BE',
        roughness: 0.7,
        metalness: 0.15,
      },
      ...
      {
        type: 'cone',
        offset: [-1.2, 2.3, -1.2] as [number, number, number],
        scale: [0.55, 0.7, 0.55] as [number, number, number],
        color: '#6C5CE7',
        roughness: 0.3,
        metalness: 0.3,
      },
      ...
      {
        type: 'box',
        offset: [0, -0.3, 1.41] as [number, number, number],
        scale: [0.5, 0.8, 0.08] as [number, number, number],
        color: '#FDCB6E',
        emissive: '#FDCB6E',
    ...
    children: [
      {
        type: 'cylinder',
        offset: [0, 0, 0] as [number, number, number],
        scale: [0.45, 2.2, 0.45] as [number, number, number],
        color: '#DFE6E9',
        roughness: 0.2,
        metalness: 0.7,
      },
      {
        type: 'cone',
        offset: [0, 1.4, 0] as [number, number, number],
        scale: [0.5, 0.8, 0.5] as [number, number, number],
        color: '#FF6B6B',
        roughness: 0.3,
        metalness: 0.4,
      },
      ...
      {
        type: 'cone',
        offset: [0.35, -0.85, 0] as [number, number, number],
        scale: [0.2, 0.55, 0.1] as [number, number, number],
        color: '#74B9FF',
        roughness: 0.3,
        metalness: 0.4,
      },
      ...
      {
        type: 'cone',
        offset: [0, -0.85, 0.35] as [number, number, number],
        scale: [0.1, 0.55, 0.2] as [number, number, number],
        color: '#74B9FF',
        roughness: 0.3,
        metalness: 0.4,
      },
    ...
    children: [
      {
        type: 'cone',
        offset: [0, 0, 0] as [number, number, number],
        scale: [0.6, 1.8, 0.6] as [number, number, number],
        color: '#A29BFE',
        emissive: '#6C5CE7',
      ...
      },
      {
        type: 'cone',
        offset: [0, 0, 0] as [number, number, number],
        scale: [0.6, -1.0, 0.6] as [number, number, number],
        color: '#A29BFE',
        emissive: '#6C5CE7',
        emissiveIntensity: 1.0,
        roughness: 0.05,
      ...
      {
        type: 'cone',
        offset: [0.3, -0.3, 0.2] as [number, number, number],
        scale: [0.3, 1.0, 0.3] as [number, number, number],
        color: '#74B9FF',
        emissive: '#0984E3',
...
const LIGHTING_PRESETS = [
  {
    ...
    label: '🌅 Sunset',
    sky: true,
    sunPos: [1, 0.15, -1] as [number, number, number],
    stars: false,
    ambI: 0.5,
    dirI: 1.2,
    fogColor: '#1a0d2e',
    bgGradient: 'linear-gradient(180deg, #1a0d2e 0%, #3d1947 30%, #c84b31 60%, #0d1f0d 100%)',
  },
  {
    id: 'day',
    label: '☀️ Day',
    sky: true,
    sunPos: [0, 1, 0] as [number, number, number],
    stars: false,
    ambI: 0.8,
    dirI: 1.8,
    fogColor: '#87CEEB',
    bgGradient: 'linear-gradient(180deg, #74B9FF 0%, #A3D8F4 50%, #55EFC4 80%, #00B894 100%)',
  },
  {
    id: 'night',
    label: '🌙 Night',
    ...
    dirI: 0.3,
    fogColor: '#050510',
    bgGradient: 'linear-gradient(180deg, #0c0c1d 0%, #1a1a3e 50%, #0d150d 100%)',
  },
  {
    id: 'neon',
    label: '🟣 Neon',
    ...
    dirI: 0.4,
    fogColor: '#0a001a',
    bgGradient: 'linear-gradient(180deg, #0a001a 0%, #1a0033 50%, #0d001a 100%)',
  },
  {
    id: 'golden',
    label: '✨ Golden',
    sky: true,
    sunPos: [-1, 0.2, 0] as [number, number, number],
    stars: false,
    ambI: 0.6,
    dirI: 1.5,
    fogColor: '#2a1a0a',
    bgGradient: 'linear-gradient(180deg, #2a1a0a 0%, #4a2a10 30%, #ffa751 60%, #1a2a0a 100%)',
  },
];
      ...
      objects: [
        {
          ...
          scale: [1, 1, 1],
          color: '#FDCB6E',
          children: COMPOUNDS.find((c) => c.type === 'house')!.children,
        },
        {
          type: 'house',
          label: 'House',
          ...
          color: '#FF7675',
          children: COMPOUNDS.find((c) => c.type === 'house')!.children?.map((c) => ({
            ...c,
            color: c.type === 'box' && c.offset[1] === 0 ? '#FF7675' : c.color,
          })),
        },
        {
          type: 'tree',
          ...
          scale: [1, 1, 1],
          color: '#00B894',
          children: COMPOUNDS.find((c) => c.type === 'tree')!.children,
        },
        {
          type: 'tree',
          label: 'Tree',
        ...
        },
        {
          ...
          scale: [0.5, 0.5, 0.5],
          color: '#A29BFE',
          children: COMPOUNDS.find((c) => c.type === 'crystal')!.children,
        },
      ],
    },
    space: {
      ...
      objects: [
        {
          ...
          scale: [1, 1, 1],
          color: '#FF6B6B',
          children: COMPOUNDS.find((c) => c.type === 'rocket')!.children,
        },
        {
          type: 'sphere',
          label: 'Planet',
      ...
      objects: [
        {
          ...
          scale: [1, 1, 1],
          color: '#B2BEC3',
          children: COMPOUNDS.find((c) => c.type === 'castle')!.children,
        },
        {
          type: 'tree',
          label: 'Tree',
        ...
        },
        {
          ...
          scale: [0.8, 0.8, 0.8],
          color: '#DFE6E9',
          children: COMPOUNDS.find((c) => c.type === 'snowman')!.children,
        },
      ],
    },
    garden: {
...
function GLBModel({
  ...
  return (
    <primitive object={cloned} scale={[modelScale, modelScale, modelScale]} onClick={onClick} />
  );
}
      ...
      default:
        if (!isSelected) {
          groupRef.current.position.y =
            obj.position[1] + Math.sin(t * 0.8 + obj.position[0]) * 0.04;
        }
        break;
    }
  });
        ...
        {obj.children.map((child, i) => (
          <mesh key={i} position={child.offset} scale={child.scale} castShadow receiveShadow>
            ...
            <RichMaterial
              ...
              emissiveIntensity={child.emissiveIntensity}
              metalness={child.metalness}
...
function PhysicsObject({
  ...
  isSelected: boolean;
  onSelect: (id: string) => void;
  onUpdatePosition: (id: string, y: number, vy: number) => void;
  ...
  useFrame((state, delta) => {
    ...
    if (posRef.current[1] <= groundY) {
      ...
      if (Math.abs(velRef.current[1]) > 0.5) {
        velRef.current[1] = -velRef.current[1] * simConfig.friction;
        playBounceSound();
      } else {
        velRef.current[1] = 0;
      }
    ...
    if (velRef.current[1] === 0 && Math.abs(posRef.current[1] - obj.position[1]) > 0.01)
      onUpdatePosition(obj.id, posRef.current[1], 0);
  });
...
/** Ground plane */
function StylizedGround({
  onPlace,
  lightingId,
}: {
  onPlace: (p: THREE.Vector3) => void;
  lightingId: string;
}) {
...
const WATER_RADIUS = 4.0; // max distance from river centre for healthy growth
const WASH_RADIUS = 1.8; // too close — washes away (river water is ~1.5 half-width)
...
function WaterRiver({ position }: { position: [number, number, number] }) {
  ...
  return (
    <group position={position}>
      ...
      {/* White foam/highlight stripe down the center */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.03, 0]}>
        <planeGeometry args={[0.4, 18]} />
        <meshStandardMaterial color="#E3F2FD" transparent opacity={0.3} roughness={0} />
      </mesh>
      ...
      <Sparkles
        ...
        position={[0, 0.1, 0]}
      />
      {/* Thin grassy edge strips (left & right) */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[-1.7, 0.003, 0]} receiveShadow>
      ...
      {[
        ...
        <mesh key={i} position={p as [number, number, number]} castShadow>
          <sphereGeometry args={[0.08 + (i % 3) * 0.03, 6, 5]} />
          <meshStandardMaterial color={i % 2 === 0 ? '#78909C' : '#90A4AE'} roughness={0.9} />
        </mesh>
      ))}
    </group>
  );
  ...
  useFrame((_, delta) => {
    ...
    if (stage !== 'ready') {
      if (nextTime >= GROWTH_DURATION) {
        const nextStages: Record<string, GrowthStage> = {
          seed: 'sprout',
          sprout: 'growing',
          growing: 'ready',
        };
    ...
    <group ref={groupRef} position={seed.position} onClick={handleClick}>
      ...
      <mesh position={[0, 0.01, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial
          color={
            stage === 'withering'
              ? `rgb(${93 + witherTint * 50}, ${64 - witherTint * 20}, ${55 - witherTint * 20})`
              : '#5D4037'
          }
          roughness={0.9}
        />
      ...
      {(stage === 'sprout' || stage === 'withering') && (
        <group>
          <mesh position={[0, 0.05 + progress * 0.15, 0]} castShadow>
            ...
            <meshStandardMaterial
              color={witherTint > 0.3 ? '#9E8B60' : '#27AE60'}
              roughness={0.6}
            />
          </mesh>
          <mesh position={[0.04, 0.15 + progress * 0.1, 0]} rotation={[0, 0, 0.4]} castShadow>
            ...
            <meshStandardMaterial
              color={witherTint > 0.3 ? '#B8A060' : '#2ECC71'}
              roughness={0.5}
            />
          </mesh>
          {witherTint > 0.5 && (
      ...
      {stage === 'growing' && (
        <group>
          ...
          {[0, 1.2, 2.4, 3.6, 4.8].map((angle, i) => (
            <mesh
              key={i}
              position={[Math.cos(angle) * 0.08, 0.35 + progress * 0.1, Math.sin(angle) * 0.08]}
      ...
      {stage === 'ready' && (
        <group>
          ...
          {[0, 1.2, 2.4, 3.6, 4.8].map((angle, i) => (
            <mesh
              key={i}
              position={[Math.cos(angle) * 0.06, 0.42, Math.sin(angle) * 0.06]}
              rotation={[0.4 + Math.sin(angle) * 0.2, angle, 0.6]}
              castShadow
            >
...
function GardenScene({
  ...
  onHarvest: () => void;
  onStatsUpdate: (stats: ProofOfPlayStats) => void;
}) {
  ...
  return (
    <group>
      ...
      <GardenToolHUD
        tool={gardenTool}
        setTool={setGardenTool}
        hasRiver={!!riverPos}
        seedCount={seeds.filter((s) => s.stage !== 'dead').length}
      />
    </group>
  );
}
...
function SceneContent({
  ...
  onUpdatePhysicsPos: (id: string, y: number, vy: number) => void;
  onGardenHarvest: () => void;
  onStatsUpdate: (stats: ProofOfPlayStats) => void;
  orbitRef: React.RefObject<any>;
}) {
  return (
    <>
      ...
      <Environment
        preset={lighting.id === 'day' ? 'park' : lighting.id === 'neon' ? 'city' : 'sunset'}
        background={false}
      ...
      {/* === GROUND === */}
      {!gardenActive && <StylizedGround onPlace={onPlace} lightingId={lighting.id} />}
        ...
        if (physicsEnabled)
          return (
            <PhysicsObject
              ...
              isSelected={false}
              onSelect={onSelect}
              onUpdatePosition={onUpdatePhysicsPos}
              simConfig={simConfig}
            />
          );
...
export default function PlayPage() {
    ...
    (point: THREE.Vector3) => {
      ...
      const newObj: SceneObject = {
        ...
        position: [
          ...
          physicsEnabled ? 5 + Math.random() * 3 : groundY,
  ...
  const handleUpdateTransform = useCallback(
    (
      ...
      setObjects((prev) =>
        prev.map((o) => (o.id === id ? { ...o, position: pos, rotation: rot, scale: scl } : o))
      );
    },
    []
  );
  ...
  const handleUpdatePhysicsPos = useCallback((id: string, y: number, vy: number) => {
    setObjects((prev) =>
      prev.map((o) =>
        o.id === id
          ? { ...o, position: [o.position[0], y, o.position[2]], velocity: [0, vy, 0] }
          : o
      )
    );
  }, []);
  ...
  const duplicateSelected = useCallback(() => {
    ...
    const n = {
      ...
      id: `obj-${Date.now()}`,
      position: [
        selectedObj.position[0] + 1.5,
        selectedObj.position[1],
        selectedObj.position[2],
      ] as [number, number, number],
    };
    setObjects((prev) => [...prev, n]);
    setSelectedId(n.id);
    playPlaceSound();
  }, [selectedObj]);
        ...
        prev.map((o) => {
          ...
          if (o.children)
            return {
              ...o,
              color,
              children: o.children.map((c, i) => (i === 0 ? { ...c, color } : c)),
            };
          return { ...o, color };
        })
      );
  ...
  const loadScene = useCallback((sceneId: string) => {
    ...
    setObjects(
      s.objects.map((o, i) => ({
        ...o,
        id: `s-${sceneId}-${i}-${Date.now()}`,
        animation: 'none' as AnimationType,
        particles: 'none' as ParticleType,
      }))
    );
    setSelectedId(null);
  }, []);
    ...
    setPhysicsEnabled((prev) => {
      if (!prev)
        setObjects((objs) =>
          objs.map((o) => ({
            ...o,
            position: [o.position[0], o.position[1] + 0.1, o.position[2]] as [
              number,
              number,
              number,
            ],
      ...
      <div className="play-workspace">
        <aside className="play-toolbar">
          ...
          {PRIMITIVES.map((p) => (
            <button
              key={p.type}
              className={`play-tool-btn ${activeTool.type === p.type ? 'active' : ''}`}
              onClick={() => {
                setActiveTool(p);
          ...
          {Object.entries(SCENES).map(([id, scene]) => (
            <button
              key={id}
              className="play-tool-btn play-scene-btn"
              onClick={() => loadScene(id)}
              title={scene.label}
            >
          ...
          >
            <Suspense fallback={null}>
              <SceneContent
                ...
                onUpdatePhysicsPos={handleUpdatePhysicsPos}
                onGardenHarvest={() => {
          ...
          {gardenActive && (
            <div className="play-garden-hud">
              ...
              {computeStats && computeStats.totalJobs > 0 && (
                <span className="play-garden-gold">
                  🪙 {computeStats.ecosystemValue.toFixed(0)} gold • {computeStats.totalJobs} jobs
                </span>
              )}
              <span className="play-garden-hint">
                ① Place river 💧 ② Plant seeds 🌱 Growth fuels the ecosystem!
              </span>
            </div>
          )}
        </main>
          ...
          <aside className="play-properties">
            ...
            <div className="play-transform-group">
              {(['translate', 'rotate', 'scale'] as const).map((m) => (
                <button
                  key={m}
                  className={`play-transform-btn ${transformMode === m ? 'active' : ''}`}
            ...
            <div className="play-toolbar-label" style={{ marginTop: 12 }}>
              COLOR
            </div>
            <div className="play-color-grid">
              {COLOR_PALETTE.map((c) => (
                <button
                  key={c}
                  className={`play-color-swatch ${selectedObj.color === c ? 'active' : ''}`}
                  style={{ background: c }}
            ...
            <div className="play-anim-picker">
              {ANIMATION_PRESETS.map((a) => (
                <button
                  key={a.id}
                  className={`play-anim-btn ${selectedObj.animation === a.id ? 'active' : ''}`}
            ...
            <div className="play-anim-picker">
              {PARTICLE_PRESETS.map((p) => (
                <button
                  key={p.id}
                  className={`play-anim-btn ${selectedObj.particles === p.id ? 'active' : ''}`}
            ...
            <div className="play-prop-actions">
              <button className="play-action-btn" onClick={duplicateSelected}>
                📋 Duplicate
              </button>
              <button className="play-action-btn play-delete-btn" onClick={deleteSelected}>
                🗑️ Delete
              </button>
            </div>
          </aside>
      ...
      <footer className="play-footer">
        <div className="play-lighting-bar">
          {LIGHTING_PRESETS.map((p, i) => (
            <button
              key={p.id}
              className={`play-lighting-btn ${lightingIdx === i ? 'active' : ''}`}
        ...
        <div className="play-footer-hints">
          ...
          <span>P Physics</span>
          <button
            className={`play-sim-toggle ${simPanelOpen ? 'active' : ''}`}
        ...
        <div className="play-footer-actions">
          <button className="play-action-btn" onClick={exportScene} disabled={objects.length === 0}>
            📤 Export
          </button>
          <button
          ...
          <button className="play-action-btn" onClick={clearAll} disabled={objects.length === 0}>
            🗑️ Clear
          </button>
        </div>
      </footer>
      ...
      {simPanelOpen && (
        <div className="play-sim-panel">
          <div className="play-sim-header">
            ...
            <button className="play-sim-close" onClick={() => setSimPanelOpen(false)}>
              ✕
            </button>
          </div>
          ...
          <label className="play-sim-row">
            ...
            <input
              ...
              max={5}
              step={0.1}
              value={simConfig.wind[0]}
              onChange={(e) =>
                setSimConfig((s) => ({ ...s, wind: [+e.target.value, s.wind[1], s.wind[2]] }))
              }
            />
          ...
          <label className="play-sim-row">
            ...
            <input
              ...
              max={5}
              step={0.1}
              value={simConfig.wind[2]}
              onChange={(e) =>
                setSimConfig((s) => ({ ...s, wind: [s.wind[0], s.wind[1], +e.target.value] }))
              }
            />
          ...
          <button
            ...
            onClick={() => setSimConfig({ ...DEFAULT_SIM })}
          >
            🔄 Reset Defaults
          </button>
        </div>
