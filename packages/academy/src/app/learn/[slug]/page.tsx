...
const DEMO_TUTORIAL: TutorialStep[] = [
  {
    ...
    markdown:
      '<p>HoloScript is the premier language for defining declarative spatial computing interfaces, agents, and worlds.</p><p>Instead of manipulating complex raw 3D engine APIs, you use high-level "Traits" bound to a semantic scene graph.</p><p><strong>Goal:</strong> Let\'s start by instantiating an empty World.</p>',
    initialCode:
  ...
  },
  {
    ...
    markdown:
      '<p>Every object in HoloScript is an <code>Entity</code>. Entities are empty containers until you attach <code>Traits</code> to them.</p><p><strong>Goal:</strong> Create a new Entity named "Player".</p>',
    initialCode:
  ...
  },
  {
    ...
    markdown:
      "<p>Let's give our Player a physical form. We'll use the <code>Box</code> trait to render a simple cube.</p><p><strong>Goal:</strong> Attach a <code>Box</code> trait to your Player entity.</p>",
    initialCode:
