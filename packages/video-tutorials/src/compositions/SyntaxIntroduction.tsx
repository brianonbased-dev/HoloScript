...
const STEPS = [
  ...
  },
  {
    ...
    lines: [
      ...
      {
        content: '    mesh: Plane { scale: [4, 1, 4] }',
        type: 'added' as const,
        annotation: 'geometry',
      },
      {
        content: '    material: StandardMaterial { color: #7CFC00 }',
        type: 'added' as const,
        annotation: 'surface',
      },
  ...
  },
  {
    title: 'Add Lighting',
    description:
      'Scenes need light. HoloScript supports 6 light types — directional is the most common.',
    lines: [
      { content: 'scene VirtualGarden {' },
  ...
  },
  {
    ...
    lines: [
      ...
      {
        content: '    position: [0, 3, 8]',
        type: 'added' as const,
        annotation: 'above and behind',
      },
  ...
  },
  {
    ...
    lines: [
      ...
      {
        content: '      PhysicsBody { mass: 0.2 }',
        type: 'added' as const,
        annotation: 'gravity + collisions',
      },
      { content: '    ]' },
      { content: '  }' },
    ],
