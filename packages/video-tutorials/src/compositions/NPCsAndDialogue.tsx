...
const STEPS = [
  {
    ...
    description: "NPCs are objects with the NPC trait — they get a name, avatar mesh, and navigation by default.",
    lines: [
      ...
      { content: "      NPC { name: \"Merlin\", role: quest_giver },", type: "added" as const, annotation: "core NPC trait" },
      { content: "      Idle { animation: breathe, loop: true },", type: "added" as const },
      { content: "      NavMeshAgent { speed: 2.0 }", type: "added" as const, annotation: "pathfinding" },
      { content: "    ]" },
      { content: "  }" },
    ],
  },
  {
    ...
    description: "Define dialogue inline with the dialogue block — branches, conditions, and actions.",
    lines: [
  ...
  },
  {
    ...
    lines: [
      ...
      { content: "        say: \"Find the golden key hidden in the forest.\"", type: "added" as const },
