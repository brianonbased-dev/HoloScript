...
const STEPS = [
  {
    ...
    description: "Traits are named behaviors — attach them to any object to add physics, interaction, AI, or animation.",
    lines: [
      ...
      { content: "      Breakable { hp: 3 }", type: "added" as const, annotation: "can be destroyed" },
      { content: "    ]" },
      { content: "  }" },
    ],
  },
  {
    ...
    description: "PhysicsBody, Kinematic, StaticCollider — three modes for different physics use cases.",
    lines: [
  ...
  },
  {
    ...
    description: "Make objects respond to the user — hover highlights, grab-and-throw, proximity triggers.",
    lines: [
      ...
      { content: "      Grabbable { throwable: true },", type: "added" as const, annotation: "VR grab support" },
      { content: "      ProximityTrigger { radius: 2.0, onEnter: \"glow\" }", type: "added" as const },
      { content: "    ]" },
      { content: "  }" },
    ],
  },
  {
    ...
    lines: [
      ...
      { content: "    traits: [", highlight: true },
      { content: "      Rotate { axis: [0,1,0], speed: 180 },", type: "added" as const, annotation: "deg/sec" },
