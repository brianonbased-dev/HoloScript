...
const STEPS = [
  {
    ...
    description:
      'Define animations inline with from/to keyframes — no separate animation files needed.',
    lines: [
      { content: '  object Door {' },
  ...
  },
  {
    title: 'Timelines',
    description:
      'Sequence multiple animations with timeline blocks — control order, delay, and overlap.',
    lines: [
      { content: 'scene Intro {' },
  ...
  },
  {
    ...
    lines: [
      ...
      {
        content: 'animation Pop { easing: spring(stiffness: 400), duration: 0.3s }',
        highlight: true,
      },
      { content: '' },
  ...
  },
  {
    ...
    description:
      'For repeating, code-driven animations — use animation traits instead of keyframes.',
    lines: [
  ...
  },
  {
    ...
    lines: [
      ...
      {
        content: '        this.play("Open")',
        type: 'added' as const,
        annotation: 'named animation',
      },
