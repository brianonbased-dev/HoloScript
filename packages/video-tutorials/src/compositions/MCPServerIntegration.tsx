...
const STEPS = [
  {
    ...
    description: "MCP (Model Context Protocol) skills are defined in SKILL.md files with a structured frontmatter block.",
    lines: [
  ...
  },
  {
    ...
    description: "The holoscript-language MCP server registers tools using the @modelcontextprotocol/sdk package.",
    lines: [
      { content: 'import { Server } from "@modelcontextprotocol/sdk/server/index.js"', highlight: true },
      ...
      { content: ")" },
      { content: "" },
      { content: "server.setRequestHandler(ListToolsRequestSchema, async () => ({", highlight: true },
      ...
      { content: "await server.connect(transport)", type: "added" as const, annotation: "start server" },
    ],
  },
  {
    title: "Tool: brittney_scan_project",
    description: "Call the scan tool to discover all .holo files and their scene names in the workspace.",
    lines: [
  ...
  },
  {
    ...
    description: "Pass a natural language prompt and receive a ready-to-use .holo scene from the MCP server.",
    lines: [
      ...
      { content: '  "args": {' },
      { content: '    "prompt": "A futuristic showroom with neon lighting and a car on a rotating platform",' },
  ...
  },
  {
    ...
    description: "Add the HoloScript MCP server to your .claude/settings.json so Claude Code can discover it automatically.",
    lines: [
      ...
      { content: '        "HOLOSCRIPT_WORKSPACE": "${workspaceFolder}"', type: "added" as const, annotation: "path injection" },
      { content: "      }", type: "added" as const },
      { content: "    }" },
      { content: "  }," },
      { content: '  "permissions": {' },
