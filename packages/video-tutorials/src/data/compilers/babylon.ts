...
export const babylonData: CompilerWalkthroughData = {
  ...
  holoSteps: [
    ...
    },
    {
      ...
      description: "BabylonCompiler outputs a createScene() function — paste it into any Babylon.js app.",
      lines: [
        { content: 'import { BabylonCompiler } from "@holoscript/core/compilers"', highlight: true },
        { content: "" },
  ...
  outputSteps: [
    {
      ...
      description: "A self-contained createScene() function, importable into any Babylon.js project.",
      lines: [
    ...
    },
    {
      ...
      lines: [
        ...
        { content: "  )" },
        { content: "  const mat = new BABYLON.PBRMaterial('ArtworkMat', scene)", type: "added", annotation: "PBR" },
