  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
        ...
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2">Connect Your Wallet</h1>
        <p className="text-zinc-600 dark:text-zinc-400 text-center max-w-md">
          Please connect your Web3 wallet using the button in the header to access your Creator Dashboard and view analytics.
        </p>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400">
          Welcome back, <span className="font-mono bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded">{address?.slice(0, 6)}...{address?.slice(-4)}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-zinc-900 dark:text-white">
                {balance ? Number(formatEther(balance.value)).toFixed(4) : '0.000'} {balance?.symbol || 'ETH'}
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-sm font-medium text-zinc-600 dark:text-zinc-400">Total Royalties Earned</p>
      ...
      <div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-12 text-center">
          <p className="text-zinc-600 dark:text-zinc-400">No recent activity found. Publish your first trait to get started!</p>
        </div>
      </div>
    </div>
  );
