      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 relative group overflow-hidden">
          <div className="absolute top-0 right-0 p-4">
            <Link href="#" className="flex items-center gap-1 text-xs font-semibold text-holoscript-500 hover:text-holoscript-600 transition-colors">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Sample Procedural World</h3>
