...
_Generated by [HoloScript CI/CD](https://github.com/holoscript/holoscript)_
...
{
  "valid": true,
  "warnings": ["Consider adding @spatial_audio trait to ambient_sound object"],
  "suggestions": [
...
_Powered by [HoloScript MCP](https://mcp.holoscript.net) & [Claude](https://claude.ai)_
