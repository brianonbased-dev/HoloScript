...
describe('AppleAppStoreClient', () => {
  ...
  describe('App Store Version Management', () => {
    ...
    it('should attach build to version', async () => {
      ...
      await expect(client.attachBuildToVersion('version-1', 'build-123')).resolves.not.toThrow();
    ...
    it('should submit version for review', async () => {
      ...
      await expect(client.submitForReview('version-1')).resolves.not.toThrow();
  ...
  describe('Error Handling', () => {
    ...
    it('should validate platform for uploads', async () => {
      ...
      await expect(client.uploadBuild(artifact, appMetadata)).rejects.toThrow(
        'Invalid platform for Apple upload'
      );
    });
  });
});
