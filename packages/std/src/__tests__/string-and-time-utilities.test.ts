...
describe('Stopwatch', () => {
  ...
  it('lap returns elapsed time and restarts', async () => {
    ...
    // After lap(), stopwatch restarted â€” elapsed should be less than before
