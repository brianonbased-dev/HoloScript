...
export const ARTraits: TraitDefinition[] = [
  {
    name: '@ar_beacon',
    type: 'marker',
    description: 'Binds a UI or 3D overlay to a physical reality marker (QR code, NFC, BLE beacon, or visual image).',
    parameters: [
      {
        name: 'type',
        type: 'string',
      ...
      },
      {
        ...
        type: 'number',
        required: false,
        description: 'The expected physical size of the image/marker in meters (for image/qr types)'
      }
    ],
    validation: (node: any) => {
  ...
  },
  {
    name: '@overlay',
    type: 'behavior',
    description: 'Marks a HoloUI panel or 3D object to act as a pass-through overlay locked to the viewport or surface.',
    parameters: [
      {
        name: 'anchor',
        type: 'string',
  ...
  },
  {
    name: '@layer_shift',
    type: 'behavior',
    description: 'Controls the automatic transition between physical reality (AR) and digital twin reality (VR/VRR) boundaries.',
    parameters: [
      {
        name: 'trigger',
        type: 'string',
