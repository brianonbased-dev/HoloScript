/**
 * @holoscript/visual acceptance tests
 * Covers: CATEGORY_COLORS, NodeCategory, PortType, EVENT_NODES structure
 *
 * NOTE: React/ReactFlow are not needed â€” we only test pure data constants.
