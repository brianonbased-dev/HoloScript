 ...
 */
interface PackageMetadata extends PackageManifest {
    /** Creation timestamp */
    created: string;
...
declare class PackageRegistry {
     ...
     */
    hasPermission(pkg: PackageMetadata, userId: string, requiredPermission: PackagePermission): boolean;
    /**
...
declare class ThingDescriptionGenerator {
    ...
    private propertyListToRecord;
    private asRecord;
    private readNodeProperties;
    private readInlineAffordanceMetadata;
    private templateNameFor;
    private resolveTemplateNode;
    private mergeNodeWithTemplate;
    /**
    ...
    private buildActionAffordance;
    /**
     * Extract TD events from emit() calls
     */
    private extractEvents;
    private buildEventAffordance;
    private normalizeAffordanceName;
    /**
