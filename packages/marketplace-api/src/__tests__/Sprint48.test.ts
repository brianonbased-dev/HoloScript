/**
 * Sprint 48 — @holoscript/marketplace-api acceptance tests
...
// ═══════════════════════════════════════════════
// satisfies() — semver constraint checking
// ═══════════════════════════════════════════════
describe('satisfies()', () => {
  it('is a function', () => {
