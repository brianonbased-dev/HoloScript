...
const fullRoster: RosterAgent[] = [
  {
    agentId: 'a1',
    agentName: 'Atlas',
    capabilities: ['geography', 'data-collection'],
  ...
  },
  {
    agentId: 'a2',
    agentName: 'Mapper',
    capabilities: ['map-design', 'frontend'],
  ...
  },
  {
    agentId: 'a3',
    agentName: 'Scout',
    capabilities: ['data-collection', 'geography'],
  ...
  },
  {
    agentId: 'a4',
    agentName: 'Pixel',
    capabilities: ['frontend', 'map-design'],
    specializationScore: 0.7,
    ...
    const partialRoster: RosterAgent[] = [
      {
        agentId: 'p1',
        agentName: 'Halfway',
        capabilities: ['geography', 'map-design'],
        active: true,
      },
    ];
    ...
    const mixedRoster: RosterAgent[] = [
      {
        agentId: 'i1',
        agentName: 'Idle',
        capabilities: ['geography', 'map-design', 'data-collection', 'frontend'],
        active: false,
      },
    ];
