...
export function buildFitnessReceipt(
  ...
  return buildDomainSimulationReceipt({
    ...
    resultSummary: {
      vo2MaxMlKgMin: result.vo2Max?.vo2MaxMlKgMin,
      fitnessClass: result.vo2Max?.fitnessClass,
      oneRMAvgKg: result.oneRM?.average,
      bodyFatPct: result.bodyComp?.bodyFatPct,
      acwr: result.trainingLoad?.acwr,
    },
