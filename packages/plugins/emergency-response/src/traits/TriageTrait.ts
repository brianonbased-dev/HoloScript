  ...
  parameters: [
    {
      ...
      type: 'enum',
      required: true,
      enumValues: ['red', 'yellow', 'green', 'black'],
      description: 'Triage color priority',
    },
    { name: 'patientCount', type: 'number', required: true, description: 'Number of patients' },
    {
      ...
      type: 'enum',
      required: false,
      enumValues: ['START', 'JumpSTART', 'SALT', 'SMART', 'custom'],
      default: 'START',
    ...
    },
    {
      ...
      required: false,
      default: 0,
      description: 'Fine-grained severity 0-100',
    },
    {
      name: 'reassessmentEnabled',
      type: 'boolean',
      required: false,
      default: true,
      description: 'Enable periodic reassessment',
    },
    {
      name: 'reassessmentIntervalSec',
      type: 'number',
      required: false,
      default: 300,
      description: 'Reassessment interval in seconds',
    },
