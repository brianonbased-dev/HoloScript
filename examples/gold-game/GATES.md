...
| 13 | hologram — real multiview quilt light-field of the vault world | **PASS** | `tsx gate-13-hologram-verify.mjs` (7/7; SHIPPED QuiltCompiler → 48-view 8x6 quilt for 16inch Looking Glass, all 8 vault objects projected into every view, cross-view parallax, deterministic digest) | `GATE-13-HOLOGRAM-receipt.json` | _this commit_ |
