...
| 20 | economy balance — stake-on-submit kills the spam-farm strategy; reputation is the progression currency | **PASS** | `tsx gate-20-economy-balance-verify.mjs` (9/9; real economyPrimitivesHandler stake+reward over N=20; honest play BOUNDED — sink absorbs ~98% of inflation; spammer drains + self-limits via insufficient_funds; no-sink baseline inflates; Archivist stays earnable on reputation, not credits) | `GATE-20-ECONOMY-BALANCE-receipt.json` | _this commit_ |
