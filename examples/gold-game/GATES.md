...
| 12 | multi-physics solver (real StructuralSolver TET4 FEM over the vault keystone) | **PASS** | `tsx gate-12-solvers-verify.mjs` (5/5; genuine StructuralSolverAdapter, von-Mises stress under load, deterministic digest) | `GATE-12-SOLVERS-receipt.json` | _this commit_ |
