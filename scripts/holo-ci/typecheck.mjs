...
const ENFORCED = [
  ...
  'auth', 'benchmark', 'connector-appstore', 'connector-core', 'connector-github',
  'connector-moltbook', 'connector-railway', 'connector-upstash', 'connector-vscode', 'core',
  'core-types', 'crdt', 'crdt-spatial', 'create-holoscript', 'formatter',
  ...
  'holoscript-cdn', 'linter', 'llm-provider', 'lsp', 'marketplace-agentkit',
  'marketplace-api', 'mcp-server', 'mcp-server-adversarial', 'memory', 'mesh',
