#!/usr/bin/env tsx
/**
 * Generates hololand-substrate-v1.jsonl training dataset
 */
...
const outPath = join(import.meta.dirname ?? __dirname, '../packages/mcp-server/hololand-substrate-v1.jsonl');
