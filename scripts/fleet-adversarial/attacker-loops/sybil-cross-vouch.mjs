  ...
  async emit({ agentHandle, operation, vvFingerprint }) {
    ...
    if (this.apiBase && this.apiKey) {
      try {
        ...
        // operation must be a string (typeof string check in core-routes.ts).
        // The local JSONL keeps the rich object shape; the wire shape
        // flattens operation into a string and lifts metadata to typed slots.
