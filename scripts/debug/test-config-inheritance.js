...
async function testConfigInheritance() {
    ...
    fs.writeFileSync(path.join(testDir, 'holoscript.config.json'), JSON.stringify(childConfig, null, 2));
    ...
    try {
        ...
        // Assertions
        const success = resolvedConfig.compilerOptions?.target === 'unity' && // Overridden
