> [!WARNING]
> **ARCHIVED**: March 1, 2026. Moved from `docs/physics/`. Progress tracking was never updated despite partial GPU shader implementation (`particle-physics.wgsl`, `spatial-grid.wgsl`, `WebGPUContext.ts`). See main [ROADMAP.md](../strategy/ROADMAP.md) for current physics plans.
