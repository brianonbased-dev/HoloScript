> [!WARNING]
> **ARCHIVED**: March 1, 2026. Moved from `docs/integrations/`. This file references HoloScript 3.0 (now v3.42.0) and was superseded by the v3.5.0 Hololand Bootstrap section in the main [ROADMAP.md](../strategy/ROADMAP.md).
