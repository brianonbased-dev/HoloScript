...
**Revisit when:** HoloLand demands a **single** user-visible reconstruction identity across Quest + browser, _and_ benchmarks show acceptable drift — then open an ADR for a shared **teacher** + two **students**.
