...
export const LESSONS: Lesson[] = [
  {
    id: 1, slug: '01-hello-orb', title: 'Hello Orb',
  ...
  {
    id: 2, slug: '02-properties', title: 'Properties',
