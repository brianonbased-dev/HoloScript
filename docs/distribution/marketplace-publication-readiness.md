...
**Purpose:** Single checklist for **VS Code Marketplace / Open VSX** and **npm** so distribution is repeatable before campaigns. Aligns with board task _Distribution — marketplace publication readiness_.
