...
4. **[Paper Program README](./paper-program/readme.md)** - CAEL-rooted novelty-generation thesis and paper promotion rule
5. **[Paper Program Status](./paper-program-status.md)** - Research program dashboard
