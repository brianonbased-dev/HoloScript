...
Cause: CRDT metadata (version vectors, timestamps, tombstones) adds 20-40 bytes per entry. At 100K particles * 40 bytes overhead * 60fps = ~240MB/s -- impossible over WebRTC.
