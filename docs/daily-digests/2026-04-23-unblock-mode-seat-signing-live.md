...
**Release surface**: This digest originally described the deployment with a generated public-major label. The 2026-05-18 release-line correction treats that label as generated-major drift; the outward-facing story remains on the HoloScript 6.x line. `@holoscript/framework` gets `unblock` in the next publish cycle. No API breakage.
