...
| "I need simulation, agents, and robotics together."   | [`examples/novel-use-cases/05-robot-training-metaverse.holo`](https://github.com/brianonbased-dev/HoloScript/blob/main/examples/novel-use-cases/05-robot-training-metaverse.holo) (aspirational grammar) | One composition ties training, feedback, agents, and robotics targets into a product story; track parser status in the examples health matrix. |
