...
| Scaffold CLI                     | `npm view create-holoscript version`                                                                                                                                 | Repo-canonical `npx create-holoscript`; re-check before claiming release parity                                      |
| Scaffold CLI (`-app` sibling)    | `npm view create-holoscript-app version`                                                                                                                             | Compatibility sibling; compare with `create-holoscript` before claiming release parity                              |
