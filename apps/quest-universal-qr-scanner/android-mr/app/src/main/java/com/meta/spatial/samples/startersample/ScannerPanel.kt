...
object ScannerState {
  ...
  // Content comes from ScannerContent.kt — @generated from scanner.holo by quest-emit-mr.mjs.
  // Edit the copy/contexts in scanner.holo (onboarding/tutorial), recompile — never here.
...
/** Minimal ambient indicator — small pill, rest of the panel transparent, with a way back. */
@Composable
private fun ScanningPill() {
  Column(
    ...
    Row(
      ...
      Body("Scanning for QR…", secondary = true)
      Spacer(Modifier.size(14.dp))
