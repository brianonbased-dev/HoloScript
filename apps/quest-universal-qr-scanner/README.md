...
Current store state: resubmit candidate is HoloQR `1.0.4` (`versionCode 5`). Independent review
is still **changes-requested**. See [`roadmap.md`](./roadmap.md) for the post-launch product sequence and the
