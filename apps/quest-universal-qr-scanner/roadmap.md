...
>
> **Current release:** HoloQR `1.0.4` (`versionCode 5`) is the resubmit candidate
> from this HoloScript source path. Independent review is still **changes-requested**;
> this is not a store ship until headset proof.
