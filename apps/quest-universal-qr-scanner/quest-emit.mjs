...
export const GOLDEN_MANIFEST = [
  ...
  { path: 'android/app/src/main/AndroidManifest.xml', status: 'emitted' },
  { path: 'android/app/build.gradle.kts', status: 'emitted' },
  ...
  { path: 'android/app/src/main/java/net/holoscript/qrscanner/MainActivity.kt', status: 'emitted' },
  { path: 'android/app/src/main/java/net/holoscript/qrscanner/PassthroughCameraController.kt', status: 'emitted' },
];
...
function emitPassthroughControllerKt() {
  return `package net.holoscript.qrscanner
...
const EMITTERS = {
  ...
  'android/app/src/main/AndroidManifest.xml': emitAndroidManifest,
  'android/app/build.gradle.kts': emitAppBuildGradle,
  'android/app/src/main/java/net/holoscript/qrscanner/MainActivity.kt': emitMainActivityKt,
  'android/app/src/main/java/net/holoscript/qrscanner/PassthroughCameraController.kt': emitPassthroughControllerKt,
};
