...
|---------|-----------|-----------|----------|----------------|------------------|
${results.serialization.map((r: any) =>
...
function analyzeMerge(merge: any[]): string {
  let analysis = 'All CRDT implementations successfully merged concurrent edits without conflicts.\n\n';
