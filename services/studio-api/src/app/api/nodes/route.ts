...
const NODE_CATALOG: NodeDef[] = [
  ...
  },
  {
    ...
    label: 'Vector 3',
    category: 'input',
    description: 'Constant XYZ vector',
    color: '#4488ff',
    inputs: [],
  ...
  },
  {
    ...
    label: 'Texture',
    category: 'input',
    description: 'Texture asset sampler',
    color: '#4488ff',
    inputs: [{ id: 'uv', label: 'UV', type: 'vec3' }],
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { id: 'sin', label: 'Sin(Time)', type: 'float' },
    ],
  },
  ...
  },
  {
    ...
    label: 'Lerp',
    category: 'utility',
    description: 'Linear interpolation A → B by T',
    color: '#888899',
    inputs: [
      { id: 'a', label: 'A', type: 'float' },
      { id: 'b', label: 'B', type: 'float' },
  ...
  },
  {
    ...
    description: 'sin(θ)',
    color: '#888899',
    inputs: [{ id: 'theta', label: 'Theta', type: 'float' }],
    outputs: [{ id: 'out', label: 'sin(θ)', type: 'float' }],
  },
  ...
  // ── Transform ───────────────────────────────────────────────────────────────
  {
    ...
    label: 'Position',
    category: 'transform',
    description: 'Object world position',
    color: '#44bb88',
    inputs: [{ id: 'xyz', label: 'XYZ', type: 'vec3' }],
  ...
  },
  {
    ...
    color: '#44bb88',
    inputs: [{ id: 'xyz', label: 'XYZ°', type: 'vec3' }],
    outputs: [{ id: 'rotation', label: 'Rotation', type: 'vec3' }],
  },
  {
    type: 'scale',
    label: 'Scale',
    ...
    color: '#44bb88',
    inputs: [{ id: 'xyz', label: 'XYZ', type: 'vec3' }],
    outputs: [{ id: 'scale', label: 'Scale', type: 'vec3' }],
  },
  ...
  },
  {
    ...
    label: 'Fresnel',
    category: 'material',
    description: 'Edge glow / rim light effect',
    color: '#cc6644',
    inputs: [
      { id: 'power', label: 'Power', type: 'float' },
      { id: 'color', label: 'Color', type: 'color' },
    ],
    outputs: [{ id: 'factor', label: 'Factor', type: 'float' }],
  },
  {
    type: 'noise',
    label: 'Noise',
    category: 'material',
    description: 'Animated Perlin noise field',
    color: '#cc6644',
    inputs: [
    ...
    outputs: [
      { id: 'noise', label: 'Noise', type: 'float' },
      { id: 'color', label: 'Color', type: 'color' },
    ],
  },
  ...
  // ── Geometry ─────────────────────────────────────────────────────────────────
  {
    ...
    label: 'Box',
    category: 'geometry',
    description: 'Parametric box mesh',
    color: '#8855cc',
    inputs: [{ id: 'size', label: 'Size', type: 'vec3' }],
    outputs: [{ id: 'mesh', label: 'Mesh', type: 'string' }],
  },
  {
    type: 'sphere_mesh',
    label: 'Sphere',
    category: 'geometry',
    description: 'Parametric sphere mesh',
    color: '#8855cc',
    inputs: [
      { id: 'radius', label: 'Radius', type: 'float' },
      { id: 'segments', label: 'Segments', type: 'float' },
    ],
    outputs: [{ id: 'mesh', label: 'Mesh', type: 'string' }],
  },
  {
  ...
  },
  {
    ...
    label: 'Directional',
    category: 'light',
    description: 'Infinite directional light',
    color: '#eeaa22',
    inputs: [
      { id: 'color', label: 'Color', type: 'color' },
      { id: 'intensity', label: 'Intensity', type: 'float' },
  ...
  // ── Output ────────────────────────────────────────────────────────────────────
  {
    ...
    label: 'Scene Object',
    category: 'output',
    description: 'Materialises as a scene object',
    color: '#ff4466',
    inputs: [
      { id: 'mesh', label: 'Mesh', type: 'string' },
      { id: 'material', label: 'Material', type: 'string' },
      { id: 'position', label: 'Position', type: 'vec3' },
      { id: 'rotation', label: 'Rotation', type: 'vec3' },
      { id: 'scale', label: 'Scale', type: 'vec3' },
    ],
    outputs: [],
  },
];
...
declare global {
  var __nodeCatalog__: NodeDef[] | undefined;
}
